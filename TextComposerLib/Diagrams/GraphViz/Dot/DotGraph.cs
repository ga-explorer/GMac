...
using TextComposerLib.Diagrams.GraphViz.Dot.Label;
using TextComposerLib.Diagrams.GraphViz.Dot.Label.Text;
using TextComposerLib.Diagrams.GraphViz.Dot.Value;
using TextComposerLib.Text;

namespace TextComposerLib.Diagrams.GraphViz.Dot
{
    /// <summary>
    ...
    public class DotGraph : IDotGraph
    {
        ...
        /// not be present here
        /// </summary>
        internal Dictionary<string, DotNode> NodesCache = 
        ...
        internal DotNode FindOrDefineNode(string nodeName)
        {
            ...
            if (NodesCache.TryGetValue(nodeName, out node))
                return node;
