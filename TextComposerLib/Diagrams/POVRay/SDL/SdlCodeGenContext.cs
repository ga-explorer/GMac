using System;
using System.Linq;
using TextComposerLib.Diagrams.POVRay.SDL.Cameras;
using TextComposerLib.Diagrams.POVRay.SDL.Directives;
using TextComposerLib.Diagrams.POVRay.SDL.Finishes;
using TextComposerLib.Diagrams.POVRay.SDL.Lights;
using TextComposerLib.Diagrams.POVRay.SDL.Objects;
using TextComposerLib.Diagrams.POVRay.SDL.Objects.FSP;
using TextComposerLib.Diagrams.POVRay.SDL.Objects.ISP;
...
namespace TextComposerLib.Diagrams.POVRay.SDL
{
    ...
    {
        internal LinearComposer TextComposer { get; }
