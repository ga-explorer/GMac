...
namespace TextComposerLib.Helpers
{
    /// <summary>
    ...
    public sealed class SubArray<T> : IEnumerable<T>
    {
        ...
        /// </summary>
        public int BaseArrayFirstIndex => IsReversed ? BaseArrayLargerIndex : BaseArraySmallerIndex;

        /// <summary>
        /// The last index of the base array corresponding to the max index of the sub-array
        /// </summary>
        public int BaseArrayLastIndex => IsReversed ? BaseArraySmallerIndex : BaseArrayLargerIndex;
        ...
        /// </summary>
        public int Length => BaseArrayLargerIndex - BaseArraySmallerIndex + 1;

        /// <summary>
        /// The last index in this sub-array
        /// </summary>
        public int LastIndex => BaseArrayLargerIndex - BaseArraySmallerIndex;
        ...
        /// </summary>
        public T FirstItem => Length > 0 ? BaseArray[BaseArrayFirstIndex] : default(T);

        /// <summary>
        /// The last item of this sub-array
        /// </summary>
        public T LastItem => Length > 0 ? BaseArray[BaseArrayLastIndex] : default(T);
