...
namespace TextComposerLib.Code
{
    /// <summary>
    ...
    public abstract class CodeLibraryComposer : IProgressReportSource
    {
        ...
        /// </summary>
        public FilesComposer CodeFilesComposer { get; }

        /// <summary>
        /// A collection of parametric template composers to be used during code generation
        /// </summary>
        public ParametricComposerCollection Templates { get; }
        ...
        /// </summary>
        public LinearComposer ActiveFileTextComposer => CodeFilesComposer.ActiveFileTextComposer;
