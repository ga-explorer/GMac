...
namespace TextComposerLib.Code.Languages
{
    ...
    /// </summary>
    public abstract class LanguageCodeGenerator : ILanguageCodeGenerator
    {
        protected LinearComposer TextComposer = new LinearComposer();
        ...
        {
            get { return TextComposer.IndentationDefault; }
        ...
        protected LanguageCodeGenerator()
        {
