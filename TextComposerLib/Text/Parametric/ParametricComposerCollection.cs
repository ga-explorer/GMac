...
{
    public class ParametricComposerCollection : IDictionary<string, ParametricComposer>
    {
        ...
        protected Dictionary<string, ParametricComposer> ComposersDictionary =
            new Dictionary<string, ParametricComposer>();
        ...
        public bool IgnoreUndefinedParameters
        {
            get
            {
                return _ignoreUndefinedParameters;
            }
            set
            {
        ...
        public bool AlignMultiLineParameterValues 
        {
            get
            {
                return _alignMultiLineParameterValues;
            }
            set
            {
        ...
        /// <param name="templatesNames"></param>
        /// <returns></returns>
        public ParametricComposerCollection SubCollection(params string[] templatesNames)
        {
        ...
        private void AddTemplate(string[] fileLines, int startLine, int endLine, string templateName, string leftDel, string rightDel)
        {
            ...
            //Create the template
            var template =
                new ParametricComposer(leftDel, rightDel, templateText.ToString())
                {
        ...
        private void ParseTemplates(string[] fileLines, int curLine, string leftDel, string rightDel)
        {
            while (curLine < fileLines.Length)
            {
                ...
                if (ParseBeginTemplate(fileLines[curLine], out templateName) == false)
                {
                    curLine++;
                    continue;
                }
        ...
        private void ParseLines(string[] fileLines)
        {
            ...
            if (ParseDelimiters(fileLines[curLine], out leftDel, out rightDel) == false)
                return;
        ...
        public void Add(string key, ParametricComposer value)
        {
        ...
        public bool TryGetValue(string key, out ParametricComposer value)
        {
            return ComposersDictionary.TryGetValue(key, out value);
        }

        public ICollection<ParametricComposer> Values => ComposersDictionary.Values;

        public ParametricComposer this[string key]
        {
            get
            {
                return ComposersDictionary[key];
            }
            set
            {
                ComposersDictionary[key] = value;
            }
        }

        public void Add(KeyValuePair<string, ParametricComposer> item)
        {
        ...
        public bool Contains(KeyValuePair<string, ParametricComposer> item)
        {
            throw new NotImplementedException();
        }

        public void CopyTo(KeyValuePair<string, ParametricComposer>[] array, int arrayIndex)
        {
            throw new NotImplementedException();
        }
        ...
        public bool Remove(KeyValuePair<string, ParametricComposer> item)
        {
            throw new NotImplementedException();
        }

        public IEnumerator<KeyValuePair<string, ParametricComposer>> GetEnumerator()
        {
