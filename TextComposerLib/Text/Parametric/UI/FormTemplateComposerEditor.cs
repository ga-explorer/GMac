...
namespace TextComposerLib.Text.Parametric.UI
{
    ...
    {
        internal ParametricComposerCollection ComposerCollection = 
            new ParametricComposerCollection();
        ...
        private void menuItemTemplate_New_Click(object sender, EventArgs e)
        {
            ...
            ComposerCollection.Add(
                ...
                new ParametricComposer(newTemplateForm.LeftDelimiter, newTemplateForm.RightDelimiter)
                );
        ...
        private void menuItemTemplate_Edit_Click(object sender, EventArgs e)
        {
            ...
            FormEditTemplate templateEditorForm;

            if (_openedTemplates.TryGetValue(templateName, out templateEditorForm) == false)
            {
