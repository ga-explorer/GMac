...
using System.Text;
using TextComposerLib.TextExpression;
using TextComposerLib.TextExpression.Ast;
...
namespace TextComposerLib.Text.Mapped
{
    public sealed class MappingComposerSegment
    {
        ...
        public void TransformUsing(IDictionary<string, string> transTable)
        {
            ...
            FinalText = 
                transTable.TryGetValue(InitialText, out finalText) 
                ? finalText 
                : String.Empty;
        ...
        public void TransformByIndexUsing(IDictionary<int, string> transTable)
        {
            ...
            FinalText = 
                transTable.TryGetValue(Index, out finalText) 
                ? finalText 
                : String.Empty;
        ...
        public void TransformByKindIndexUsing(IDictionary<int, string> transTable)
        {
            ...
            FinalText = 
                transTable.TryGetValue(KindIndex, out finalText) 
                ? finalText 
                : String.Empty;
        ...
        public void TransformByMarkedIndexUsing(IDictionary<int, string> transTable)
        {
            ...
            FinalText = 
                transTable.TryGetValue(MarkedIndex, out finalText) 
                ? finalText 
                : String.Empty;
        ...
        public void TransformByUnmarkedIndexUsing(IDictionary<int, string> transTable)
        {
            ...
            FinalText = 
                transTable.TryGetValue(UnmarkedIndex, out finalText) 
                ? finalText 
                : String.Empty;
