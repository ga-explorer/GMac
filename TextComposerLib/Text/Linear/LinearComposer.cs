...
namespace TextComposerLib.Text.Linear
{
    public sealed class LinearComposer
    {
        ...
        /// </summary>
        private readonly List<LcLineHeader> _lineHeaders = new List<LcLineHeader>();

        /// <summary>
        /// The indentation header object
        /// </summary>
        private readonly LcStackIndentation _indentation = new LcStackIndentation();
        ...
        public LinearComposer IncreaseIndentation() 
        {
        ...
        /// <returns></returns>
        public LinearComposer IncreaseIndentation(string indent)
        {
        ...
        /// </summary>
        /// <returns>The current indentation level</returns>
        public LinearComposer DecreaseIndentation() 
        {
        ...
        /// </summary>
        public LinearComposer ClearIndentation()
        {
            _indentation.Reset();
        ...
        /// </summary>
        public LinearComposer ClearText()
        {
            _lines.Clear();
        ...
        /// </summary>
        public LinearComposer ClearLastLine()
        {
            _newLine.Clear();
        ...
        public LinearComposer Trim(int i)
        {
        ...
        /// </summary>
        public LinearComposer AppendLine()
        {
            if (_newLine.Length == 0)
                AppendLineHeader();
        ...
        /// </summary>
        public LinearComposer AppendAtNewLine()
        {
            if (_newLine.Length > 0)
                AppendLine();
        ...
        /// </summary>
        public LinearComposer AppendLineAtNewLine()
        {
            if (_newLine.Length > 0)
                AppendLine();
        ...
        /// <returns></returns>
        public LinearComposer Append<T>(T text)
        {
        ...
        public LinearComposer Append(string text)
        {
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public LinearComposer AppendLine<T>(T text)
        {
        ...
        public LinearComposer AppendLine(string text)
        {
            Append(text);
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public LinearComposer AppendNewLine<T>(T text)
        {
        ...
        /// </summary>
        /// <param name="text">The text to be appended</param>
        public LinearComposer AppendNewLine(string text)
        {
            AppendLine();
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public LinearComposer AppendAtNewLine<T>(T text)
        {
        ...
        /// </summary>
        /// <param name="text">The text to be appended</param>
        public LinearComposer AppendAtNewLine(string text)
        {
            if (_newLine.Length > 0)
                AppendLine();
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public LinearComposer AppendLineAtNewLine<T>(T text)
        {
        ...
        /// </summary>
        /// <param name="text"></param>
        public LinearComposer AppendLineAtNewLine(string text)
        {
            if (_newLine.Length > 0)
                AppendLine();
        ...
        public LcLineCount AddLineCountHeader()
        {
            var lineHeader = new LcLineCount(this);
        ...
        /// <returns>The added header object</returns>
        public LcLineCount AddLineCountHeader(string formatString)
        {
            var lineHeader = new LcLineCount(this, formatString);
        ...
        public LcTimeStamp AddTimeStampHeader()
        {
            var lineHeader = new LcTimeStamp();
        ...
        public LcTimeStamp AddTimeStampHeader(string formatString)
        {
            var lineHeader = new LcTimeStamp(formatString);
        ...
        public LcStopWatch AddStopWatchHeader()
        {
            var lineHeader = new LcStopWatch();
        ...
        public LcStopWatch AddStopWatchHeader(bool resetOnRead)
        {
            var lineHeader = new LcStopWatch() { ResetOnRead = resetOnRead };
        ...
        public LcStopWatch AddStopWatchHeader(string formatString)
        {
            var lineHeader = new LcStopWatch(formatString);
        ...
        public LcStopWatch AddStopWatchHeader(bool resetOnRead, string formatString)
        {
            var lineHeader = new LcStopWatch(formatString) { ResetOnRead = resetOnRead };
        ...
        public LcLineHeader AddLineHeader(LcLineHeader lineHeader)
        {
            _lineHeaders.Add(lineHeader);
        ...
        /// <summary>
        /// This function clears all lines of texr logger after composing its final text
        /// </summary>
        /// <returns></returns>
