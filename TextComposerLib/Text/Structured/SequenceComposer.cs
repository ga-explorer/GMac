...
{
    public sealed class SequenceComposer : IEnumerable<string>, IStructuredComposer
    {
        ...
        public SequenceComposer(string separator)
        {
            Separator = separator ?? String.Empty;
        }


        public SequenceComposer Clear()
        {
        ...
        public SequenceComposer Append(IEnumerable<string> sequence)
        {
        ...
        public SequenceComposer Append(params string[] sequence)
        {
            _sequence = _sequence.Concat(sequence);
        ...
        public SequenceComposer Append<T>(IEnumerable<T> sequence)
        {
        ...
        public SequenceComposer Append<T>(params T[] sequence)
        {
            _sequence = _sequence.Concat(sequence.Select(item => item.ToString()));
