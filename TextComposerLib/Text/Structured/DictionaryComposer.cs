...
{
    public sealed class DictionaryComposer : IDictionary<string, StructuredTextItem>, IStructuredComposer
    {
        ...
        public DictionaryComposer(string separator)
        {
        ...
        public StructuredTextItem this[string key]
        {
            get
            {
                StructuredTextItem value;

                return (_itemsDictionary.TryGetValue(key, out value)) ? value : StructuredTextItem.Empty;
            }
            set
            {
                ...
                if (_itemsDictionary.ContainsKey(key) == false)
                {
        ...
        public bool Contains(KeyValuePair<string, StructuredTextItem> item)
        {
            ...
            if (_itemsDictionary.TryGetValue(item.Key, out value) == false) return false;
