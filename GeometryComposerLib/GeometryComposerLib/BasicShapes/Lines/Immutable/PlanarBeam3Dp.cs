...
using GeometryComposerLib.BasicShapes.Polyhedra.Immutable;
using GeometryComposerLib.BasicShapes.Triangles.Immutable;

namespace GeometryComposerLib.BasicShapes.Lines.Immutable
{
    /// <summary>
    ...
    public sealed class PlanarBeam3Dp
    {
        ...
        public Tuple3D Origin
            => new Tuple3D(OriginX, OriginY, OriginZ);
        ...
        public Line3D Ray1
            => new Line3D(OriginX, OriginY, OriginZ, Direction1X, Direction1Y, Direction1Z);

        public Line3D Ray2
            => new Line3D(OriginX, OriginY, OriginZ, Direction2X, Direction2Y, Direction2Z);
        ...
        public Tuple3D Normal21
            => Direction2.VectorCross(Direction1);

        public Tuple3D UnitNormal21
            => Direction2.VectorUnitCross(Direction1);


        public Line3D GetNormalLine12()
            => new Line3D(Origin, Normal12);

        public Line3D GetUnitNormalLine12()
            => new Line3D(Origin, UnitNormal12);

        public Line3D GetNormalLine21()
            => new Line3D(Origin, Normal21);

        public Line3D GetUnitNormalLine21()
            => new Line3D(Origin, UnitNormal21);
