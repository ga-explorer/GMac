...
namespace GeometryComposerLib.BasicShapes.Triangles
{
    public static class TrianglesUtils
    {
        ...
        public static IEnumerable<Tuple2D> GetEndPoints(this IEnumerable<ITriangle2D> trianglesList)
            => trianglesList.SelectMany(t => t.GetEndPoints());
        ...
        public static Tuple3D GetPoint1(this ITriangle3D triangle)
            => new Tuple3D(triangle.Point1X, triangle.Point1Y, triangle.Point1Z);

        public static Tuple3D GetPoint2(this ITriangle3D triangle)
            => new Tuple3D(triangle.Point2X, triangle.Point2Y, triangle.Point2Z);

        public static Tuple3D GetPoint3(this ITriangle3D triangle)
            => new Tuple3D(triangle.Point3X, triangle.Point3Y, triangle.Point3Z);
        ...
        public static IEnumerable<LineSegment3D> GetSides(this IEnumerable<ITriangle3D> trianglesList)
            => trianglesList.SelectMany(t => t.GetSides());
        ...
        public static IEnumerable<Line3D> GetLines(this IEnumerable<ITriangle3D> trianglesList)
            => trianglesList.SelectMany(t => t.GetLines());
        ...
        public static IEnumerable<LimitedLine3D> GetLimitedLines(this IEnumerable<ITriangle3D> trianglesList)
            => trianglesList.SelectMany(t => t.GetLimitedLines());
