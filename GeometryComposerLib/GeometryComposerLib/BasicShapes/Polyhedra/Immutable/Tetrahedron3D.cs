...
namespace GeometryComposerLib.BasicShapes.Polyhedra.Immutable
{
    public sealed class Tetrahedron3D
    {
        ...
        public Tuple3D Point1
            => new Tuple3D(Point1X, Point1Y, Point1Z);

        public Tuple3D Point2
            => new Tuple3D(Point2X, Point2Y, Point2Z);

        public Tuple3D Point3
            => new Tuple3D(Point3X, Point3Y, Point3Z);

        public Tuple3D Direction12
            => new Tuple3D(Point2X - Point1X, Point2Y - Point1Y, Point2Z - Point1Z);

        public Tuple3D Direction21
            => new Tuple3D(Point1X - Point2X, Point1Y - Point2Y, Point1Z - Point2Z);

        public Tuple3D Direction23
            => new Tuple3D(Point3X - Point2X, Point3Y - Point2Y, Point3Z - Point2Z);

        public Tuple3D Direction32
            => new Tuple3D(Point2X - Point3X, Point2Y - Point3Y, Point2Z - Point3Z);

        public Tuple3D Direction31
            => new Tuple3D(Point1X - Point3X, Point1Y - Point3Y, Point1Z - Point3Z);

        public Tuple3D Direction13
            => new Tuple3D(Point3X - Point1X, Point3Y - Point1Y, Point3Z - Point1Z);

        public Tuple3D Direction14
            => new Tuple3D(Point4X - Point1X, Point4Y - Point1Y, Point4Z - Point1Z);

        public Tuple3D Direction41
            => new Tuple3D(Point1X - Point4X, Point1Y - Point4Y, Point1Z - Point4Z);

        public Tuple3D Direction24
            => new Tuple3D(Point4X - Point2X, Point4Y - Point2Y, Point4Z - Point2Z);

        public Tuple3D Direction42
            => new Tuple3D(Point2X - Point4X, Point2Y - Point4Y, Point2Z - Point4Z);

        public Tuple3D Direction34
            => new Tuple3D(Point4X - Point3X, Point4Y - Point3Y, Point4Z - Point3Z);

        public Tuple3D Direction43
            => new Tuple3D(Point3X - Point4X, Point3Y - Point4Y, Point3Z - Point4Z);

        public Tuple3D Normal123
            => Direction12.VectorCross(Direction23);

        public Tuple3D UnitNormal123
            => Direction12.VectorUnitCross(Direction23);

        public Tuple3D Normal321
            => Direction32.VectorCross(Direction21);

        public Tuple3D UnitNormal321
            => Direction32.VectorUnitCross(Direction21);

        public Tuple3D Normal124
            => Direction12.VectorCross(Direction24);

        public Tuple3D UnitNormal124
            => Direction12.VectorUnitCross(Direction24);

        public Tuple3D Normal421
            => Direction42.VectorCross(Direction21);

        public Tuple3D UnitNormal421
            => Direction42.VectorUnitCross(Direction21);

        public Tuple3D Normal134
            => Direction13.VectorCross(Direction34);

        public Tuple3D UnitNormal134
            => Direction13.VectorUnitCross(Direction34);

        public Tuple3D Normal431
            => Direction43.VectorCross(Direction31);

        public Tuple3D UnitNormal431
            => Direction43.VectorUnitCross(Direction31);

        public Tuple3D Normal234
            => Direction23.VectorCross(Direction34);

        public Tuple3D UnitNormal234
            => Direction23.VectorUnitCross(Direction34);

        public Tuple3D Normal432
            => Direction43.VectorCross(Direction32);

        public Tuple3D UnitNormal432
            => Direction43.VectorUnitCross(Direction32);
