...
using GeometryComposerLib.Borders.Space1D;
using GeometryComposerLib.Borders.Space1D.Immutable;
using GeometryComposerLib.Computers;

namespace GeometryComposerLib.Accelerators.BIH.Space2D.Traversal
{
    public struct AccBihLineTraversalState2D
    {
        public IAccBihNode2D BihNode { get; }
        ...
        internal AccBihLineTraversalState2D(IAccBihNode2D bihNode, double lineParameterMinValue, double lineParameterMaxValue)
        {
        ...
        internal AccBihLineTraversalState2D(IAccBihNode2D bihNode, IBoundingBox1D lineParameterRange)
        {
            Debug.Assert(!ReferenceEquals(bihNode, null));
        ...
        public AccBihLineTraversalData2D GetTraversalData(LineTraversalData2D lineData) 
            => new AccBihLineTraversalData2D(
                BihNode,
                lineData
            );
        ...
        /// </summary>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_SingleInternalNode(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            ...
            {
                if (t0 <= s1 && t1 >= s0)
                    yield return new AccBihLineTraversalState2D(
        ...
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_PDirection_NoOverlap(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_PDirection_Overlap(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_PDirection_Touch(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
            ...
            if (s0 < t0 && node.HasRightChild)
                yield return
                    new AccBihLineTraversalState2D(node.RightChild, t0, t1);
            ...
            else if (t0 <= s0 && s0 <= t1)
            {
                if (node.HasRightChild)
                    yield return
                        new AccBihLineTraversalState2D(node.RightChild, s0, t1);

                if (node.HasLeftChild)
                    yield return
                        new AccBihLineTraversalState2D(node.LeftChild, t0, s0);
            }

            //Case 15: t0 < t1 < s0
            else if (t1 <= s0 && node.HasLeftChild)
                yield return
                    new AccBihLineTraversalState2D(node.LeftChild, t0, t1);
        }
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_NDirection_NoOverlap(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_NDirection_Overlap(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_NDirection_Touch(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
            ...
            else if (t0 <= s0 && s0 <= t1)
            {
                if (node.HasRightChild)
                    yield return
                        new AccBihLineTraversalState2D(node.RightChild, t0, s0);

                if (node.HasLeftChild)
                    yield return
                        new AccBihLineTraversalState2D(node.LeftChild, s0, t1);
            }
        ...
        /// <param name="bihLineData"></param>
        /// <returns></returns>
        private IEnumerable<AccBihLineTraversalState2D> GetChildStates_ZDirection(AccBihLineTraversalData2D bihLineData)
        {
            var node = BihNode;
            var t0 = LineParameterMinValue;
            var t1 = LineParameterMaxValue;
        ...
        public IEnumerable<AccBihLineTraversalState2D> GetChildStates(LineTraversalData2D lineData)
        {
            ...
            //traversal cases
            var bihLineData = 
                new AccBihLineTraversalData2D(BihNode, lineData);
