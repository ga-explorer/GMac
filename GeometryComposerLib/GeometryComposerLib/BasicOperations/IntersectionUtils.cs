...
namespace GeometryComposerLib.BasicOperations
{
    public static class IntersectionUtils
    {
        internal static Tuple<bool, double> NoIntersection { get; }
            = new Tuple<bool, double>(false, 0);

        internal static Tuple<bool, double, double> NoIntersectionPair { get; }
