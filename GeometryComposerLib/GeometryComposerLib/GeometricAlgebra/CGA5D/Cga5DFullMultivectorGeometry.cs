...
namespace GeometryComposerLib.GeometricAlgebra.CGA5D
{
        ...
        : Cga5DMultivectorGeometry
    {
        ...
        protected override double ComputeSdfOpns(Tuple3D point)
        {
        ...
        protected override double ComputeSdfIpns(Tuple3D point)
        {
        ...
        private Tuple3D GetOpnsNormal(Tuple3D point)
        {
        ...
        private Tuple3D GetIpnsNormal(Tuple3D point)
        {
        ...
        public override Tuple3D ComputeSdfNormal(Tuple3D point)
        {
