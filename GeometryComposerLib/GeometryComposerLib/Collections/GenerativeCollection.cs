...
using System.Linq;
using GeometryComposerLib.Collections.Finite;
using GeometryComposerLib.Collections.Finite.Iterators;
using GeometryComposerLib.Collections.Finite.Natural;

namespace GeometryComposerLib.Collections
{
