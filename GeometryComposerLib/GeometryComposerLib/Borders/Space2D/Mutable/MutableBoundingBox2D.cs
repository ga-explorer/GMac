...
using System.Linq;
using GeometryComposerLib.BasicMath.Maps.Space2D;
...
namespace GeometryComposerLib.Borders.Space2D.Mutable
{
    /// <summary>
    /// 
    /// </summary>
    public sealed class MutableBoundingBox2D : IBoundingBox2D
    {
        ...
        public IBorderCurve2D MapUsing(IAffineMap2D affineMap)
        {
            ...
            var newCorner00 = affineMap.MapPoint(this.GetMinCorner()).ToTuple2D();
