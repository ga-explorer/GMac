...
namespace GeometryComposerLib.Computers.Voronoi
{
    public sealed class VoronoiTriangle2D : ITriangle2D
    {
        ...
        public Tuple2D Point1 
            => PointsList[PointIndex1];

        public Tuple2D Point2 
            => PointsList[PointIndex2];

        public Tuple2D Point3 
            => PointsList[PointIndex3];

        public VoronoiEdge2D Edge12 
            => new VoronoiEdge2D(PointsList, PointIndex1, PointIndex2);

        public VoronoiEdge2D Edge23 
            => new VoronoiEdge2D(PointsList, PointIndex2, PointIndex3);

        public VoronoiEdge2D Edge31 
            => new VoronoiEdge2D(PointsList, PointIndex3, PointIndex1);
