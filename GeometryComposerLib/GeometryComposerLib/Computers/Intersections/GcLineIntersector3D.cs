...
using System.Linq;
using GeometryComposerLib.Accelerators.BIH;
using GeometryComposerLib.Accelerators.BIH.Space3D;
using GeometryComposerLib.Accelerators.BIH.Space3D.Traversal;
using GeometryComposerLib.Accelerators.Grids;
using GeometryComposerLib.Accelerators.Grids.Space3D;
using GeometryComposerLib.BasicMath;
using GeometryComposerLib.BasicMath.Tuples;
using GeometryComposerLib.BasicOperations;
...
namespace GeometryComposerLib.Computers.Intersections
{
    ...
    public class GcLineIntersector3D
    {
        ...
        public GcLineIntersector3D SetLineAsLineSegment(ITuple3D point1, ITuple3D point2)
        {
            Line = new Line3D(
                point1.X,
                point1.Y,
        ...
        public GcLineIntersector3D SetLine(ITuple3D lineOrigin, ITuple3D lineDirection)
        {
            Line = new Line3D(
                lineOrigin.X,
                lineOrigin.Y,
