...
using GeometryComposerLib.Accelerators.BIH.Space2D.Traversal;
...
using GeometryComposerLib.Computers.Intersections;
using GeometryComposerLib.Random;
using GraphicsComposerLib.SVG.DrawingBoard;

namespace GeometryComposerLibBenchmarks.Samples.Accelerators
{
    /// <summary>
    ...
    public static class Sample3
    {
        public static void Execute()
        {
            ...
            foreach (var lineData in linesData)
            {
                ...
                var pointsList =
                    line2.GetPointsAt(lineData.Item2).Cast<ITuple2D>();
