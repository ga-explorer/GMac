...
namespace GeometryComposerLibBenchmarks.Benchmarks.Accelerators
{
    public class AcceleratorsBenchmark1
    {
        private RandomGeometryGenerator RandomGenerator { get; set; }
        ...
        public void Setup()
        {
            RandomGenerator = new RandomGeometryGenerator(10);
            LinesList.Clear();
