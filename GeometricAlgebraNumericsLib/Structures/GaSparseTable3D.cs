...
{
    public class GaSparseTable3D<TKey1, TKey2, TKey3, TValue>
        : IEnumerable<KeyValuePair<Tuple<TKey1, TKey2, TKey3>, TValue>>
    {
        ...
        public TValue this[TKey1 key1, TKey2 key2, TKey3 key3]
        {
            get
            {
                TValue value;
                return
                    _dictionary.TryGetValue(new Tuple<TKey1, TKey2, TKey3>(key1, key2, key3), out value)
                        ? value : DefaultValue;
            }
            set
            {
        ...
        public GaSparseTable3D()
        {
            DefaultValue = default(TValue);
        }

        public GaSparseTable3D(TValue defaultValue)
        {
            DefaultValue = defaultValue;
        }

        public GaSparseTable3D(IEnumerable<KeyValuePair<Tuple<TKey1, TKey2, TKey3>, TValue>> pairs)
        {
            DefaultValue = default(TValue);
        ...
        public GaSparseTable3D(TValue defaultValue, IEnumerable<KeyValuePair<Tuple<TKey1, TKey2, TKey3>, TValue>> pairs)
        {
            DefaultValue = defaultValue;
        ...
        public GaSparseTable3D<TKey1, TKey2, TKey3, TValue> Clear()
        {
            _dictionary.Clear();
        ...
        public GaSparseTable3D<TKey1, TKey2, TKey3, TValue> Remove(TKey1 key1, TKey2 key2, TKey3 key3)
        {
