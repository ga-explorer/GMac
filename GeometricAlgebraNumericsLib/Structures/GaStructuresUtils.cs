...
namespace GeometricAlgebraNumericsLib.Structures
{
    public static class GaStructuresUtils
    {
        ...
        public static DotGraph AddBinaryTree<T>(this DotGraph dotGraph, GaBinaryTree<T> quadTree, bool showFullGraph)
        {
        ...
        public static DotGraph AddQuadTree<T>(this DotGraph dotGraph, GaQuadTree<T> quadTree, bool showFullGraph)
        {
            var maxTreeDepth = quadTree.TreeDepth;
            var activeIDs = quadTree.LeafNodeIDs.ToArray();
