...
{
    public class GaSparseTable2D<TKey1, TKey2, TValue> 
        : IEnumerable<KeyValuePair<Tuple<TKey1, TKey2>, TValue>>
    {
        ...
        public TValue this[TKey1 key1, TKey2 key2]
        {
            get
            {
                TValue value;
                return
                    _dictionary.TryGetValue(new Tuple<TKey1, TKey2>(key1, key2), out value)
                        ? value : DefaultValue;
            }
            set
            {
        ...
        public GaSparseTable2D()
        {
            DefaultValue = default(TValue);
        }

        public GaSparseTable2D(TValue defaultValue)
        {
            DefaultValue = defaultValue;
        }

        public GaSparseTable2D(IEnumerable<KeyValuePair<Tuple<TKey1, TKey2>, TValue>> pairs)
        {
            DefaultValue = default(TValue);
        ...
        public GaSparseTable2D(TValue defaultValue, IEnumerable<KeyValuePair<Tuple<TKey1, TKey2>, TValue>> pairs)
        {
            DefaultValue = defaultValue;
        ...
        public GaSparseTable2D<TKey1, TKey2, TValue> Clear()
        {
            _dictionary.Clear();
        ...
        public GaSparseTable2D<TKey1, TKey2, TValue> Remove(TKey1 key1, TKey2 key2)
        {
