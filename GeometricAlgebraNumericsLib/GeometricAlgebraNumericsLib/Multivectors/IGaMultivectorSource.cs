...
namespace GeometricAlgebraNumericsLib.Multivectors
{
    public interface IGaMultivectorSource<T>
    {
        ...
        /// <returns></returns>
        bool TryGetValue(ulong id, out T value);
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        bool TryGetValue(int grade, ulong index, out T value);
        ...
        /// </summary>
        IEnumerable<ulong> GetNonZeroTermIds();
        ...
        /// <param name="term"></param>
        /// <returns></returns>
        bool TryGetTerm(int grade, ulong index, out GaTerm<T> term);
