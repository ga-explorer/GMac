    ...
    public sealed class GaNumEuclideanCp : GaNumBilinearProductEuclidean
    {
        public override GaNumSarMultivector this[GaNumSarMultivector mv1, GaNumSarMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtECpTerms(mv2).SumAsSarMultivector(TargetVSpaceDimension);
            }
        }
        ...
        public override GaNumDgrMultivector this[GaNumDgrMultivector mv1, GaNumDgrMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtECpTerms(mv2).SumAsDgrMultivector(TargetVSpaceDimension);
            }
        }


        internal GaNumEuclideanCp(int targetVSpaceDim) 
