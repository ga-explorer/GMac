...
{
    public sealed class GaNumEuclideanAcp : GaNumBilinearProductEuclidean
    {
        public override GaNumSarMultivector this[GaNumSarMultivector mv1, GaNumSarMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtEAcpTerms(mv2).SumAsSarMultivector(TargetVSpaceDimension);
            }
        }
        ...
        public override GaNumDgrMultivector this[GaNumDgrMultivector mv1, GaNumDgrMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtEAcpTerms(mv2).SumAsDgrMultivector(TargetVSpaceDimension);
            }
        }


        internal GaNumEuclideanAcp(int targetVSpaceDim) 
