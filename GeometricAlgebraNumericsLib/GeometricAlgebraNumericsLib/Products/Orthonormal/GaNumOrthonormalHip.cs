...
{
    public sealed class GaNumOrthonormalHip : GaNumBilinearProductOrthonormal
    {
        public override GaNumSarMultivector this[GaNumSarMultivector mv1, GaNumSarMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtHipTerms(mv2, OrthonormalMetric).SumAsSarMultivector(TargetVSpaceDimension);
            }
        }
        ...
        public override GaNumDgrMultivector this[GaNumDgrMultivector mv1, GaNumDgrMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtHipTerms(mv2, OrthonormalMetric).SumAsDgrMultivector(TargetVSpaceDimension);
            }
        }


        internal GaNumOrthonormalHip(GaNumMetricOrthonormal basisBladesSignatures)
