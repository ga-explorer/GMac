...
{
    public sealed class GaNumOrthonormalFdp : GaNumBilinearProductOrthonormal
    {
        public override GaNumSarMultivector this[GaNumSarMultivector mv1, GaNumSarMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtFdpTerms(mv2, OrthonormalMetric).SumAsSarMultivector(TargetVSpaceDimension);
            }
        }
        ...
        public override GaNumDgrMultivector this[GaNumDgrMultivector mv1, GaNumDgrMultivector mv2]
        {
            get
            {
                ...
                return mv1.GetGbtFdpTerms(mv2, OrthonormalMetric).SumAsDgrMultivector(TargetVSpaceDimension);
            }
        }


        internal GaNumOrthonormalFdp(GaNumMetricOrthonormal basisBladesSignatures)
