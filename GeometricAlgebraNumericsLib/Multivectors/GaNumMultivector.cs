...
namespace GeometricAlgebraNumericsLib.Multivectors
{
    public sealed class GaNumMultivector : IGaNumMultivector
    {
        ...
        internal static GaNumMultivector CreateCopy(GaBinaryTree<double> termsTree)
        {
        ...
        internal GaBinaryTree<double> TermsTree { get; }
        ...
        public double this[int grade, int index]
        {
            get
            {
                return this[GaNumFrameUtils.BasisBladeId(grade, index)];
            }
        }
        ...
        private GaNumMultivector(int gaSpaceDim)
        {
            ...
            TermsTree = new GaBinaryTree<double>(VSpaceDimension);
        }
