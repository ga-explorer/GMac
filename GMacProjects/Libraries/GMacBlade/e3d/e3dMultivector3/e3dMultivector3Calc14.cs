namespace GMacModel.e3d
{
    public sealed partial class e3dMultivector3 : e3dMultivector
    {
        ...
        public e3dMultivector14 OP(e3dMultivector14 mv)
        {
            var result = new e3dMultivector14();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:35:58.9143831+02:00
            //Macro: geometry3d.e3d.OP
            //Input Variables: 11 used, 0 not used, 11 total.
            //Temp Variables: 18 sub-expressions, 0 generated temps, 18 total.
            //Target Temp Variables: 2 total.
            //Output Variables: 8 total.
            //Computations: 1.42307692307692 average, 37 total.
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:35:58.9183833+02:00
        ...
        public e3dFull GP(e3dMultivector14 mv)
        {
            ...
            //Bagin GMac Macro Code Generation, 2016-01-11T22:35:58.9233836+02:00
            //Macro: geometry3d.e3d.GP
            //Input Variables: 11 used, 0 not used, 11 total.
            //Temp Variables: 40 sub-expressions, 0 generated temps, 40 total.
            //Target Temp Variables: 2 total.
            //Output Variables: 8 total.
            //Computations: 1.41666666666667 average, 68 total.
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:35:58.9303840+02:00
            
            return result;
        }
        
        public e3dFull LCP(e3dMultivector14 mv)
        {
            var result = new e3dFull();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:35:58.9353843+02:00
            //Macro: geometry3d.e3d.LCP
            //Input Variables: 11 used, 0 not used, 11 total.
            //Temp Variables: 22 sub-expressions, 0 generated temps, 22 total.
            //Target Temp Variables: 2 total.
            //Output Variables: 8 total.
            //Computations: 1.5 average, 45 total.
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:35:58.9393845+02:00
            
            return result;
        }
        
        public e3dScalar RCP(e3dMultivector14 mv)
        {
            var result = new e3dScalar();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:35:58.9423847+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:35:58.9443848+02:00
        ...
        public double SP(e3dMultivector14 mv)
        {
            ...
            //Bagin GMac Macro Code Generation, 2016-01-11T22:35:58.9463849+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:35:58.9483850+02:00
            
            return result;
        }
        
        public e3dFull Add(e3dMultivector14 mv)
        {
            return new e3dFull()
            {
                G0I0 = G0I0,
        ...
        public e3dFull Subtract(e3dMultivector14 mv)
        {
            return new e3dFull()
            {
                G0I0 = G0I0,
