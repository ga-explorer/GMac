namespace GMacModel.e3d
{
    public sealed partial class e3dMultivector10 : e3dMultivector
    {
        ...
        public e3dPseudoVector OP(e3dVector mv)
        {
            var result = new e3dPseudoVector();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:36:01.7305442+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:36:01.7335443+02:00
            
            return result;
        }
        
        public e3dMultivector5 GP(e3dVector mv)
        {
            var result = new e3dMultivector5();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:36:01.7375446+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:36:01.7405447+02:00
            
            return result;
        }
        
        public e3dScalar LCP(e3dVector mv)
        {
            var result = new e3dScalar();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:36:01.7435449+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:36:01.7455450+02:00
            
            return result;
        }
        
        public e3dMultivector5 RCP(e3dVector mv)
        {
            var result = new e3dMultivector5();
            
            //Bagin GMac Macro Code Generation, 2016-01-11T22:36:01.7485452+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:36:01.7515454+02:00
        ...
        public double SP(e3dVector mv)
        {
            ...
            //Bagin GMac Macro Code Generation, 2016-01-11T22:36:01.7525454+02:00
            ...
            //Finish GMac Macro Code Generation, 2016-01-11T22:36:01.7535455+02:00
            
            return result;
        }
        
        public e3dMultivector10 Add(e3dVector mv)
        {
        ...
        public e3dMultivector10 Subtract(e3dVector mv)
        {
            return new e3dMultivector10()
            {
                G3I0 = G3I0,
