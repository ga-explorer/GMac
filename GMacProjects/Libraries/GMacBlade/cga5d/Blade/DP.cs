...
namespace GMacBlade.cga5d
{
    ...
    {
        private static cga5dBlade DP_00(double[] coefs1, double[] coefs2)
        {
        ...
        private static cga5dBlade DP_01(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_02(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_03(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_04(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_05(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_10(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_11(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_12(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_13(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_14(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_15(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_20(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_21(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_22(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_23(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_24(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_25(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_30(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_31(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_32(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_33(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_34(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_35(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_40(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_41(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_42(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_43(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_44(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_45(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_50(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_51(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_52(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_53(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_54(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga5dBlade DP_55(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        public cga5dBlade DP(cga5dBlade blade2)
        {
