...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] RCP_422(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:05 ص
            ...
            tempArray[3] = (coefs2[3] * tempArray[0]);
            ...
            tempArray[5] = (-1 * coefs2[4] * tempArray[2]);
            ...
            tempArray[4] = (coefs2[2] * tempArray[1]);
