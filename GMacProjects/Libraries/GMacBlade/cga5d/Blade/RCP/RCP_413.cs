...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] RCP_413(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:02 ص
            ...
            tempArray[0] = (-1 * coefs1[1] * coefs2[2]);
            tempArray[1] = (-1 * coefs1[2] * coefs2[3]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[4] = (-1 * tempArray[0]);
            tempArray[0] = (-1 * coefs1[1] * coefs2[1]);
            tempArray[1] = (coefs1[3] * coefs2[3]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[5] = (-1 * tempArray[0]);
            tempArray[0] = (-1 * coefs1[2] * coefs2[1]);
            tempArray[1] = (-1 * coefs1[3] * coefs2[2]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[7] = (-1 * tempArray[0]);
