...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] RCP_211(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:53:58 ص
            ...
            tempArray[6] = (-1 * coefs1[4] * coefs2[3]);
            ...
            tempArray[2] = (tempArray[2] + tempArray[5]);
            tempArray[5] = (-1 * coefs1[4] * coefs2[1]);
            tempArray[6] = (-1 * coefs1[5] * coefs2[2]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[1] = (tempArray[1] * tempArray[4]);
            tempArray[1] = (tempArray[5] + tempArray[1]);
            tempArray[2] = (tempArray[3] * tempArray[2]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[6] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[3] = (-1 * coefs2[1] * tempArray[2]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
