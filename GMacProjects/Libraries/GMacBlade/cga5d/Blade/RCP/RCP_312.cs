...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] RCP_312(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:00 ص
            ...
            tempArray[0] = (coefs1[4] * coefs2[1]);
            tempArray[1] = (coefs1[5] * coefs2[2]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[7] * coefs2[3]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[6] = (-1 * tempArray[0]);
            ...
            tempArray[5] = (-1 * coefs1[3] * coefs2[3]);
            ...
            tempArray[2] = (tempArray[2] + tempArray[5]);
            tempArray[5] = (coefs1[3] * coefs2[2]);
            tempArray[1] = (tempArray[1] * tempArray[4]);
            tempArray[1] = (tempArray[5] + tempArray[1]);
            tempArray[2] = (tempArray[3] * tempArray[2]);
            c[4] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (-1 * coefs1[2] * tempArray[0]);
            tempArray[2] = (-1 * coefs1[9] * tempArray[0]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[5] = (coefs1[2] * tempArray[0]);
            tempArray[2] = (tempArray[2] + tempArray[5]);
            tempArray[5] = (coefs1[3] * coefs2[1]);
            tempArray[1] = (-1 * tempArray[4] * tempArray[1]);
            tempArray[1] = (tempArray[5] + tempArray[1]);
            tempArray[2] = (-1 * tempArray[3] * tempArray[2]);
            c[5] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (-1 * coefs2[3] * tempArray[1]);
            tempArray[2] = (-1 * coefs2[2] * tempArray[1]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[4] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[0] * tempArray[1]);
            tempArray[3] = (-1 * coefs2[3] * tempArray[2]);
            tempArray[4] = (-1 * coefs2[2] * tempArray[2]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
