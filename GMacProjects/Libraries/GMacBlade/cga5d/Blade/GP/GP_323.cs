...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_323(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:41 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[5] = (-1 * coefs2[3] * tempArray[0]);
            ...
            tempArray[14] = (coefs1[7] * coefs2[5]);
            ...
            tempArray[4] = (-1 * coefs1[5] * coefs2[5]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[10] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[9] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            ...
            c[7] = (-1 * tempArray[1]);
            tempArray[1] = (tempArray[5] * tempArray[4]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[9] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[11] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            c[3] = (-1 * tempArray[1]);
            tempArray[1] = (-1 * coefs2[4] * tempArray[9]);
            tempArray[2] = (coefs2[5] * tempArray[1]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[2] = (-1 * coefs2[4] * tempArray[10]);
            tempArray[3] = (coefs2[5] * tempArray[2]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * coefs2[6] * tempArray[4]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs1[3] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs1[4] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[5] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[2]);
            c[0] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (coefs2[2] * tempArray[9]);
            tempArray[4] = (coefs2[6] * tempArray[2]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs2[5] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[4] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[7] * tempArray[11]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[4] = (coefs2[2] * tempArray[10]);
            tempArray[5] = (-1 * coefs2[6] * tempArray[1]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (-1 * coefs2[5] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[4] * tempArray[5]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (-1 * coefs1[3] * tempArray[7]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (-1 * coefs1[7] * tempArray[12]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (tempArray[0] * tempArray[4]);
            c[1] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (-1 * coefs2[6] * tempArray[10]);
            tempArray[6] = (coefs2[2] * tempArray[1]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs2[4] * tempArray[4]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (coefs1[5] * tempArray[6]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[7] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[3] * tempArray[12]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[5] = (-1 * tempArray[0] * tempArray[5]);
            tempArray[6] = (coefs2[6] * tempArray[9]);
            tempArray[7] = (coefs2[2] * tempArray[2]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs2[4] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[5] * tempArray[5]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (coefs1[7] * tempArray[8]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[3] * tempArray[11]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
