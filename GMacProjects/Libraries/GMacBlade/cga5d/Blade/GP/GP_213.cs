...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_213(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:27 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[0] = (coefs1[5] * coefs2[1]);
            tempArray[1] = (-1 * coefs1[4] * coefs2[2]);
            ...
            tempArray[5] = (-1 * coefs1[6] * coefs2[1]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[5] = (coefs1[3] * tempArray[0]);
            tempArray[2] = (tempArray[2] + tempArray[5]);
            tempArray[5] = (coefs1[6] * coefs2[3]);
            tempArray[2] = (-1 * tempArray[3] * tempArray[2]);
            tempArray[2] = (tempArray[5] + tempArray[2]);
            ...
            tempArray[2] = (coefs2[1] * tempArray[2]);
            tempArray[3] = (-1 * coefs2[2] * tempArray[2]);
            ...
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[4] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            ...
            tempArray[7] = (-1 * coefs1[5] * tempArray[4]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
