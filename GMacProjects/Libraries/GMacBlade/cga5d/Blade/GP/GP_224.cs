...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_224(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:31 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[9] = (-1 * coefs1[6] * coefs2[2]);
            ...
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (tempArray[7] * tempArray[2]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[9] * tempArray[6]);
            c[3] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (coefs2[2] * tempArray[9]);
            tempArray[2] = (-1 * coefs2[4] * tempArray[1]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs2[5] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[2] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[4] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[5] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[0] * tempArray[1]);
            tempArray[3] = (coefs2[2] * tempArray[10]);
            tempArray[4] = (-1 * coefs2[4] * tempArray[2]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs2[5] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[2] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
