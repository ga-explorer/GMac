...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_244(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:36 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[5] = (-1 * coefs1[5] * coefs2[2]);
            tempArray[6] = (coefs1[4] * coefs2[3]);
            ...
            tempArray[6] = (-1 * coefs1[2] * coefs2[3]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
