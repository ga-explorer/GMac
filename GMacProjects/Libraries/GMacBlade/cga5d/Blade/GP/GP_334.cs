...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_334(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[5] = (coefs2[2] * tempArray[0]);
            ...
            tempArray[13] = (-1 * coefs1[5] * coefs2[3]);
            tempArray[14] = (-1 * coefs1[3] * coefs2[5]);
            ...
            tempArray[2] = (-1 * coefs1[3] * coefs2[4]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[11] * tempArray[4]);
            c[3] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (coefs2[4] * tempArray[1]);
            tempArray[2] = (-1 * coefs2[5] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs2[7] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[3] = (-1 * coefs2[4] * tempArray[2]);
            tempArray[4] = (coefs2[5] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs2[7] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[4] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[5] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[7] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
