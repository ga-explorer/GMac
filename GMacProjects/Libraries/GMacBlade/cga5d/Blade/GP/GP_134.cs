...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] GP_134(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:54:21 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[5] = (-1 * coefs1[2] * coefs2[4]);
            ...
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[3] * coefs2[5]);
            tempArray[6] = (-1 * coefs1[2] * coefs2[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
