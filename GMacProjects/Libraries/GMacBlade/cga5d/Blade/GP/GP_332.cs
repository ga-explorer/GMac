...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] GP_332(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:43 ص
            //Macro: main.cga5d.GP
            ...
            //Computations: 1.28662420382166 average, 202 total.
            ...
            tempArray[10] = (-1 * coefs1[6] * tempArray[0]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[11] = (coefs2[0] * tempArray[0]);
            tempArray[12] = (-1 * coefs2[6] * tempArray[0]);
            ...
            tempArray[14] = (coefs1[4] * coefs2[7]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[5] * tempArray[10]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[9] * tempArray[6]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (tempArray[1] * tempArray[12]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (tempArray[11] * tempArray[2]);
            c[4] = (tempArray[13] + tempArray[14]);
            tempArray[13] = (coefs1[7] * coefs2[5]);
            tempArray[14] = (-1 * coefs1[5] * coefs2[7]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[10] * tempArray[8]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[9] * tempArray[7]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (tempArray[4] * tempArray[12]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (tempArray[3] * tempArray[11]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[11] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            c[6] = (-1 * tempArray[1]);
            tempArray[1] = (coefs2[3] * tempArray[1]);
            tempArray[2] = (-1 * coefs2[7] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs2[5] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[3] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[7] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[5] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[0] * tempArray[1]);
            tempArray[3] = (coefs2[3] * tempArray[2]);
            tempArray[4] = (coefs2[7] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs2[5] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[7] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[5] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            c[0] = (tempArray[2] + tempArray[3]);
            tempArray[2] = (coefs2[7] * tempArray[2]);
            tempArray[4] = (coefs2[3] * tempArray[4]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * coefs2[4] * tempArray[9]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[7] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (coefs1[4] * tempArray[11]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[0] * tempArray[2]);
            tempArray[5] = (-1 * coefs2[7] * tempArray[1]);
            tempArray[6] = (coefs2[3] * tempArray[3]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (coefs2[4] * tempArray[10]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (coefs1[7] * tempArray[5]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[3] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[4] * tempArray[12]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[5] = (tempArray[0] * tempArray[5]);
            c[1] = (tempArray[4] + tempArray[5]);
            tempArray[4] = (-1 * coefs2[5] * tempArray[2]);
            tempArray[6] = (-1 * coefs2[4] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * coefs2[3] * tempArray[10]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (coefs1[5] * tempArray[6]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (coefs1[4] * tempArray[7]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (coefs1[3] * tempArray[12]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[7] = (coefs2[5] * tempArray[1]);
            tempArray[8] = (coefs2[4] * tempArray[4]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * coefs2[3] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[5] * tempArray[5]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[4] * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (coefs1[3] * tempArray[11]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
