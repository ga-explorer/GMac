...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] GP_424(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:51 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[6] = (-1 * coefs1[1] * coefs2[5]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            ...
            tempArray[1] = (coefs2[6] * tempArray[1]);
            ...
            tempArray[3] = (-1 * coefs2[6] * tempArray[2]);
