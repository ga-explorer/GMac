...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] GP_433(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:53 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[0] = (coefs1[3] * coefs2[4]);
            tempArray[1] = (-1 * coefs1[2] * coefs2[5]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[1] * coefs2[7]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[3] = (-1 * tempArray[0]);
            ...
            tempArray[3] = (coefs2[2] * tempArray[0]);
            ...
            tempArray[5] = (-1 * coefs2[4] * tempArray[1]);
            ...
            tempArray[6] = (coefs2[4] * tempArray[2]);
            tempArray[7] = (coefs1[1] * tempArray[4]);
