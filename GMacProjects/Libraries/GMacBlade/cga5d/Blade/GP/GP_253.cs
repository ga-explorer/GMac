...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] GP_253(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:37 ص
            //Macro: main.cga5d.GP
            ...
            c[3] = (-1 * tempArray[0]);
            tempArray[0] = (-1 * coefs1[5] * coefs2[0]);
            c[4] = (-1 * tempArray[0]);
            ...
            tempArray[3] = (-1 * coefs1[3] * tempArray[0]);
            ...
            tempArray[5] = (coefs2[0] * tempArray[5]);
