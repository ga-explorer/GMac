...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] GP_143(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:54:22 ص
            //Macro: main.cga5d.GP
            ...
            tempArray[1] = (coefs1[3] * coefs2[2]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[4] = (-1 * tempArray[0]);
            tempArray[0] = (coefs1[1] * coefs2[1]);
            ...
            c[3] = (-1 * tempArray[1]);
            tempArray[1] = (-1 * coefs2[1] * tempArray[1]);
            ...
            tempArray[5] = (coefs2[3] * tempArray[1]);
