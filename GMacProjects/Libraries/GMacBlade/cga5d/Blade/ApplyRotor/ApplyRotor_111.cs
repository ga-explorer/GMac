...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyRotor_111(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:57:21 ص
            ...
            tempArray[5] = (tempArray[7] + tempArray[5]);
            tempArray[5] = (tempArray[0] * tempArray[5]);
            tempArray[7] = (tempArray[10] + tempArray[5]);
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[3] * tempArray[8]);
            tempArray[8] = (-1 * coefs1[2] * tempArray[11]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[1] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            ...
            tempArray[2] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
