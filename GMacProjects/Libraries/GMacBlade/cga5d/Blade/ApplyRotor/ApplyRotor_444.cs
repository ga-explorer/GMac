...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyRotor_444(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:58:09 ص
            ...
            tempArray[5] = (-1 * coefs2[4] * tempArray[0]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[6] = (coefs1[1] * tempArray[4]);
            ...
            tempArray[8] = (-1 * coefs1[1] * tempArray[5]);
            ...
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[7] = (tempArray[8] + tempArray[3]);
            ...
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[1] * tempArray[4]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[1] * tempArray[8]);
            tempArray[9] = (-1 * coefs1[2] * coefs2[1]);
            ...
            tempArray[10] = (-1 * coefs1[3] * coefs2[1]);
            tempArray[11] = (coefs1[1] * coefs2[3]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (coefs1[3] * tempArray[10]);
            ...
            tempArray[6] = (-1 * coefs1[2] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[7] = (-1 * coefs2[2] * tempArray[2]);
            tempArray[11] = (coefs1[2] * tempArray[5]);
            tempArray[7] = (tempArray[7] + tempArray[11]);
            tempArray[7] = (tempArray[0] * tempArray[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[11] = (tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[3] = (tempArray[7] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            ...
            tempArray[6] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[2] * tempArray[8]);
            ...
            tempArray[11] = (-1 * coefs1[3] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[11]);
            ...
            tempArray[11] = (coefs1[3] * tempArray[5]);
            tempArray[7] = (tempArray[7] + tempArray[11]);
            tempArray[7] = (tempArray[0] * tempArray[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[11] = (tempArray[0] * tempArray[6]);
            ...
            tempArray[8] = (coefs1[1] * tempArray[10]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            ...
            tempArray[1] = (-1 * coefs1[1] * tempArray[7]);
            tempArray[2] = (coefs1[2] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[3] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[2] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[1] * tempArray[5]);
            ...
            tempArray[5] = (-1 * coefs1[2] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[3] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[2]);
            tempArray[2] = (tempArray[4] + tempArray[2]);
            tempArray[4] = (tempArray[1] * tempArray[8]);
