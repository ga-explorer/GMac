...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyRotor_022(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:57:14 ص
            ...
            //Computations: 1.28048780487805 average, 105 total.
            ...
            c[2] = (coefs1[0] * tempArray[0]);
            tempArray[0] = (coefs1[0] * coefs2[4]);
            c[4] = (coefs1[0] * tempArray[0]);
            tempArray[0] = (-1 * coefs1[0] * coefs2[5]);
            c[5] = (-1 * coefs1[0] * tempArray[0]);
            ...
            tempArray[4] = (coefs2[0] * tempArray[0]);
            ...
            tempArray[6] = (coefs2[1] * tempArray[0]);
            ...
            tempArray[8] = (coefs2[3] * tempArray[0]);
