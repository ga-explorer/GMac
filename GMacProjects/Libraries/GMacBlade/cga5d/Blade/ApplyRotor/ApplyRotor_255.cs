...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyRotor_255(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:57:44 ص
            ...
            tempArray[5] = (-1 * coefs1[3] * tempArray[1]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[3] = (coefs2[0] * tempArray[3]);
            tempArray[6] = (tempArray[1] * tempArray[3]);
            ...
            tempArray[4] = (coefs2[0] * tempArray[4]);
            tempArray[4] = (-1 * tempArray[1] * tempArray[4]);
            tempArray[5] = (-1 * coefs1[0] * tempArray[1]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[3] = (-1 * coefs2[0] * tempArray[3]);
            tempArray[6] = (tempArray[1] * tempArray[3]);
            tempArray[6] = (tempArray[4] + tempArray[6]);
            ...
            tempArray[2] = (tempArray[5] + tempArray[7]);
