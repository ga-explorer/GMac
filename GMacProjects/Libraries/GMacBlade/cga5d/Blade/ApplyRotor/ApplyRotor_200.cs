...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyRotor_200(double[] coefs1, double[] coefs2)
        {
            var c = new double[1];
        
            //GMac Generated Processing Code, 14/04/2015 09:57:32 ص
            ...
            //Computations: 1.23809523809524 average, 104 total.
            ...
            tempArray[6] = (coefs1[3] * tempArray[1]);
            ...
            tempArray[7] = (-1 * coefs1[9] * tempArray[1]);
            ...
            tempArray[3] = (coefs1[8] * tempArray[1]);
            tempArray[4] = (tempArray[2] + tempArray[3]);
            tempArray[4] = (-1 * coefs2[0] * tempArray[4]);
            tempArray[5] = (-1 * tempArray[1] * tempArray[4]);
            tempArray[6] = (coefs1[1] * tempArray[1]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[3] = (-1 * coefs2[0] * tempArray[3]);
            tempArray[3] = (tempArray[1] * tempArray[3]);
            tempArray[5] = (tempArray[5] + tempArray[3]);
            ...
            tempArray[3] = (coefs1[7] * tempArray[1]);
            tempArray[4] = (tempArray[2] + tempArray[3]);
            ...
            tempArray[3] = (tempArray[1] * tempArray[3]);
            tempArray[4] = (tempArray[7] + tempArray[3]);
            tempArray[7] = (-1 * coefs1[7] * tempArray[1]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[4] = (tempArray[4] * tempArray[6]);
            tempArray[0] = (tempArray[0] + tempArray[4]);
