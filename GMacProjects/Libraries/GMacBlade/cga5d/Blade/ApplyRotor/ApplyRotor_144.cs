...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyRotor_144(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:57:28 ص
            ...
            tempArray[7] = (coefs1[2] * tempArray[4]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (tempArray[0] * tempArray[6]);
            ...
            tempArray[5] = (-1 * coefs1[2] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[3] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (tempArray[2] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
