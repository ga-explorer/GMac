...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyRotor_422(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:58:04 ص
            ...
            tempArray[4] = (coefs2[1] * tempArray[0]);
            tempArray[5] = (coefs2[8] * tempArray[0]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[6] = (-1 * coefs1[3] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs2[0] * tempArray[0]);
            tempArray[7] = (coefs2[7] * tempArray[0]);
            ...
            tempArray[9] = (coefs2[2] * tempArray[2]);
            tempArray[10] = (-1 * coefs2[1] * tempArray[0]);
            tempArray[5] = (tempArray[5] + tempArray[10]);
            tempArray[10] = (coefs1[3] * tempArray[5]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * coefs2[0] * tempArray[0]);
            ...
            tempArray[10] = (tempArray[0] * tempArray[8]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[3] = (tempArray[9] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[9] = (tempArray[10] + tempArray[3]);
            ...
            tempArray[7] = (-1 * tempArray[0] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (coefs1[3] * coefs2[2]);
            tempArray[8] = (-1 * coefs1[1] * coefs2[5]);
            ...
            tempArray[6] = (-1 * coefs1[1] * tempArray[6]);
            ...
            tempArray[6] = (tempArray[2] * tempArray[10]);
            c[4] = (tempArray[3] + tempArray[6]);
            tempArray[3] = (-1 * coefs2[5] * tempArray[1]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[1] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[8] = (-1 * coefs2[5] * tempArray[2]);
            tempArray[9] = (coefs1[2] * tempArray[8]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs1[1] * tempArray[5]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            ...
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[8] = (tempArray[9] + tempArray[3]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[5] = (coefs1[3] * tempArray[5]);
            tempArray[4] = (-1 * coefs1[1] * tempArray[4]);
            tempArray[4] = (tempArray[5] + tempArray[4]);
            tempArray[5] = (coefs1[2] * tempArray[7]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[3] = (tempArray[1] * tempArray[3]);
            tempArray[3] = (tempArray[4] + tempArray[3]);
            tempArray[4] = (tempArray[2] * tempArray[8]);
            c[5] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (coefs2[6] * tempArray[2]);
            tempArray[4] = (coefs1[1] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[2] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[3] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[0] * tempArray[3]);
            tempArray[5] = (-1 * coefs2[6] * tempArray[1]);
            tempArray[6] = (-1 * coefs1[1] * tempArray[8]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (coefs1[2] * tempArray[5]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[3] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            ...
            tempArray[6] = (-1 * coefs1[3] * coefs2[6]);
            tempArray[7] = (tempArray[1] * tempArray[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (tempArray[6] * tempArray[2]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[2] * coefs2[6]);
            tempArray[7] = (tempArray[1] * tempArray[5]);
            tempArray[4] = (tempArray[4] + tempArray[7]);
            tempArray[7] = (tempArray[4] * tempArray[2]);
            tempArray[4] = (tempArray[4] + tempArray[7]);
            tempArray[7] = (coefs1[1] * coefs2[6]);
            tempArray[8] = (-1 * tempArray[1] * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * tempArray[2] * tempArray[7]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[6] = (coefs1[3] * tempArray[6]);
            tempArray[4] = (coefs1[2] * tempArray[4]);
            tempArray[4] = (tempArray[6] + tempArray[4]);
            tempArray[6] = (coefs1[1] * tempArray[7]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            c[6] = (-1 * tempArray[1]);
            tempArray[1] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[2] = (-1 * coefs1[1] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[3] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[1] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[1] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[2] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            c[0] = (tempArray[2] + tempArray[3]);
            tempArray[2] = (coefs1[3] * tempArray[9]);
            tempArray[4] = (-1 * coefs1[1] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (coefs1[2] * tempArray[5]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
