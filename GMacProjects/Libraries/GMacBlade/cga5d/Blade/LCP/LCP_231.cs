...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] LCP_231(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
            ...
            tempArray[9] = (coefs2[0] * tempArray[0]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs1[5] * coefs2[3]);
            tempArray[10] = (-1 * coefs1[6] * coefs2[4]);
            ...
            tempArray[13] = (coefs1[4] * coefs2[3]);
            tempArray[14] = (coefs1[6] * coefs2[5]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[9] * tempArray[8]);
            c[2] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (-1 * coefs1[2] * coefs2[3]);
            tempArray[2] = (coefs1[6] * coefs2[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[11] * tempArray[4]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[3] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[5] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[9] * tempArray[6]);
            c[3] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (-1 * coefs2[7] * tempArray[1]);
            tempArray[2] = (-1 * coefs2[5] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs2[4] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[5] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[4] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[2] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[2] = (coefs2[7] * tempArray[2]);
            tempArray[3] = (coefs2[5] * tempArray[4]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs2[4] * tempArray[10]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs1[5] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs1[4] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (coefs1[2] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
