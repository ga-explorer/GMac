...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] LCP_121(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //GMac Generated Processing Code, 14/04/2015 09:53:47 ص
            ...
            tempArray[1] = (-1 * coefs2[6] * tempArray[1]);
            ...
            tempArray[2] = (coefs2[6] * tempArray[2]);
