...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] LCP_220(double[] coefs1, double[] coefs2)
        {
            var c = new double[1];
        
            //GMac Generated Processing Code, 14/04/2015 09:53:50 ص
            ...
            tempArray[5] = (coefs2[9] * tempArray[1]);
            ...
            tempArray[5] = (coefs2[7] * tempArray[1]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[2] = (tempArray[2] * tempArray[4]);
            tempArray[0] = (tempArray[0] + tempArray[2]);
