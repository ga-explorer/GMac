...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] LCP_352(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:53:53 ص
            ...
            tempArray[4] = (-1 * coefs1[2] * tempArray[0]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[2] = (-1 * coefs2[0] * tempArray[2]);
            ...
            tempArray[6] = (-1 * coefs1[1] * tempArray[0]);
            ...
            tempArray[6] = (-1 * coefs1[6] * tempArray[0]);
            ...
            tempArray[6] = (coefs2[0] * tempArray[6]);
            tempArray[6] = (tempArray[0] * tempArray[6]);
            c[3] = (tempArray[7] + tempArray[6]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            c[7] = (tempArray[2] + tempArray[1]);
