...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] LCP_132(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:53:48 ص
            ...
            tempArray[0] = (coefs1[1] * coefs2[4]);
            tempArray[1] = (coefs1[2] * coefs2[5]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[3] * coefs2[7]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            c[6] = (-1 * tempArray[0]);
            ...
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (coefs1[2] * coefs2[3]);
            tempArray[3] = (tempArray[3] * tempArray[2]);
            tempArray[3] = (tempArray[5] + tempArray[3]);
            tempArray[4] = (tempArray[1] * tempArray[4]);
            c[4] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (-1 * coefs2[2] * tempArray[0]);
            tempArray[4] = (-1 * coefs2[9] * tempArray[0]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            ...
            tempArray[2] = (-1 * coefs2[5] * tempArray[1]);
            ...
            tempArray[5] = (coefs2[5] * tempArray[2]);
            ...
            tempArray[4] = (-1 * coefs2[7] * tempArray[1]);
            ...
            tempArray[7] = (coefs2[7] * tempArray[2]);
            tempArray[8] = (-1 * coefs1[2] * tempArray[4]);
