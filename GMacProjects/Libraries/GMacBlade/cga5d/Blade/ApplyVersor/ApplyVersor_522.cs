...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyVersor_522(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //GMac Generated Processing Code, 14/04/2015 09:57:07 ص
            ...
            tempArray[1] = (-1 * coefs1[0] * coefs2[5]);
            tempArray[1] = (coefs1[0] * tempArray[1]);
            c[5] = (-1 * tempArray[0] * tempArray[1]);
            tempArray[1] = (coefs1[0] * coefs2[6]);
            tempArray[1] = (coefs1[0] * tempArray[1]);
            c[6] = (tempArray[0] * tempArray[1]);
            tempArray[1] = Math.Pow(2, -0.5);
            tempArray[2] = (coefs2[0] * tempArray[1]);
            tempArray[3] = (coefs2[7] * tempArray[1]);
            ...
            tempArray[4] = (coefs2[1] * tempArray[1]);
            tempArray[5] = (coefs2[8] * tempArray[1]);
            ...
            tempArray[7] = (tempArray[1] * tempArray[6]);
            ...
            tempArray[6] = (coefs2[3] * tempArray[1]);
            tempArray[7] = (coefs2[9] * tempArray[1]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[6] = (-1 * coefs1[0] * tempArray[6]);
            tempArray[6] = (-1 * tempArray[1] * tempArray[6]);
            tempArray[8] = (-1 * coefs2[3] * tempArray[1]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[7] = (coefs1[0] * tempArray[7]);
            ...
            tempArray[8] = (tempArray[9] + tempArray[6]);
            c[3] = (-1 * tempArray[0] * tempArray[8]);
            tempArray[3] = (tempArray[1] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            c[7] = (-1 * tempArray[0] * tempArray[2]);
