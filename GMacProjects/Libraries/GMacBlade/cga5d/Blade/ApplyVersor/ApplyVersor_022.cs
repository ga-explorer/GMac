...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyVersor_022(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:55:52 ص
            ...
            tempArray[4] = (-1 * tempArray[1] * tempArray[2]);
            tempArray[5] = (coefs2[0] * tempArray[1]);
            ...
            tempArray[6] = (-1 * tempArray[1] * tempArray[4]);
            tempArray[7] = (coefs2[1] * tempArray[1]);
            ...
            tempArray[6] = (-1 * coefs2[3] * tempArray[1]);
            tempArray[7] = (coefs2[9] * tempArray[1]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[6] = (-1 * coefs1[0] * tempArray[6]);
            tempArray[8] = (-1 * tempArray[1] * tempArray[6]);
            tempArray[9] = (coefs2[3] * tempArray[1]);
