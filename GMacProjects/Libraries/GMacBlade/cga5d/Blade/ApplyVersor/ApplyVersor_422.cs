...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyVersor_422(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:56:54 ص
            ...
            tempArray[8] = Math.Pow(coefs1[2], 2);
            tempArray[8] = (-1 * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = Math.Pow(coefs1[3], 2);
            tempArray[8] = (-1 * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = Math.Pow(tempArray[2], 2);
            tempArray[8] = (-1 * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = Math.Pow(tempArray[1], 2);
            tempArray[8] = (-1 * tempArray[8]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[7] = Math.Pow(tempArray[7], -1);
            tempArray[8] = (coefs1[3] * coefs2[2]);
            ...
            tempArray[10] = (coefs1[2] * tempArray[6]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[3] * tempArray[4]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[3] = (-1 * tempArray[1] * tempArray[3]);
            tempArray[3] = (tempArray[8] + tempArray[3]);
            tempArray[8] = (-1 * tempArray[2] * tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[8]);
            c[2] = (tempArray[7] * tempArray[3]);
            tempArray[3] = (-1 * coefs2[4] * tempArray[1]);
            tempArray[8] = (coefs2[3] * tempArray[0]);
            tempArray[9] = (coefs2[9] * tempArray[0]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[10] = (coefs1[3] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[1] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[11] = (-1 * coefs2[4] * tempArray[2]);
            tempArray[12] = (-1 * coefs2[3] * tempArray[0]);
            tempArray[9] = (tempArray[9] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[3] * tempArray[9]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[1] * tempArray[7]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[12] = (tempArray[0] * tempArray[10]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[3] = (tempArray[11] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[11] = (tempArray[12] + tempArray[3]);
            ...
            tempArray[9] = (tempArray[2] * tempArray[9]);
            ...
            tempArray[6] = (tempArray[2] * tempArray[11]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            c[4] = (tempArray[7] * tempArray[3]);
            ...
            tempArray[9] = (-1 * coefs2[5] * tempArray[2]);
            ...
            tempArray[9] = (tempArray[0] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[10] = (tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[3] = (tempArray[9] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[9] = (tempArray[10] + tempArray[3]);
            ...
            tempArray[6] = (-1 * coefs1[1] * tempArray[9]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            c[6] = (-1 * tempArray[7] * tempArray[1]);
            tempArray[1] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[2] = (-1 * coefs1[1] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            c[0] = (tempArray[2] * tempArray[7]);
            tempArray[2] = (coefs1[3] * tempArray[9]);
            tempArray[4] = (-1 * coefs1[1] * tempArray[9]);
            ...
            tempArray[4] = (tempArray[4] + tempArray[5]);
            c[1] = (tempArray[7] * tempArray[4]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[11]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[1] * tempArray[5]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[1] * tempArray[8]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[2] * tempArray[8]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[8] = (coefs1[3] * tempArray[3]);
            tempArray[9] = (coefs1[2] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs1[1] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[1] * tempArray[8]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (tempArray[2] * tempArray[8]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
