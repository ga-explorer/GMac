...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyVersor_133(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:56:07 ص
            ...
            tempArray[8] = (coefs1[2] * coefs2[5]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (coefs1[3] * coefs2[7]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            ...
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[11] = (tempArray[12] + tempArray[4]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[4] = (tempArray[4] + tempArray[10]);
            tempArray[10] = (coefs1[3] * coefs2[5]);
            tempArray[12] = (-1 * coefs1[2] * coefs2[7]);
            ...
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[10] = (coefs1[3] * tempArray[8]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            ...
            tempArray[9] = (coefs2[7] * tempArray[2]);
            tempArray[10] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[1] * tempArray[7]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            ...
            c[7] = (-1 * tempArray[5] * tempArray[1]);
            tempArray[1] = (-1 * coefs2[3] * tempArray[2]);
            tempArray[2] = (-1 * coefs1[1] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[6] = (tempArray[3] * tempArray[2]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            ...
            tempArray[7] = (-1 * tempArray[8] * tempArray[2]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[1] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[6] = (coefs1[1] * tempArray[6]);
            ...
            tempArray[3] = (coefs1[1] * tempArray[9]);
            ...
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[1] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[2] * tempArray[6]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            ...
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[1] * tempArray[1]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            ...
            c[2] = (tempArray[5] * tempArray[8]);
            tempArray[2] = (-1 * tempArray[0] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            c[6] = (tempArray[5] * tempArray[1]);
            tempArray[1] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[1] = (tempArray[3] + tempArray[1]);
            c[8] = (tempArray[5] * tempArray[1]);
            tempArray[0] = (-1 * tempArray[0] * tempArray[7]);
