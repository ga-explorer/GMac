...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyVersor_144(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //GMac Generated Processing Code, 14/04/2015 09:56:10 ص
            ...
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[0] * tempArray[7]);
            tempArray[4] = (tempArray[5] + tempArray[4]);
            tempArray[5] = Math.Pow(coefs1[1], 2);
            ...
            tempArray[7] = (-1 * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[7] = Math.Pow(tempArray[1], 2);
            tempArray[7] = (-1 * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[7] = Math.Pow(tempArray[2], 2);
            tempArray[7] = (-1 * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[5] = Math.Pow(tempArray[5], -1);
            tempArray[7] = (coefs1[1] * coefs2[1]);
            tempArray[8] = (-1 * coefs1[3] * coefs2[3]);
            ...
            tempArray[10] = (coefs1[3] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            ...
            tempArray[8] = (coefs1[1] * coefs2[2]);
            tempArray[10] = (coefs1[2] * coefs2[3]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[10] = (coefs1[1] * tempArray[8]);
            tempArray[9] = (-1 * coefs1[3] * tempArray[9]);
            tempArray[9] = (tempArray[10] + tempArray[9]);
            tempArray[10] = (-1 * coefs1[2] * tempArray[3]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[4] = (-1 * tempArray[2] * tempArray[4]);
            tempArray[4] = (tempArray[9] + tempArray[4]);
            tempArray[6] = (tempArray[1] * tempArray[6]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            c[2] = (tempArray[5] * tempArray[4]);
            tempArray[4] = (coefs2[3] * tempArray[1]);
            tempArray[6] = (coefs1[1] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[4] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[6] = (-1 * coefs2[3] * tempArray[2]);
            ...
            tempArray[8] = (-1 * coefs1[2] * tempArray[8]);
            tempArray[7] = (coefs1[3] * tempArray[7]);
            ...
            tempArray[4] = (coefs1[1] * tempArray[4]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (coefs1[3] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[2] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
