...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyVersor_444(double[] coefs1, double[] coefs2)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:57:00 ص
            ...
            tempArray[10] = (-1 * coefs1[2] * coefs2[1]);
            tempArray[11] = (coefs1[1] * coefs2[2]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[2] * tempArray[10]);
            tempArray[9] = (tempArray[9] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[3] * coefs2[1]);
            tempArray[12] = (coefs1[1] * coefs2[3]);
            ...
            tempArray[12] = (tempArray[0] * tempArray[7]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            ...
            tempArray[10] = (coefs1[1] * tempArray[10]);
            ...
            tempArray[12] = (-1 * coefs1[3] * tempArray[10]);
            tempArray[7] = (tempArray[7] + tempArray[12]);
            tempArray[9] = (-1 * tempArray[2] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[9]);
            ...
            tempArray[12] = (coefs1[3] * tempArray[5]);
            tempArray[9] = (tempArray[9] + tempArray[12]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[9]);
            tempArray[12] = (tempArray[0] * tempArray[7]);
            ...
            tempArray[8] = (coefs1[1] * tempArray[11]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[3] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
