...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyVersor_411(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //GMac Generated Processing Code, 14/04/2015 09:56:51 ص
            ...
            //Computations: 1.32 average, 198 total.
            ...
            tempArray[8] = (tempArray[3] + tempArray[8]);
            tempArray[10] = (tempArray[0] * tempArray[8]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[3] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[6] = (tempArray[10] + tempArray[3]);
            ...
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[1] * tempArray[8]);
            ...
            tempArray[7] = (-1 * coefs1[3] * tempArray[9]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[1] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
