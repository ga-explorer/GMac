namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyERotor_211(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[12] = (-1 * coefs1[2] * tempArray[2]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[1] * tempArray[3]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[4] * tempArray[4]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[3] * tempArray[5]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[5] * coefs2[1]);
            tempArray[13] = (coefs1[4] * coefs2[2]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[2] * coefs2[3]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[5] * tempArray[12]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[7] * tempArray[7]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[13] = (coefs1[6] * tempArray[8]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[8] * coefs2[1]);
            tempArray[14] = (coefs1[7] * coefs2[2]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[2] * coefs2[4]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[8] * tempArray[13]);
            ...
            tempArray[15] = (coefs1[2] * tempArray[0]);
            tempArray[11] = (tempArray[11] + tempArray[15]);
            tempArray[3] = (-1 * coefs1[0] * tempArray[3]);
            tempArray[3] = (tempArray[11] + tempArray[3]);
            tempArray[11] = (-1 * coefs1[5] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (coefs1[3] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (coefs1[4] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[8] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (coefs1[6] * tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (coefs1[7] * tempArray[13]);
            tempArray[3] = (tempArray[3] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[9] * coefs2[2]);
            tempArray[15] = (coefs1[8] * coefs2[3]);
            tempArray[11] = (tempArray[11] + tempArray[15]);
            tempArray[15] = (-1 * coefs1[5] * coefs2[4]);
            tempArray[11] = (tempArray[11] + tempArray[15]);
            tempArray[15] = (-1 * coefs1[9] * tempArray[11]);
            c[2] = (tempArray[3] + tempArray[15]);
            tempArray[3] = (coefs1[3] * tempArray[1]);
            tempArray[15] = (coefs1[4] * tempArray[0]);
            tempArray[3] = (tempArray[3] + tempArray[15]);
            tempArray[15] = (coefs1[5] * tempArray[2]);
            tempArray[3] = (tempArray[3] + tempArray[15]);
            ...
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (coefs1[7] * tempArray[14]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (coefs1[8] * tempArray[11]);
            c[3] = (tempArray[3] + tempArray[5]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (-1 * coefs1[2] * tempArray[13]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
