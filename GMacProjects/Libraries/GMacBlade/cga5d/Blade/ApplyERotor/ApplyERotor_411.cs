namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyERotor_411(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
            ...
            tempArray[4] = (-1 * coefs1[4] * coefs2[2]);
