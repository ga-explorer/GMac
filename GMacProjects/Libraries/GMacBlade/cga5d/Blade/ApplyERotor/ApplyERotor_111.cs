namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyERotor_111(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[3] = (-1 * coefs1[0] * coefs2[1]);
            ...
            tempArray[2] = (coefs1[2] * coefs2[1]);
            tempArray[6] = (-1 * coefs1[1] * coefs2[2]);
            tempArray[2] = (tempArray[2] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[2]);
            ...
            c[1] = (tempArray[1] + tempArray[8]);
            tempArray[1] = (-1 * coefs1[2] * tempArray[0]);
            tempArray[3] = (coefs1[0] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[2] = (coefs1[1] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[3] * coefs2[2]);
            tempArray[3] = (-1 * coefs1[2] * coefs2[3]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[3] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (coefs1[4] * coefs2[2]);
            tempArray[8] = (-1 * coefs1[2] * coefs2[4]);
            tempArray[3] = (tempArray[3] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[4] * tempArray[3]);
            c[2] = (tempArray[1] + tempArray[8]);
            tempArray[1] = (-1 * coefs1[3] * tempArray[0]);
            tempArray[4] = (coefs1[0] * tempArray[4]);
            tempArray[1] = (tempArray[1] + tempArray[4]);
            tempArray[4] = (coefs1[1] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[4]);
            tempArray[2] = (coefs1[2] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (coefs1[4] * coefs2[3]);
            tempArray[4] = (-1 * coefs1[3] * coefs2[4]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[4] * tempArray[2]);
            c[3] = (tempArray[1] + tempArray[4]);
            tempArray[0] = (-1 * coefs1[4] * tempArray[0]);
            tempArray[1] = (coefs1[0] * tempArray[5]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[1] * tempArray[7]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[2] * tempArray[3]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[3] * tempArray[2]);
