namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyERotor_133(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[7] = (coefs1[2] * coefs2[2]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[4] * coefs2[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[11]);
            tempArray[11] = (coefs1[1] * tempArray[1]);
            tempArray[0] = (tempArray[0] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[0] * coefs2[4]);
            tempArray[12] = (coefs1[2] * coefs2[6]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[3] * coefs2[8]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[0] * tempArray[11]);
            tempArray[0] = (tempArray[0] + tempArray[12]);
            tempArray[12] = (coefs1[2] * tempArray[5]);
            tempArray[0] = (tempArray[0] + tempArray[12]);
            tempArray[12] = (coefs1[3] * tempArray[8]);
            c[4] = (tempArray[0] + tempArray[12]);
            ...
            tempArray[2] = (tempArray[2] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[0] * tempArray[2]);
            tempArray[0] = (tempArray[0] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[1] * tempArray[5]);
            tempArray[0] = (tempArray[0] + tempArray[12]);
            tempArray[12] = (coefs1[3] * tempArray[10]);
            c[5] = (tempArray[0] + tempArray[12]);
            tempArray[0] = (-1 * coefs1[4] * tempArray[3]);
            tempArray[3] = (coefs1[2] * tempArray[11]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[1] * tempArray[8]);
            tempArray[0] = (tempArray[0] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[2] * tempArray[10]);
            ...
            c[8] = (tempArray[0] + tempArray[3]);
            tempArray[0] = (-1 * coefs1[4] * tempArray[9]);
