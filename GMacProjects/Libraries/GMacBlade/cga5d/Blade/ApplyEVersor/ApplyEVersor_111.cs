...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyEVersor_111(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[7] = (-1 * coefs1[2] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[7]);
            tempArray[7] = (coefs1[3] * coefs2[1]);
            tempArray[8] = (-1 * coefs1[1] * coefs2[3]);
            ...
            tempArray[9] = (-1 * coefs1[2] * coefs2[4]);
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[9] = (-1 * coefs1[4] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[9]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[1] * tempArray[8]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
