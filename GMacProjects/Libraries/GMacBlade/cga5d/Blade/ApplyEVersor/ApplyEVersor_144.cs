...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double[] ApplyEVersor_144(double[] coefs1, double[] coefs2)
        {
            ...
            tempArray[7] = (coefs1[2] * tempArray[1]);
            ...
            tempArray[9] = (coefs1[0] * tempArray[8]);
            tempArray[0] = (tempArray[0] + tempArray[9]);
            tempArray[9] = (coefs1[3] * tempArray[5]);
            tempArray[0] = (tempArray[0] + tempArray[9]);
            c[1] = (tempArray[6] * tempArray[0]);
            ...
            tempArray[9] = (coefs1[0] * tempArray[2]);
            tempArray[0] = (tempArray[0] + tempArray[9]);
            tempArray[9] = (-1 * coefs1[2] * tempArray[5]);
            tempArray[0] = (tempArray[0] + tempArray[9]);
            c[2] = (tempArray[6] * tempArray[0]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[3]);
            c[3] = (tempArray[6] * tempArray[0]);
            tempArray[0] = (-1 * coefs1[4] * tempArray[4]);
            tempArray[3] = (coefs1[3] * tempArray[8]);
            tempArray[0] = (tempArray[0] + tempArray[3]);
