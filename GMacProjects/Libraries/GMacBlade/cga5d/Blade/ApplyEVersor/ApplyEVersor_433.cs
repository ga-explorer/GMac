...
namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] ApplyEVersor_433(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
            ...
            //Computations: 1.24 average, 248 total.
            ...
            tempArray[9] = (coefs1[3] * coefs2[1]);
            tempArray[10] = (-1 * coefs1[2] * coefs2[2]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (coefs1[0] * coefs2[7]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (coefs1[3] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[1] * tempArray[5]);
            tempArray[7] = (tempArray[7] + tempArray[10]);
            c[1] = (tempArray[6] * tempArray[7]);
            tempArray[7] = (-1 * coefs1[0] * coefs2[2]);
            ...
            tempArray[11] = (coefs1[3] * tempArray[2]);
            ...
            tempArray[12] = (coefs1[0] * coefs2[9]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[4] * tempArray[11]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[2] * tempArray[9]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (coefs1[1] * tempArray[4]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            c[2] = (tempArray[6] * tempArray[10]);
            tempArray[10] = (coefs1[0] * coefs2[3]);
            tempArray[12] = (coefs1[1] * coefs2[6]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (coefs1[2] * coefs2[8]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (coefs1[3] * coefs2[9]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[0] * tempArray[10]);
            tempArray[2] = (coefs1[4] * tempArray[2]);
            tempArray[2] = (tempArray[12] + tempArray[2]);
            tempArray[12] = (-1 * coefs1[3] * tempArray[11]);
            tempArray[2] = (tempArray[2] + tempArray[12]);
            tempArray[12] = (coefs1[2] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[1] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[12]);
            c[3] = (tempArray[6] * tempArray[2]);
            tempArray[2] = (-1 * coefs1[1] * tempArray[1]);
            tempArray[12] = (-1 * coefs1[2] * tempArray[0]);
            tempArray[2] = (tempArray[2] + tempArray[12]);
            tempArray[12] = (coefs1[4] * coefs2[4]);
            tempArray[13] = (-1 * coefs1[2] * coefs2[6]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (coefs1[1] * coefs2[8]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (coefs1[4] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[3] * coefs2[4]);
            tempArray[14] = (coefs1[2] * coefs2[5]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[1] * coefs2[7]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            ...
            tempArray[2] = (-1 * coefs1[2] * tempArray[12]);
            tempArray[0] = (tempArray[0] + tempArray[2]);
            tempArray[2] = (coefs1[0] * tempArray[3]);
            tempArray[0] = (tempArray[0] + tempArray[2]);
            c[6] = (tempArray[6] * tempArray[0]);
            tempArray[0] = (coefs1[2] * tempArray[7]);
