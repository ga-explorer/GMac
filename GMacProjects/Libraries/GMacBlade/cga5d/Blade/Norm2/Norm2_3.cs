...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        private static double Norm2_3(double[] coefs)
        {
            ...
            //GMac Generated Processing Code, 14/04/2015 09:53:29 ص
            ...
            tempArray[0] = Math.Pow(coefs[3], 2);
            ...
            tempArray[2] = Math.Pow(coefs[7], 2);
            ...
            tempArray[2] = (tempArray[3] * tempArray[2]);
            tempArray[0] = (tempArray[0] + tempArray[2]);
            tempArray[2] = (coefs[2] * tempArray[1]);
            tempArray[3] = (-1 * coefs[9] * tempArray[1]);
            tempArray[4] = (tempArray[2] + tempArray[3]);
            tempArray[5] = (-1 * coefs[2] * tempArray[1]);
