namespace GMacBlade.cga5d
{
    ...
    {
        private static double[] SelfEGP_224(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
            ...
            tempVar0000 = (-2 * coefs1[2] * coefs1[3]);
            tempVar0001 = (2 * coefs1[1] * coefs1[4]);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (-2 * coefs1[0] * coefs1[5]);
            c[0] = (tempVar0000 + tempVar0001);
            tempVar0000 = (-2 * coefs1[2] * coefs1[6]);
            tempVar0001 = (2 * coefs1[1] * coefs1[7]);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (-2 * coefs1[0] * coefs1[8]);
            c[1] = (tempVar0000 + tempVar0001);
            tempVar0000 = (-2 * coefs1[4] * coefs1[6]);
            tempVar0001 = (2 * coefs1[3] * coefs1[7]);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (-2 * coefs1[0] * coefs1[9]);
            c[2] = (tempVar0000 + tempVar0001);
            tempVar0000 = (-2 * coefs1[5] * coefs1[6]);
            tempVar0001 = (2 * coefs1[3] * coefs1[8]);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (-2 * coefs1[1] * coefs1[9]);
            c[3] = (tempVar0000 + tempVar0001);
            tempVar0000 = (-2 * coefs1[5] * coefs1[7]);
            tempVar0001 = (2 * coefs1[4] * coefs1[8]);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (-2 * coefs1[2] * coefs1[9]);
