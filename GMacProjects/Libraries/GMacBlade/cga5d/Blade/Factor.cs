...
namespace GMacBlade.cga5d
{
    ...
    public sealed partial class cga5dBlade
    {
        ...
        private static cga5dVector[] FactorGrade2(double[] coefs)
        {
        ...
        private static cga5dVector[] FactorGrade3(double[] coefs)
        {
        ...
        private static cga5dVector[] FactorGrade4(double[] coefs)
        {
        ...
        public cga5dFactoredBlade Factor()
        {
            if (IsZero)
                return new cga5dFactoredBlade(0.0D);
        
            switch (Grade)
            {
                case 0:
                    return new cga5dFactoredBlade(Coefs[0]);
        
                case 1:
                    var vector = ToVector();
                    var norm = vector.Normalize();
                    return new cga5dFactoredBlade(norm, vector);
        
                case 2:
                    return new cga5dFactoredBlade(EMag_2(Coefs), FactorGrade2(Coefs));
                
                case 3:
                    return new cga5dFactoredBlade(EMag_3(Coefs), FactorGrade3(Coefs));
                
                case 4:
                    return new cga5dFactoredBlade(EMag_4(Coefs), FactorGrade4(Coefs));
                
                case 5:
                    return new cga5dFactoredBlade(Coefs[0],  cga5dVector.BasisVectors());
            }
