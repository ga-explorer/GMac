...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyEVersor_344(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:02.2505686+02:00
            ...
            //Computations: 1.22325581395349 average, 263 total.
            ...
            tempArray[12] = (-1 * coefs1[5] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[12]);
            tempArray[12] = (coefs1[4] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[9] * coefs2[1]);
            tempArray[13] = (coefs1[6] * coefs2[3]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[5] * coefs2[4]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (-1 * coefs1[9] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[13]);
            tempArray[13] = (coefs1[8] * coefs2[1]);
            tempArray[14] = (-1 * coefs1[6] * coefs2[2]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs1[4] * coefs2[4]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs1[8] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[7] * coefs2[1]);
            tempArray[15] = (coefs1[5] * coefs2[2]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[15] = (-1 * coefs1[4] * coefs2[3]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[15] = (-1 * coefs1[7] * tempArray[14]);
            tempArray[1] = (tempArray[1] + tempArray[15]);
            tempArray[15] = (coefs1[0] * coefs2[1]);
            tempArray[16] = (coefs1[1] * coefs2[2]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (coefs1[2] * coefs2[3]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (coefs1[3] * coefs2[4]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (-1 * coefs1[0] * tempArray[15]);
            tempArray[1] = (tempArray[1] + tempArray[16]);
            tempArray[16] = (-1 * coefs1[3] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[16]);
            tempArray[16] = (coefs1[2] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[16]);
            tempArray[16] = (-1 * coefs1[1] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[16]);
            c[1] = (tempArray[11] * tempArray[1]);
            tempArray[1] = (coefs1[8] * tempArray[0]);
            tempArray[16] = (-1 * coefs1[7] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[16]);
            tempArray[16] = (coefs1[9] * coefs2[2]);
            tempArray[17] = (-1 * coefs1[8] * coefs2[3]);
            tempArray[16] = (tempArray[16] + tempArray[17]);
            tempArray[17] = (coefs1[7] * coefs2[4]);
            tempArray[16] = (tempArray[16] + tempArray[17]);
            tempArray[17] = (coefs1[9] * tempArray[16]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (coefs1[4] * tempArray[4]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (-1 * coefs1[6] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (coefs1[5] * tempArray[14]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (-1 * coefs1[1] * tempArray[15]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (coefs1[3] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[17] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[17]);
            tempArray[10] = (coefs1[0] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[10]);
            c[2] = (tempArray[11] * tempArray[1]);
            tempArray[0] = (coefs1[9] * tempArray[0]);
            tempArray[1] = (-1 * coefs1[7] * tempArray[3]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (-1 * coefs1[8] * tempArray[16]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[5] * tempArray[4]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[6] * tempArray[12]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (-1 * coefs1[4] * tempArray[14]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (coefs1[7] * tempArray[16]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            ...
            tempArray[0] = (tempArray[0] + tempArray[1]);
            tempArray[1] = (-1 * coefs1[3] * tempArray[15]);
            tempArray[0] = (tempArray[0] + tempArray[1]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:02.2735700+02:00
