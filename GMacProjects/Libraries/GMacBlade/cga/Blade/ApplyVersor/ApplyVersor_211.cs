...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyVersor_211(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:46:16.2229360+02:00
            ...
            //Computations: 1.28169014084507 average, 364 total.
            ...
            tempArray[20] = (-1 * tempArray[20]);
            tempArray[18] = (tempArray[18] + tempArray[20]);
            tempArray[20] = Math.Pow(coefs1[6], 2);
            tempArray[20] = (-1 * tempArray[20]);
            tempArray[18] = (tempArray[18] + tempArray[20]);
            ...
            tempArray[3] = (-1 * coefs1[4] * tempArray[24]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[25]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[6] * tempArray[11]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[5] * coefs2[1]);
            tempArray[7] = (-1 * coefs1[4] * coefs2[2]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (coefs1[2] * coefs2[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (coefs1[5] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[19] * tempArray[13]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[1] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[22] * tempArray[15]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[5] * tempArray[17]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (tempArray[16] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (tempArray[14] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            c[1] = (tempArray[2] * tempArray[3]);
            tempArray[3] = (-1 * coefs2[2] * tempArray[3]);
            tempArray[7] = (coefs2[3] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[5] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            ...
            tempArray[9] = (-1 * coefs1[5] * tempArray[11]);
            tempArray[7] = (tempArray[7] + tempArray[9]);
            ...
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * coefs1[2] * coefs2[2]);
            tempArray[18] = (-1 * coefs1[4] * coefs2[3]);
            tempArray[11] = (tempArray[11] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[10] * tempArray[12]);
            tempArray[11] = (tempArray[11] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[11] * tempArray[9]);
            tempArray[11] = (tempArray[11] + tempArray[18]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[9] = (coefs1[5] * tempArray[24]);
            tempArray[10] = (coefs1[6] * tempArray[10]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[2] * tempArray[11]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (coefs1[4] * tempArray[6]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (tempArray[7] * tempArray[13]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (tempArray[1] * tempArray[3]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[15] * tempArray[4]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[14] * tempArray[5]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[22] * tempArray[16]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[8] * tempArray[17]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            c[2] = (tempArray[2] * tempArray[9]);
            tempArray[9] = (coefs1[6] * coefs2[3]);
            tempArray[10] = (-1 * tempArray[2] * tempArray[12]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (tempArray[3] * tempArray[11]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[9] = (coefs1[6] * tempArray[9]);
            tempArray[10] = (-1 * coefs1[5] * tempArray[25]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * coefs1[4] * tempArray[11]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[6]);
            tempArray[6] = (tempArray[9] + tempArray[6]);
            tempArray[4] = (-1 * tempArray[13] * tempArray[4]);
            tempArray[4] = (tempArray[6] + tempArray[4]);
            tempArray[1] = (-1 * tempArray[14] * tempArray[1]);
            tempArray[1] = (tempArray[4] + tempArray[1]);
            tempArray[4] = (-1 * tempArray[7] * tempArray[15]);
            tempArray[1] = (tempArray[1] + tempArray[4]);
            tempArray[3] = (-1 * tempArray[5] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[19] * tempArray[16]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[8] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[2] * tempArray[22]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[24] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[9] * tempArray[1]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[25] * tempArray[15]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[10] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[11] * tempArray[16]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[11] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[3] = (-1 * coefs1[6] * tempArray[4]);
            tempArray[4] = (-1 * coefs1[5] * tempArray[3]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[4] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[2] * tempArray[17]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[13] * tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[24] * tempArray[1]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[15] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[25] * tempArray[5]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[16] * tempArray[11]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[11] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[4] = (tempArray[1] + tempArray[4]);
            c[0] = (tempArray[4] * tempArray[2]);
            tempArray[0] = (tempArray[0] * tempArray[3]);
            tempArray[0] = (tempArray[1] + tempArray[0]);
            c[4] = (tempArray[2] * tempArray[0]);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:46:16.2449373+02:00
