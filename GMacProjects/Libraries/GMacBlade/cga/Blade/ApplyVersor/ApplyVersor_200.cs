...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyVersor_200(double[] coefs1, double[] coefs2)
        {
            var c = new double[1];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:46:15.5418971+02:00
            ...
            //Computations: 1.18348623853211 average, 129 total.
            ...
            tempArray[2] = (-1 * coefs1[3] * tempArray[1]);
            ...
            tempArray[7] = (coefs1[3] * tempArray[1]);
            ...
            tempArray[9] = (-1 * tempArray[1] * tempArray[6]);
            ...
            tempArray[8] = (tempArray[8] * tempArray[7]);
            ...
            tempArray[10] = (coefs1[7] * tempArray[1]);
            ...
            tempArray[16] = (tempArray[16] * tempArray[15]);
            ...
            tempArray[13] = (-1 * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[13]);
            tempArray[13] = Math.Pow(coefs1[6], 2);
            tempArray[13] = (-1 * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[13]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:46:15.5508976+02:00
