...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyVersor_122(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:46:13.2097637+02:00
            ...
            //Computations: 1.25724637681159 average, 347 total.
            ...
            tempArray[6] = (coefs2[7] * tempArray[0]);
            ...
            tempArray[7] = (coefs2[2] * tempArray[2]);
            tempArray[8] = (coefs1[1] * tempArray[3]);
            ...
            tempArray[10] = (coefs1[2] * coefs2[2]);
            tempArray[11] = (coefs1[3] * coefs2[4]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (tempArray[5] * tempArray[2]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (tempArray[1] * tempArray[6]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            ...
            tempArray[11] = (coefs1[1] * coefs2[2]);
            tempArray[12] = (-1 * coefs1[3] * coefs2[5]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (-1 * tempArray[3] * tempArray[2]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (-1 * tempArray[1] * tempArray[4]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[1] * tempArray[11]);
            tempArray[13] = (-1 * coefs1[2] * tempArray[10]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (coefs1[3] * coefs2[2]);
            tempArray[14] = (-1 * coefs1[2] * coefs2[4]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs1[1] * coefs2[5]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs1[3] * tempArray[13]);
            tempArray[12] = (tempArray[12] + tempArray[14]);
            tempArray[8] = (tempArray[2] * tempArray[8]);
            ...
            tempArray[8] = (coefs2[9] * tempArray[0]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[12] = (coefs2[3] * tempArray[0]);
            tempArray[8] = (tempArray[8] + tempArray[12]);
            tempArray[12] = (coefs2[4] * tempArray[2]);
            tempArray[14] = (coefs1[1] * tempArray[7]);
            tempArray[12] = (tempArray[12] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[3] * tempArray[5]);
            tempArray[12] = (tempArray[12] + tempArray[14]);
            tempArray[12] = (-1 * tempArray[0] * tempArray[12]);
            tempArray[14] = (coefs2[4] * tempArray[1]);
            ...
            tempArray[15] = (coefs1[1] * coefs2[4]);
            tempArray[16] = (coefs1[2] * coefs2[5]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (-1 * tempArray[7] * tempArray[2]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (-1 * tempArray[1] * tempArray[8]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = (coefs1[1] * tempArray[15]);
            tempArray[10] = (-1 * coefs1[3] * tempArray[10]);
            tempArray[10] = (tempArray[16] + tempArray[10]);
            tempArray[16] = (-1 * coefs1[2] * tempArray[13]);
            tempArray[10] = (tempArray[10] + tempArray[16]);
            tempArray[14] = (tempArray[2] * tempArray[14]);
            tempArray[10] = (tempArray[10] + tempArray[14]);
            tempArray[12] = (tempArray[1] * tempArray[12]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            c[4] = (tempArray[9] * tempArray[10]);
            tempArray[10] = (-1 * coefs2[5] * tempArray[2]);
            tempArray[12] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[12] = (coefs1[3] * tempArray[3]);
            tempArray[10] = (tempArray[10] + tempArray[12]);
            tempArray[10] = (-1 * tempArray[0] * tempArray[10]);
            tempArray[12] = (-1 * coefs2[5] * tempArray[1]);
            ...
            tempArray[10] = (tempArray[10] + tempArray[14]);
            tempArray[14] = (-1 * coefs1[2] * tempArray[15]);
            tempArray[11] = (coefs1[3] * tempArray[11]);
            tempArray[11] = (tempArray[14] + tempArray[11]);
            tempArray[13] = (-1 * coefs1[1] * tempArray[13]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[12] = (-1 * tempArray[2] * tempArray[12]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[10] = (-1 * tempArray[1] * tempArray[10]);
            tempArray[10] = (tempArray[11] + tempArray[10]);
            c[5] = (tempArray[9] * tempArray[10]);
            tempArray[10] = (-1 * coefs2[6] * tempArray[1]);
            tempArray[11] = (coefs1[3] * tempArray[7]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (coefs1[2] * tempArray[3]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (coefs1[1] * tempArray[5]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[11] = (coefs2[6] * tempArray[2]);
            tempArray[12] = (coefs1[3] * tempArray[8]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[2] * tempArray[4]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            tempArray[12] = (coefs1[1] * tempArray[6]);
            tempArray[11] = (tempArray[11] + tempArray[12]);
            ...
            c[6] = (-1 * tempArray[9] * tempArray[1]);
            tempArray[1] = (coefs1[1] * tempArray[11]);
            tempArray[2] = (-1 * coefs1[3] * tempArray[14]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * coefs1[2] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[3] = (coefs1[1] * tempArray[6]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[2] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[2] * tempArray[5]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[1] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            c[0] = (tempArray[2] * tempArray[9]);
            tempArray[2] = (-1 * coefs1[2] * tempArray[11]);
            tempArray[4] = (coefs1[3] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[1] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (tempArray[2] * tempArray[11]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (tempArray[1] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[0] * tempArray[2]);
            tempArray[5] = (-1 * coefs1[2] * tempArray[6]);
            tempArray[6] = (coefs1[3] * tempArray[10]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[1] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[2] * tempArray[3]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (tempArray[1] * tempArray[11]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[5] = (tempArray[0] * tempArray[5]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            c[1] = (tempArray[9] * tempArray[4]);
            tempArray[4] = (-1 * coefs1[3] * tempArray[11]);
            tempArray[6] = (-1 * coefs1[2] * tempArray[12]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[1] * tempArray[14]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[2] * tempArray[15]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[1] * tempArray[4]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[7] = (-1 * coefs1[3] * tempArray[6]);
            tempArray[8] = (-1 * coefs1[2] * tempArray[10]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * coefs1[1] * tempArray[12]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (-1 * tempArray[2] * tempArray[4]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (tempArray[1] * tempArray[15]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[7] = (tempArray[0] * tempArray[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            c[3] = (tempArray[9] * tempArray[6]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[1] = (tempArray[3] + tempArray[1]);
            c[7] = (tempArray[9] * tempArray[1]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:46:13.2307649+02:00
