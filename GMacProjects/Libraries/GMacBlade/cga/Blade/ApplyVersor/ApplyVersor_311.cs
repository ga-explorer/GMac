...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyVersor_311(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:46:20.1691617+02:00
            ...
            //Computations: 1.22535211267606 average, 348 total.
            ...
            tempArray[26] = (tempArray[2] * tempArray[9]);
            tempArray[25] = (tempArray[25] + tempArray[26]);
            tempArray[26] = (-1 * tempArray[3] * tempArray[8]);
            tempArray[25] = (tempArray[25] + tempArray[26]);
            tempArray[1] = (tempArray[1] + tempArray[24]);
            tempArray[24] = (coefs1[3] * coefs2[2]);
            tempArray[26] = (tempArray[7] * tempArray[9]);
            tempArray[24] = (tempArray[24] + tempArray[26]);
            tempArray[26] = (tempArray[8] * tempArray[6]);
            tempArray[24] = (tempArray[24] + tempArray[26]);
            tempArray[26] = (coefs1[8] * tempArray[0]);
            tempArray[13] = (tempArray[13] + tempArray[26]);
            tempArray[5] = (tempArray[5] + tempArray[26]);
            tempArray[26] = (coefs1[6] * tempArray[0]);
            tempArray[17] = (tempArray[17] + tempArray[26]);
            tempArray[27] = (-1 * coefs1[5] * coefs2[1]);
            tempArray[28] = (coefs1[4] * coefs2[2]);
            ...
            tempArray[9] = (tempArray[14] + tempArray[26]);
            ...
            tempArray[19] = (-1 * tempArray[19]);
            tempArray[18] = (tempArray[18] + tempArray[19]);
            tempArray[15] = (tempArray[15] * tempArray[9]);
            tempArray[15] = (tempArray[18] + tempArray[15]);
            tempArray[16] = (tempArray[16] * tempArray[17]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[16] = Math.Pow(coefs1[7], 2);
            tempArray[16] = (-1 * tempArray[16]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[6] = (tempArray[6] * tempArray[5]);
            tempArray[6] = (tempArray[15] + tempArray[6]);
            ...
            tempArray[3] = (coefs1[4] * coefs2[1]);
            tempArray[6] = (coefs1[5] * coefs2[2]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[7] * coefs2[3]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[5] * tempArray[3]);
            tempArray[7] = (-1 * coefs1[7] * tempArray[25]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs1[3] * tempArray[24]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (coefs1[4] * tempArray[8]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            ...
            tempArray[6] = (tempArray[23] * tempArray[13]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[5] * tempArray[14]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[17] * tempArray[10]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[20] * tempArray[9]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            c[2] = (tempArray[2] * tempArray[4]);
            tempArray[4] = (coefs2[3] * tempArray[3]);
            tempArray[6] = (-1 * coefs2[1] * tempArray[16]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * coefs1[5] * tempArray[8]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[7] = (coefs2[3] * tempArray[2]);
            tempArray[8] = (-1 * coefs2[1] * tempArray[15]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[8] = (coefs1[5] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[8]);
            tempArray[7] = (tempArray[0] * tempArray[7]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[8] = (tempArray[0] * tempArray[6]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[4] = (tempArray[7] + tempArray[4]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[7] = (tempArray[8] + tempArray[4]);
            tempArray[8] = (-1 * coefs1[7] * coefs2[1]);
            tempArray[12] = (coefs1[4] * coefs2[3]);
            tempArray[8] = (tempArray[8] + tempArray[12]);
            tempArray[12] = (-1 * tempArray[6] * tempArray[9]);
            tempArray[8] = (tempArray[8] + tempArray[12]);
            tempArray[12] = (tempArray[7] * tempArray[8]);
            tempArray[8] = (tempArray[8] + tempArray[12]);
            tempArray[12] = (-1 * coefs1[3] * coefs2[3]);
            tempArray[15] = (tempArray[9] * tempArray[16]);
            tempArray[12] = (tempArray[12] + tempArray[15]);
            tempArray[15] = (tempArray[8] * tempArray[15]);
            tempArray[12] = (tempArray[12] + tempArray[15]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[3] = (coefs1[7] * tempArray[3]);
            tempArray[6] = (coefs1[5] * tempArray[25]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[4] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (coefs1[3] * tempArray[12]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            ...
            tempArray[3] = (-1 * tempArray[13] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[20] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[23] * tempArray[17]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[9] * tempArray[14]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            c[3] = (tempArray[2] * tempArray[1]);
            tempArray[1] = (coefs1[3] * coefs2[1]);
            tempArray[3] = (-1 * tempArray[3] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[8] * tempArray[2]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * coefs1[4] * tempArray[3]);
            tempArray[1] = (-1 * coefs1[3] * tempArray[1]);
            tempArray[1] = (tempArray[3] + tempArray[1]);
            tempArray[3] = (coefs1[7] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (coefs1[5] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[23] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[17] * tempArray[4]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[7] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            c[1] = (tempArray[2] * tempArray[1]);
            tempArray[1] = (coefs1[7] * tempArray[12]);
            tempArray[3] = (coefs1[5] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (coefs1[4] * tempArray[20]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (coefs1[3] * tempArray[23]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[1] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[25] * tempArray[1]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[24] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (tempArray[8] * tempArray[5]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            ...
            tempArray[3] = (-1 * coefs1[7] * tempArray[4]);
            tempArray[4] = (-1 * coefs1[5] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * coefs1[4] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (coefs1[3] * tempArray[14]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[11] * tempArray[25]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[1] * tempArray[1]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[13] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[24] * tempArray[5]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[17] * tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (tempArray[12] * tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:46:20.1901629+02:00
