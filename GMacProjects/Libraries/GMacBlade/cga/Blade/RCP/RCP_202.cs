...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] RCP_202(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:41.7219627+02:00
            ...
            c[4] = (coefs1[4] * coefs2[0]);
            c[5] = (-1 * coefs1[5] * coefs2[0]);
            ...
            tempVar0004 = (coefs1[0] * tempVar0000);
            ...
            tempVar0003 = (-1 * coefs1[1] * tempVar0000);
            ...
            tempVar0006 = (coefs1[1] * tempVar0000);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:41.7269630+02:00
