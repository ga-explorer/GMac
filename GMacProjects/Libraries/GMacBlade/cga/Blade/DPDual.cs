...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Blade DPDual_00(double[] coefs1, double[] coefs2)
        {
        ...
        private static cga0001Blade DPDual_01(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_02(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_03(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_04(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_05(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_10(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_11(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_12(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_13(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_14(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_15(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_20(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_21(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_22(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_23(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_24(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_25(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_30(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_31(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_32(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_33(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_34(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_35(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_40(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_41(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_42(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_43(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_44(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_45(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_50(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_51(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_52(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_53(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_54(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        private static cga0001Blade DPDual_55(double[] coefs1, double[] coefs2)
        {
            //Try all Euclidean geometric products for these two input grades starting from largest to smallest
            //output grade
        ...
        public cga0001Blade DPDual(cga0001Blade blade2)
        {
