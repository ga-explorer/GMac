...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor11(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:11.2470832+02:00
            //Macro: geometry3d.cga.Factor3
            //Input Variables: 3 used, 10 not used, 13 total.
            //Temp Variables: 249 sub-expressions, 0 generated temps, 249 total.
            //Target Temp Variables: 17 total.
            //Output Variables: 15 total.
            //Computations: 1.27272727272727 average, 336 total.
            //Memory Reads: 2.01893939393939 average, 533 total.
            //Memory Writes: 264 total.
            //
            //Macro Binding Data: 
            ...
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs[4] * tempArray[0] * tempArray[6]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs[4] * tempArray[0] * tempArray[7]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[3] = (coefs[3] * tempArray[3]);
            vectors[0].C3 = (tempArray[8] + tempArray[3]);
            tempArray[3] = (tempArray[0] * tempArray[6]);
            tempArray[8] = (-1 * tempArray[0] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[8]);
            tempArray[8] = (-1 * coefs[5] * tempArray[0] * tempArray[1]);
            tempArray[9] = (-1 * coefs[5] * tempArray[0] * tempArray[2]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs[4] * tempArray[0] * tempArray[4]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (coefs[4] * tempArray[0] * tempArray[5]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[3] = (-1 * coefs[3] * tempArray[3]);
            vectors[0].C4 = (tempArray[8] + tempArray[3]);
            tempArray[3] = Math.Pow(coefs[4], 2);
            tempArray[8] = (tempArray[0] * tempArray[3]);
            tempArray[9] = Math.Pow(coefs[5], 2);
            tempArray[10] = (-1 * tempArray[0] * tempArray[9]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[10] = Math.Pow(coefs[7], 2);
            tempArray[11] = (-1 * tempArray[0] * tempArray[10]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (tempArray[1] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (tempArray[4] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            ...
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[9] = (tempArray[5] * tempArray[3]);
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[9] = (tempArray[7] * tempArray[3]);
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[0] * tempArray[3]);
            vectors[0].C1 = (tempArray[8] + tempArray[9]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            vectors[0].C5 = (tempArray[8] + tempArray[3]);
            tempArray[3] = (tempArray[8] + tempArray[3]);
            tempArray[8] = (coefs[3] * tempArray[3]);
            tempArray[9] = (tempArray[8] + tempArray[9]);
            tempArray[10] = (tempArray[0] * tempArray[9]);
            tempArray[11] = (tempArray[8] + tempArray[3]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[12] = (tempArray[4] * tempArray[10]);
            tempArray[8] = (tempArray[8] + tempArray[12]);
            tempArray[9] = (-1 * tempArray[0] * tempArray[9]);
            tempArray[9] = (tempArray[11] + tempArray[9]);
            tempArray[11] = (tempArray[5] * tempArray[9]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (tempArray[8] + tempArray[3]);
            tempArray[12] = (-1 * coefs[3] * tempArray[11]);
            tempArray[13] = (tempArray[6] * tempArray[10]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (tempArray[7] * tempArray[9]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[4] = (-1 * tempArray[4] * tempArray[11]);
            tempArray[6] = (-1 * tempArray[6] * tempArray[3]);
            ...
            tempArray[5] = (-1 * coefs[4] * tempArray[10]);
            ...
            tempArray[6] = (tempArray[0] * tempArray[4]);
            ...
            tempArray[11] = (tempArray[0] * tempArray[3]);
            ...
            tempArray[11] = Math.Pow(tempArray[12], 2);
            tempArray[6] = (tempArray[6] + tempArray[11]);
            tempArray[11] = (tempArray[4] * tempArray[5]);
            tempArray[6] = (tempArray[6] + tempArray[11]);
            tempArray[11] = (tempArray[3] * tempArray[7]);
            vectors[1].C2 = (tempArray[6] + tempArray[11]);
            tempArray[6] = (tempArray[8] + tempArray[3]);
            tempArray[11] = (tempArray[1] * tempArray[11]);
            tempArray[13] = (-1 * tempArray[6] * tempArray[6]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[13] = (-1 * coefs[5] * tempArray[9]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[11]);
            tempArray[14] = (tempArray[2] * tempArray[11]);
            tempArray[15] = (-1 * tempArray[7] * tempArray[6]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[15] = (coefs[5] * tempArray[10]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            ...
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[14] = (tempArray[15] + tempArray[11]);
            tempArray[13] = (tempArray[0] * tempArray[13]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[6] = (coefs[3] * tempArray[6]);
            tempArray[1] = (-1 * tempArray[1] * tempArray[10]);
            tempArray[1] = (tempArray[6] + tempArray[1]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[8] * tempArray[1]);
            tempArray[6] = (-1 * tempArray[14] * tempArray[5]);
            tempArray[2] = (tempArray[2] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[7] * tempArray[11]);
            vectors[1].C3 = (tempArray[2] + tempArray[6]);
            tempArray[2] = (-1 * tempArray[1] * tempArray[3]);
            tempArray[6] = (-1 * tempArray[4] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[6]);
            tempArray[6] = (-1 * coefs[7] * tempArray[9]);
            tempArray[2] = (tempArray[2] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[0] * tempArray[2]);
            tempArray[9] = (-1 * tempArray[2] * tempArray[3]);
            tempArray[10] = (-1 * tempArray[5] * tempArray[6]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (coefs[7] * tempArray[10]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            ...
            tempArray[2] = (tempArray[0] * tempArray[2]);
            tempArray[9] = (tempArray[10] + tempArray[2]);
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[6]);
            tempArray[6] = (tempArray[12] * tempArray[1]);
            tempArray[5] = (-1 * tempArray[9] * tempArray[5]);
            tempArray[5] = (tempArray[6] + tempArray[5]);
            tempArray[6] = (-1 * tempArray[7] * tempArray[2]);
            vectors[1].C4 = (tempArray[5] + tempArray[6]);
            tempArray[5] = (tempArray[8] * tempArray[9]);
            tempArray[6] = (tempArray[12] * tempArray[14]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[6] = (coefs[7] * tempArray[11]);
            tempArray[7] = (coefs[5] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (coefs[4] * tempArray[6]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (tempArray[6] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[5] = (tempArray[0] * tempArray[5]);
            tempArray[7] = (tempArray[8] * tempArray[2]);
            tempArray[10] = (tempArray[12] * tempArray[11]);
            tempArray[7] = (tempArray[7] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[6] * tempArray[5]);
            tempArray[7] = (tempArray[7] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[0] * tempArray[7]);
            vectors[1].C1 = (tempArray[5] + tempArray[10]);
            tempArray[7] = (tempArray[0] * tempArray[7]);
            vectors[1].C5 = (tempArray[5] + tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[6]);
            tempArray[7] = (tempArray[2] + tempArray[6]);
            tempArray[10] = (tempArray[5] + tempArray[10]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[10]);
            tempArray[15] = (tempArray[5] + tempArray[7]);
            tempArray[15] = (tempArray[0] * tempArray[15]);
            tempArray[13] = (tempArray[13] + tempArray[15]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[10] = (tempArray[15] + tempArray[10]);
            tempArray[15] = (tempArray[8] * tempArray[5]);
            tempArray[16] = (tempArray[12] * tempArray[7]);
            tempArray[15] = (tempArray[15] + tempArray[16]);
            tempArray[4] = (tempArray[4] * tempArray[10]);
            tempArray[4] = (tempArray[15] + tempArray[4]);
            tempArray[3] = (tempArray[3] * tempArray[13]);
            vectors[2].C2 = (tempArray[4] + tempArray[3]);
            tempArray[3] = (tempArray[6] + tempArray[11]);
            tempArray[4] = (-1 * tempArray[1] * tempArray[5]);
            tempArray[5] = (tempArray[12] * tempArray[3]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (-1 * tempArray[14] * tempArray[10]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[5] = (-1 * tempArray[11] * tempArray[13]);
            vectors[2].C3 = (tempArray[4] + tempArray[5]);
            tempArray[1] = (tempArray[1] * tempArray[7]);
            tempArray[3] = (tempArray[8] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[9] * tempArray[10]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[13]);
            vectors[2].C4 = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[9] * tempArray[5]);
            tempArray[2] = (tempArray[14] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            tempArray[3] = (tempArray[11] * tempArray[7]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[3] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[6] * tempArray[10]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:11.2740848+02:00
