...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor24(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:09.3709759+02:00
            ...
            //Memory Reads: 1.95412844036697 average, 213 total.
            ...
            tempVar0003 = (-1 * coefs[3] * tempVar0000);
            tempVar0004 = (coefs[9] * tempVar0000);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0005 = (tempVar0000 * tempVar0003);
            tempVar0006 = (coefs[3] * tempVar0000);
            tempVar0004 = (tempVar0004 + tempVar0006);
            tempVar0006 = (-1 * tempVar0000 * tempVar0004);
            tempVar0006 = (tempVar0005 + tempVar0006);
            tempVar0007 = (-1 * tempVar0000 * tempVar0006);
            tempVar0008 = (tempVar0000 * tempVar0004);
            tempVar0005 = (tempVar0005 + tempVar0008);
            tempVar0005 = (tempVar0000 * tempVar0005);
            tempVar0007 = (tempVar0007 + tempVar0005);
            tempVar0008 = (coefs[0] * tempVar0000);
            tempVar0002 = (tempVar0002 + tempVar0008);
            tempVar0006 = (tempVar0000 * tempVar0006);
            tempVar0005 = (tempVar0005 + tempVar0006);
            tempVar0006 = (-1 * coefs[2] * coefs[5]);
            tempVar0008 = (tempVar0001 * tempVar0005);
            tempVar0006 = (tempVar0006 + tempVar0008);
            tempVar0008 = (tempVar0007 * tempVar0002);
            vectors[0].C2 = (tempVar0006 + tempVar0008);
            tempVar0006 = (-1 * coefs[1] * tempVar0000);
            tempVar0008 = (coefs[8] * tempVar0000);
            tempVar0006 = (tempVar0006 + tempVar0008);
            tempVar0009 = (coefs[1] * tempVar0000);
            tempVar0008 = (tempVar0008 + tempVar0009);
            tempVar0009 = (coefs[2] * coefs[4]);
            tempVar000A = (-1 * tempVar0006 * tempVar0005);
            tempVar0009 = (tempVar0009 + tempVar000A);
            tempVar000A = (-1 * tempVar0007 * tempVar0008);
            vectors[0].C3 = (tempVar0009 + tempVar000A);
            tempVar0009 = Math.Pow(coefs[4], 2);
            tempVar000A = Math.Pow(coefs[5], 2);
            tempVar000A = (-1 * tempVar000A);
            tempVar0009 = (tempVar0009 + tempVar000A);
            tempVar0005 = (-1 * tempVar0003 * tempVar0005);
            tempVar0005 = (tempVar0009 + tempVar0005);
            tempVar0007 = (-1 * tempVar0004 * tempVar0007);
            vectors[0].C4 = (tempVar0005 + tempVar0007);
            tempVar0005 = (-1 * coefs[5] * tempVar0006);
            tempVar0007 = (coefs[4] * tempVar0001);
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0007 = (-1 * coefs[6] * tempVar0007);
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0005 = (tempVar0000 * tempVar0005);
            tempVar0007 = (-1 * coefs[5] * tempVar0008);
            tempVar0009 = (coefs[4] * tempVar0002);
            tempVar0007 = (tempVar0007 + tempVar0009);
            tempVar0009 = (coefs[6] * tempVar0005);
            tempVar0007 = (tempVar0007 + tempVar0009);
            tempVar0009 = (-1 * tempVar0000 * tempVar0007);
            vectors[0].C1 = (tempVar0005 + tempVar0009);
            tempVar0007 = (tempVar0000 * tempVar0007);
            vectors[0].C5 = (tempVar0005 + tempVar0007);
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0007 = (tempVar0009 + tempVar000A);
            tempVar0009 = (tempVar0005 + tempVar0009);
            tempVar000A = (-1 * tempVar0000 * tempVar0009);
            tempVar000B = (tempVar0005 + tempVar0007);
            ...
            tempVar000B = (coefs[4] * tempVar0005);
            tempVar000C = (coefs[2] * tempVar0007);
            ...
            tempVar0001 = (tempVar0006 + tempVar0008);
            tempVar0002 = (-1 * coefs[5] * tempVar0005);
            tempVar0005 = (coefs[2] * tempVar0001);
            tempVar0002 = (tempVar0002 + tempVar0005);
            tempVar0005 = (-1 * tempVar0006 * tempVar0009);
            tempVar0002 = (tempVar0002 + tempVar0005);
            tempVar0005 = (-1 * tempVar0008 * tempVar000A);
            vectors[1].C3 = (tempVar0002 + tempVar0005);
            tempVar0002 = (coefs[5] * tempVar0007);
            tempVar0001 = (coefs[4] * tempVar0001);
            tempVar0001 = (tempVar0002 + tempVar0001);
            tempVar0002 = (-1 * tempVar0003 * tempVar0009);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (-1 * tempVar0004 * tempVar000A);
            vectors[1].C4 = (tempVar0001 + tempVar0002);
            tempVar0001 = (tempVar0003 * tempVar0005);
            ...
            tempVar0003 = (tempVar0008 * tempVar0007);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:09.3849767+02:00
