...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor20(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:08.9569522+02:00
            ...
            //Computations: 1.1743119266055 average, 128 total.
            ...
            tempVar0003 = (-1 * coefs[1] * tempVar0000);
            tempVar0004 = (coefs[8] * tempVar0000);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0005 = (tempVar0000 * tempVar0003);
            tempVar0006 = (coefs[1] * tempVar0000);
            ...
            tempVar0006 = Math.Pow(coefs[2], 2);
            tempVar0008 = Math.Pow(coefs[5], 2);
            tempVar0008 = (-1 * tempVar0008);
            tempVar0006 = (tempVar0006 + tempVar0008);
            tempVar0008 = (-1 * tempVar0003 * tempVar0005);
            tempVar0006 = (tempVar0006 + tempVar0008);
            tempVar0008 = (-1 * tempVar0004 * tempVar0007);
            vectors[0].C3 = (tempVar0006 + tempVar0008);
            tempVar0006 = (-1 * coefs[3] * tempVar0000);
            ...
            tempVar0005 = (-1 * tempVar0006 * tempVar0005);
            tempVar0005 = (tempVar0009 + tempVar0005);
            tempVar0007 = (-1 * tempVar0007 * tempVar0008);
            vectors[0].C4 = (tempVar0005 + tempVar0007);
            tempVar0005 = (coefs[5] * tempVar0006);
            tempVar0007 = (coefs[2] * tempVar0001);
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0007 = (-1 * coefs[6] * tempVar0007);
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0005 = (tempVar0000 * tempVar0005);
            tempVar0007 = (coefs[5] * tempVar0008);
            tempVar0009 = (coefs[2] * tempVar0002);
            ...
            tempVar0005 = (tempVar0005 + tempVar0007);
            tempVar0007 = (tempVar0006 + tempVar0008);
            ...
            tempVar0003 = (-1 * tempVar0003 * tempVar0009);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (-1 * tempVar0004 * tempVar000A);
            ...
            tempVar0002 = (-1 * tempVar0006 * tempVar0009);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (-1 * tempVar0008 * tempVar000A);
            vectors[1].C4 = (tempVar0001 + tempVar0002);
            tempVar0001 = (tempVar0006 * tempVar0005);
            tempVar0002 = (tempVar0003 * tempVar0007);
            tempVar0001 = (tempVar0001 + tempVar0002);
            ...
            tempVar0002 = (tempVar0008 * tempVar0005);
            tempVar0003 = (tempVar0004 * tempVar0007);
            tempVar0002 = (tempVar0002 + tempVar0003);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:08.9679529+02:00
