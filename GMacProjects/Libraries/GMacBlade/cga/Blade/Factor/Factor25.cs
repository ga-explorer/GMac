...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor25(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:16.7333970+02:00
            ...
            //Computations: 1.27924528301887 average, 339 total.
            ...
            tempArray[13] = (-1 * tempArray[4] * tempArray[11]);
            ...
            tempArray[15] = (-1 * tempArray[5] * tempArray[11]);
            tempArray[16] = (-1 * tempArray[7] * tempArray[12]);
            ...
            tempArray[4] = (-1 * tempArray[4] * tempArray[3]);
            tempArray[1] = (tempArray[1] + tempArray[4]);
            tempArray[4] = (-1 * coefs[7] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[4]);
            ...
            tempArray[3] = (coefs[7] * tempArray[10]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[2] = (tempArray[0] * tempArray[2]);
            tempArray[3] = (tempArray[4] + tempArray[2]);
            ...
            tempArray[7] = (tempArray[15] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (tempArray[5] * tempArray[12]);
            vectors[1].C2 = (tempArray[6] + tempArray[7]);
            tempArray[6] = (tempArray[1] * tempArray[11]);
            tempArray[7] = (-1 * tempArray[6] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * coefs[5] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[9] = (tempArray[2] * tempArray[11]);
            tempArray[10] = (-1 * tempArray[7] * tempArray[3]);
            ...
            tempArray[11] = (tempArray[4] * tempArray[10]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            ...
            vectors[1].C3 = (tempArray[7] + tempArray[11]);
            tempArray[7] = Math.Pow(tempArray[8], 2);
            ...
            tempArray[7] = (coefs[4] * tempArray[3]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[7] = (tempArray[5] * tempArray[5]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[7] = (-1 * tempArray[8] * tempArray[6]);
            ...
            tempArray[12] = (tempArray[6] + tempArray[7]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:16.7553983+02:00
