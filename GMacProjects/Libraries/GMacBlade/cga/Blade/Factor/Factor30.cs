...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor30(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:23.9698109+02:00
            //Macro: geometry3d.cga.Factor4
            //Input Variables: 4 used, 5 not used, 9 total.
            //Temp Variables: 324 sub-expressions, 0 generated temps, 324 total.
            //Target Temp Variables: 21 total.
            //Output Variables: 20 total.
            //Computations: 1.27616279069767 average, 439 total.
            //Memory Reads: 1.96511627906977 average, 676 total.
            //Memory Writes: 344 total.
            //
            //Macro Binding Data: 
            ...
            vectors[0].C3 = (coefs[2] * coefs[3]);
            vectors[0].C4 = (-1 * coefs[1] * coefs[3]);
            ...
            tempArray[4] = (-1 * coefs[0] * tempArray[0]);
            ...
            vectors[0].C2 = (tempArray[3] + tempArray[5]);
            ...
            tempArray[15] = (-1 * coefs[1] * coefs[3]);
            tempArray[16] = (coefs[2] * tempArray[15]);
            ...
            tempArray[12] = (-1 * coefs[3] * tempArray[15]);
            tempArray[9] = (coefs[1] * tempArray[9]);
            tempArray[9] = (tempArray[12] + tempArray[9]);
            tempArray[12] = (tempArray[5] * tempArray[9]);
            tempArray[13] = (-1 * tempArray[7] * tempArray[8]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            tempArray[13] = (-1 * tempArray[14] * tempArray[6]);
            vectors[1].C2 = (tempArray[12] + tempArray[13]);
            tempArray[12] = (coefs[3] * tempArray[5]);
            tempArray[13] = (coefs[2] * tempArray[9]);
            tempArray[12] = (tempArray[12] + tempArray[13]);
            ...
            tempArray[13] = (tempArray[0] * tempArray[4]);
            tempArray[15] = (-1 * tempArray[0] * tempArray[2]);
            tempArray[3] = (tempArray[3] + tempArray[15]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[13] = (tempArray[13] + tempArray[3]);
            tempArray[4] = (-1 * tempArray[0] * tempArray[4]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[4] = (-1 * tempArray[12] * tempArray[9]);
            tempArray[3] = (-1 * tempArray[7] * tempArray[3]);
            tempArray[3] = (tempArray[4] + tempArray[3]);
            tempArray[4] = (-1 * tempArray[13] * tempArray[6]);
            ...
            tempArray[13] = (tempArray[12] * tempArray[14]);
            tempArray[4] = (tempArray[4] + tempArray[13]);
            tempArray[13] = (tempArray[5] * tempArray[13]);
            tempArray[4] = (tempArray[4] + tempArray[13]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[13] = (-1 * tempArray[3] * tempArray[6]);
            tempArray[15] = (-1 * tempArray[12] * tempArray[8]);
            tempArray[13] = (tempArray[13] + tempArray[15]);
            tempArray[15] = (-1 * tempArray[5] * tempArray[3]);
            tempArray[13] = (tempArray[13] + tempArray[15]);
            tempArray[15] = (-1 * tempArray[0] * tempArray[13]);
            vectors[1].C1 = (tempArray[4] + tempArray[15]);
            tempArray[15] = Math.Pow(tempArray[9], 2);
            tempArray[15] = (-1 * tempArray[15]);
            tempArray[16] = Math.Pow(tempArray[3], 2);
            ...
            tempArray[8] = (tempArray[8] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[2] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[1] * tempArray[13]);
            vectors[1].C3 = (tempArray[8] + tempArray[14]);
            tempArray[8] = (tempArray[0] * tempArray[13]);
            vectors[1].C5 = (tempArray[4] + tempArray[8]);
            tempArray[4] = (tempArray[12] + tempArray[13]);
            tempArray[8] = (-1 * tempArray[3] * tempArray[4]);
            tempArray[13] = (tempArray[4] + tempArray[15]);
            tempArray[14] = (tempArray[0] * tempArray[13]);
            tempArray[15] = (tempArray[4] + tempArray[8]);
            tempArray[15] = (tempArray[0] * tempArray[15]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[16] = (-1 * tempArray[11] * tempArray[14]);
            tempArray[8] = (tempArray[8] + tempArray[16]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[13]);
            tempArray[13] = (tempArray[15] + tempArray[13]);
            tempArray[15] = (-1 * tempArray[10] * tempArray[13]);
            tempArray[8] = (tempArray[8] + tempArray[15]);
            tempArray[15] = (tempArray[3] + tempArray[4]);
            tempArray[16] = (tempArray[8] + tempArray[14]);
            tempArray[17] = (-1 * tempArray[7] * tempArray[15]);
            tempArray[18] = (-1 * tempArray[2] * tempArray[16]);
            tempArray[17] = (tempArray[17] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[5] * tempArray[13]);
            tempArray[17] = (tempArray[17] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[0] * tempArray[17]);
            tempArray[19] = (-1 * tempArray[6] * tempArray[15]);
            tempArray[20] = (-1 * tempArray[1] * tempArray[16]);
            tempArray[19] = (tempArray[19] + tempArray[20]);
            tempArray[20] = (tempArray[5] * tempArray[14]);
            tempArray[19] = (tempArray[19] + tempArray[20]);
            ...
            tempArray[11] = (-1 * tempArray[11] * tempArray[16]);
            tempArray[7] = (-1 * tempArray[7] * tempArray[4]);
            tempArray[7] = (tempArray[11] + tempArray[7]);
            tempArray[11] = (tempArray[12] * tempArray[13]);
            tempArray[7] = (tempArray[7] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[7]);
            tempArray[10] = (-1 * tempArray[10] * tempArray[16]);
            tempArray[4] = (-1 * tempArray[6] * tempArray[4]);
            tempArray[4] = (tempArray[10] + tempArray[4]);
            tempArray[6] = (-1 * tempArray[12] * tempArray[14]);
            ...
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[7] = (tempArray[10] + tempArray[4]);
            tempArray[10] = (tempArray[0] * tempArray[7]);
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            ...
            tempArray[12] = (tempArray[0] * tempArray[18]);
            tempArray[12] = (tempArray[17] + tempArray[12]);
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[6] = (tempArray[10] + tempArray[6]);
            tempArray[3] = (tempArray[3] * tempArray[15]);
            ...
            tempArray[2] = (-1 * tempArray[8] * tempArray[1]);
            tempArray[3] = (tempArray[19] * tempArray[6]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[11] * tempArray[12]);
            vectors[2].C2 = (tempArray[2] + tempArray[3]);
            tempArray[2] = (tempArray[11] * tempArray[15]);
            ...
            tempArray[13] = (-1 * tempArray[9] * tempArray[14]);
            tempArray[10] = (tempArray[10] + tempArray[13]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[3] = (tempArray[3] + tempArray[10]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[3]);
            tempArray[2] = (tempArray[0] * tempArray[2]);
            tempArray[2] = (tempArray[10] + tempArray[2]);
            tempArray[2] = (tempArray[0] * tempArray[2]);
            tempArray[10] = (tempArray[13] + tempArray[2]);
            tempArray[13] = (-1 * tempArray[3] * tempArray[16]);
            tempArray[14] = (tempArray[7] * tempArray[14]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (tempArray[6] * tempArray[13]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[13] * tempArray[1]);
            tempArray[14] = (-1 * tempArray[10] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[11] * tempArray[2]);
            vectors[2].C3 = (tempArray[3] + tempArray[14]);
            tempArray[3] = Math.Pow(tempArray[8], 2);
            tempArray[3] = (-1 * tempArray[3]);
            tempArray[14] = Math.Pow(tempArray[13], 2);
            tempArray[3] = (tempArray[3] + tempArray[14]);
            tempArray[6] = (-1 * tempArray[7] * tempArray[6]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[4] * tempArray[11]);
            vectors[2].C4 = (tempArray[3] + tempArray[6]);
            tempArray[3] = (-1 * tempArray[8] * tempArray[10]);
            tempArray[6] = (tempArray[13] * tempArray[19]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[12] * tempArray[15]);
            tempArray[9] = (-1 * tempArray[9] * tempArray[16]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[5] = (-1 * tempArray[5] * tempArray[4]);
            tempArray[5] = (tempArray[6] + tempArray[5]);
            tempArray[6] = (tempArray[5] * tempArray[11]);
            tempArray[3] = (tempArray[3] + tempArray[6]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[6] = (-1 * tempArray[8] * tempArray[2]);
            tempArray[9] = (tempArray[13] * tempArray[12]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            ...
            tempArray[11] = (-1 * tempArray[0] * tempArray[9]);
            ...
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[12] = (tempArray[12] * tempArray[11]);
            vectors[3].C2 = (tempArray[14] + tempArray[12]);
            tempArray[12] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[8] * tempArray[3]);
            tempArray[1] = (tempArray[1] * tempArray[12]);
            tempArray[1] = (tempArray[3] + tempArray[1]);
            tempArray[3] = (-1 * tempArray[10] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[3]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[11]);
            vectors[3].C3 = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[8] * tempArray[6]);
            tempArray[2] = (tempArray[13] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[7] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[4] * tempArray[11]);
            vectors[3].C4 = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[7] * tempArray[3]);
            tempArray[2] = (tempArray[10] * tempArray[6]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[19] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[5] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:24.0088131+02:00
