...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor28(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:18.3604901+02:00
            //Macro: geometry3d.cga.Factor3
            //Input Variables: 3 used, 10 not used, 13 total.
            //Temp Variables: 241 sub-expressions, 0 generated temps, 241 total.
            //Target Temp Variables: 17 total.
            //Output Variables: 15 total.
            //Computations: 1.25 average, 320 total.
            //Memory Reads: 1.96875 average, 504 total.
            //Memory Writes: 256 total.
            //
            //Macro Binding Data: 
            ...
            tempArray[1] = (-1 * coefs[1] * tempArray[0]);
            tempArray[2] = (-1 * coefs[8] * tempArray[0]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[3] = (-1 * coefs[2] * tempArray[0]);
            tempArray[4] = (-1 * coefs[9] * tempArray[0]);
            tempArray[3] = (tempArray[3] + tempArray[4]);
            tempArray[5] = (tempArray[0] * tempArray[3]);
            tempArray[6] = (coefs[2] * tempArray[0]);
            ...
            tempArray[8] = (coefs[1] * tempArray[0]);
            tempArray[2] = (tempArray[2] + tempArray[8]);
            tempArray[5] = (-1 * tempArray[0] * tempArray[5]);
            tempArray[5] = (tempArray[6] + tempArray[5]);
            tempArray[6] = (coefs[4] * coefs[5]);
            tempArray[8] = (-1 * tempArray[1] * tempArray[5]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * tempArray[7] * tempArray[2]);
            vectors[0].C2 = (tempArray[6] + tempArray[8]);
            tempArray[6] = (-1 * coefs[0] * tempArray[0]);
            tempArray[8] = (-1 * coefs[6] * tempArray[0]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[9] = (tempArray[0] * tempArray[6]);
            tempArray[10] = (coefs[0] * tempArray[0]);
            tempArray[8] = (tempArray[8] + tempArray[10]);
            tempArray[10] = (-1 * tempArray[0] * tempArray[8]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[11] = (tempArray[0] * tempArray[9]);
            tempArray[12] = (-1 * tempArray[0] * tempArray[6]);
            ...
            tempArray[10] = (-1 * coefs[5] * coefs[7]);
            tempArray[9] = (-1 * tempArray[1] * tempArray[9]);
            tempArray[9] = (tempArray[10] + tempArray[9]);
            tempArray[10] = (-1 * tempArray[11] * tempArray[2]);
            vectors[0].C4 = (tempArray[9] + tempArray[10]);
            tempArray[9] = (coefs[3] * tempArray[1]);
            tempArray[10] = (-1 * coefs[7] * tempArray[7]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[10] = (-1 * coefs[4] * tempArray[11]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            tempArray[10] = (coefs[3] * tempArray[2]);
            tempArray[11] = (coefs[7] * tempArray[5]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (coefs[4] * tempArray[9]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[10]);
            vectors[0].C1 = (tempArray[9] + tempArray[11]);
            tempArray[11] = Math.Pow(coefs[3], 2);
            tempArray[12] = Math.Pow(coefs[5], 2);
            ...
            tempArray[7] = (tempArray[4] * tempArray[7]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[6] * tempArray[9]);
            tempArray[5] = (tempArray[5] + tempArray[7]);
            tempArray[7] = (-1 * tempArray[8] * tempArray[11]);
            vectors[0].C3 = (tempArray[5] + tempArray[7]);
            tempArray[5] = (tempArray[0] * tempArray[10]);
            vectors[0].C5 = (tempArray[9] + tempArray[5]);
            tempArray[5] = (tempArray[6] + tempArray[8]);
            tempArray[7] = (coefs[3] * tempArray[5]);
            tempArray[9] = (tempArray[9] + tempArray[11]);
            tempArray[10] = (tempArray[0] * tempArray[9]);
            tempArray[11] = (tempArray[9] + tempArray[5]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[12] = (-1 * tempArray[3] * tempArray[10]);
            tempArray[7] = (tempArray[7] + tempArray[12]);
            tempArray[9] = (-1 * tempArray[0] * tempArray[9]);
            tempArray[9] = (tempArray[11] + tempArray[9]);
            tempArray[11] = (-1 * tempArray[4] * tempArray[9]);
            tempArray[7] = (tempArray[7] + tempArray[11]);
            tempArray[11] = (tempArray[9] + tempArray[10]);
            tempArray[12] = (tempArray[5] + tempArray[7]);
            tempArray[13] = (-1 * tempArray[1] * tempArray[11]);
            tempArray[14] = (-1 * tempArray[6] * tempArray[12]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs[4] * tempArray[9]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[0] * tempArray[13]);
            tempArray[15] = (-1 * tempArray[2] * tempArray[11]);
            tempArray[16] = (-1 * tempArray[8] * tempArray[12]);
            ...
            tempArray[4] = (-1 * tempArray[4] * tempArray[12]);
            ...
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[8] * tempArray[9]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[7] * tempArray[4]);
            tempArray[8] = (tempArray[15] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (tempArray[5] * tempArray[12]);
            vectors[1].C2 = (tempArray[6] + tempArray[8]);
            tempArray[6] = (tempArray[3] * tempArray[11]);
            tempArray[8] = (-1 * tempArray[6] * tempArray[5]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * coefs[5] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[9] = (tempArray[4] * tempArray[11]);
            tempArray[10] = (-1 * tempArray[8] * tempArray[5]);
            tempArray[9] = (tempArray[9] + tempArray[10]);
            ...
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[9] = (tempArray[10] + tempArray[6]);
            tempArray[10] = (coefs[3] * tempArray[12]);
            tempArray[11] = (tempArray[1] * tempArray[10]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (tempArray[2] * tempArray[9]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[8] = (tempArray[0] * tempArray[8]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (tempArray[10] * tempArray[4]);
            tempArray[11] = (-1 * tempArray[9] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[5] * tempArray[6]);
            vectors[1].C3 = (tempArray[8] + tempArray[11]);
            ...
            vectors[1].C4 = (tempArray[3] + tempArray[5]);
            tempArray[3] = (-1 * tempArray[7] * tempArray[9]);
            tempArray[5] = (tempArray[10] * tempArray[15]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (coefs[7] * tempArray[11]);
            tempArray[8] = (coefs[5] * tempArray[12]);
            tempArray[5] = (tempArray[5] + tempArray[8]);
            tempArray[8] = (coefs[4] * tempArray[5]);
            tempArray[5] = (tempArray[5] + tempArray[8]);
            tempArray[8] = (tempArray[5] * tempArray[5]);
            tempArray[3] = (tempArray[3] + tempArray[8]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[8] = (-1 * tempArray[7] * tempArray[6]);
            tempArray[11] = (tempArray[10] * tempArray[12]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[5] * tempArray[3]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[8]);
            vectors[1].C1 = (tempArray[3] + tempArray[11]);
            tempArray[8] = (tempArray[0] * tempArray[8]);
            vectors[1].C5 = (tempArray[3] + tempArray[8]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (tempArray[3] + tempArray[11]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[11]);
            tempArray[14] = (tempArray[3] + tempArray[8]);
            tempArray[14] = (tempArray[0] * tempArray[14]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[11] = (tempArray[14] + tempArray[11]);
            tempArray[14] = (tempArray[10] * tempArray[3]);
            tempArray[16] = (tempArray[4] * tempArray[8]);
            ...
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[5] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[2] = (tempArray[1] * tempArray[3]);
            tempArray[3] = (tempArray[6] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[12] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[5] * tempArray[11]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:18.3814913+02:00
