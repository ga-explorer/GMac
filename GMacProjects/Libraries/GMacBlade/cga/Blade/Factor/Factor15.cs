...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor15(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:19.4815542+02:00
            ...
            //Computations: 1.28080229226361 average, 447 total.
            ...
            tempArray[12] = (tempArray[12] + tempArray[15]);
            tempArray[15] = (tempArray[8] + tempArray[12]);
            tempArray[16] = (tempArray[3] + tempArray[4]);
            tempArray[17] = (-1 * tempArray[11] * tempArray[16]);
            tempArray[18] = (-1 * tempArray[2] * tempArray[15]);
            tempArray[17] = (tempArray[17] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[9] * tempArray[13]);
            tempArray[17] = (tempArray[17] + tempArray[18]);
            tempArray[18] = (-1 * tempArray[0] * tempArray[17]);
            tempArray[19] = (-1 * tempArray[10] * tempArray[16]);
            tempArray[20] = (-1 * tempArray[1] * tempArray[15]);
            ...
            tempArray[7] = (tempArray[0] * tempArray[18]);
            tempArray[7] = (tempArray[17] + tempArray[7]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[4] = (tempArray[5] + tempArray[4]);
            tempArray[3] = (-1 * tempArray[3] * tempArray[15]);
            tempArray[5] = (tempArray[11] * tempArray[14]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (tempArray[10] * tempArray[13]);
            tempArray[3] = (tempArray[3] + tempArray[5]);
            tempArray[5] = (tempArray[12] * tempArray[3]);
            tempArray[10] = (tempArray[19] * tempArray[4]);
            tempArray[5] = (tempArray[5] + tempArray[10]);
            tempArray[10] = (tempArray[6] * tempArray[7]);
            vectors[2].C2 = (tempArray[5] + tempArray[10]);
            tempArray[5] = (tempArray[3] * tempArray[16]);
            tempArray[10] = (tempArray[2] * tempArray[14]);
            tempArray[5] = (tempArray[5] + tempArray[10]);
            tempArray[10] = (tempArray[1] * tempArray[13]);
            tempArray[5] = (tempArray[5] + tempArray[10]);
            tempArray[10] = Math.Pow(tempArray[12], 2);
            tempArray[10] = (-1 * tempArray[10]);
            tempArray[11] = Math.Pow(tempArray[5], 2);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[2] * tempArray[4]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[1] * tempArray[6]);
            vectors[2].C3 = (tempArray[10] + tempArray[11]);
            tempArray[10] = (-1 * tempArray[7] * tempArray[15]);
            tempArray[11] = (-1 * tempArray[11] * tempArray[4]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (tempArray[8] * tempArray[13]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[10]);
            tempArray[13] = (-1 * tempArray[6] * tempArray[15]);
            tempArray[14] = (-1 * tempArray[10] * tempArray[4]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[8] * tempArray[14]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[13] = (tempArray[0] * tempArray[13]);
            tempArray[11] = (tempArray[11] + tempArray[13]);
            tempArray[14] = (-1 * tempArray[0] * tempArray[11]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[10] = (tempArray[13] + tempArray[10]);
            tempArray[10] = (tempArray[0] * tempArray[10]);
            tempArray[13] = (tempArray[14] + tempArray[10]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (tempArray[5] * tempArray[3]);
            tempArray[4] = (-1 * tempArray[13] * tempArray[4]);
            tempArray[4] = (tempArray[11] + tempArray[4]);
            tempArray[6] = (-1 * tempArray[6] * tempArray[10]);
            vectors[2].C4 = (tempArray[4] + tempArray[6]);
            tempArray[4] = (tempArray[12] * tempArray[13]);
            tempArray[6] = (tempArray[5] * tempArray[19]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (-1 * tempArray[8] * tempArray[16]);
            tempArray[8] = (-1 * tempArray[5] * tempArray[15]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (-1 * tempArray[9] * tempArray[4]);
            tempArray[6] = (tempArray[6] + tempArray[8]);
            tempArray[8] = (tempArray[6] * tempArray[6]);
            tempArray[4] = (tempArray[4] + tempArray[8]);
            tempArray[4] = (tempArray[0] * tempArray[4]);
            tempArray[8] = (tempArray[12] * tempArray[10]);
            tempArray[9] = (tempArray[5] * tempArray[7]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[6] * tempArray[4]);
            tempArray[8] = (tempArray[8] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[0] * tempArray[8]);
            vectors[2].C1 = (tempArray[4] + tempArray[9]);
            tempArray[8] = (tempArray[0] * tempArray[8]);
            vectors[2].C5 = (tempArray[4] + tempArray[8]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[8] = (tempArray[10] + tempArray[11]);
            tempArray[9] = (tempArray[4] + tempArray[9]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[9]);
            tempArray[14] = (tempArray[4] + tempArray[8]);
            ...
            tempArray[14] = (tempArray[3] * tempArray[4]);
            tempArray[15] = (tempArray[5] * tempArray[8]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[15] = (tempArray[19] * tempArray[9]);
            tempArray[14] = (tempArray[14] + tempArray[15]);
            tempArray[7] = (tempArray[7] * tempArray[11]);
            vectors[3].C2 = (tempArray[14] + tempArray[7]);
            tempArray[7] = (tempArray[5] + tempArray[10]);
            tempArray[4] = (-1 * tempArray[12] * tempArray[4]);
            tempArray[5] = (tempArray[5] * tempArray[7]);
            tempArray[4] = (tempArray[4] + tempArray[5]);
            tempArray[2] = (-1 * tempArray[2] * tempArray[9]);
            tempArray[2] = (tempArray[4] + tempArray[2]);
            tempArray[1] = (-1 * tempArray[1] * tempArray[11]);
            vectors[3].C3 = (tempArray[2] + tempArray[1]);
            tempArray[1] = (tempArray[12] * tempArray[8]);
            tempArray[2] = (tempArray[3] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[13] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[10] * tempArray[11]);
            vectors[3].C4 = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[13] * tempArray[4]);
            tempArray[2] = (tempArray[2] * tempArray[8]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[19] * tempArray[7]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[6] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[2] = (tempArray[10] * tempArray[4]);
            tempArray[3] = (tempArray[1] * tempArray[8]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[7] * tempArray[7]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[6] * tempArray[9]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:19.5125560+02:00
