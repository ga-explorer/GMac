...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor22(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:15.8403459+02:00
            ...
            //Computations: 1.24313725490196 average, 317 total.
            ...
            tempArray[11] = (tempArray[5] + tempArray[6]);
            tempArray[12] = (tempArray[7] + tempArray[8]);
            tempArray[13] = (-1 * tempArray[3] * tempArray[12]);
            tempArray[14] = (-1 * tempArray[5] * tempArray[11]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs[4] * tempArray[9]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[0] * tempArray[13]);
            tempArray[15] = (-1 * tempArray[4] * tempArray[12]);
            tempArray[16] = (-1 * tempArray[6] * tempArray[11]);
            ...
            tempArray[6] = (tempArray[15] * tempArray[5]);
            tempArray[4] = (tempArray[4] + tempArray[6]);
            tempArray[6] = (tempArray[7] * tempArray[12]);
            vectors[1].C2 = (tempArray[4] + tempArray[6]);
            tempArray[4] = (-1 * coefs[3] * tempArray[12]);
            ...
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (tempArray[4] * tempArray[3]);
            tempArray[5] = (-1 * tempArray[10] * tempArray[5]);
            tempArray[5] = (tempArray[9] + tempArray[5]);
            tempArray[7] = (-1 * tempArray[7] * tempArray[6]);
            vectors[1].C4 = (tempArray[5] + tempArray[7]);
            tempArray[5] = (tempArray[8] * tempArray[10]);
            tempArray[7] = (tempArray[4] * tempArray[15]);
            ...
            tempArray[12] = (tempArray[4] + tempArray[6]);
            tempArray[5] = (-1 * tempArray[8] * tempArray[5]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:15.8613471+02:00
