...
namespace GMacBlade.cga0001
{
    ...
    {
        private static cga0001Vector[] Factor13(double[] coefs)
        {
            var vectors = new[] 
            {
                new cga0001Vector(),
            ...
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:12.1951374+02:00
            ...
            //Computations: 1.26792452830189 average, 336 total.
            //Memory Reads: 2.01509433962264 average, 534 total.
            //Memory Writes: 265 total.
            //
            //Macro Binding Data: 
            ...
            tempArray[8] = (tempArray[8] + tempArray[11]);
            tempArray[11] = (tempArray[8] + tempArray[3]);
            tempArray[12] = (tempArray[8] + tempArray[3]);
            tempArray[13] = (-1 * tempArray[4] * tempArray[12]);
            tempArray[14] = (-1 * tempArray[6] * tempArray[11]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (coefs[4] * tempArray[9]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[14] = (-1 * tempArray[0] * tempArray[13]);
            tempArray[15] = (-1 * tempArray[5] * tempArray[12]);
            tempArray[16] = (-1 * tempArray[7] * tempArray[11]);
            ...
            tempArray[9] = Math.Pow(tempArray[5], 2);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[2] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[1] * tempArray[7]);
            vectors[1].C3 = (tempArray[6] + tempArray[9]);
            tempArray[6] = (-1 * tempArray[1] * tempArray[11]);
            tempArray[9] = (-1 * tempArray[4] * tempArray[3]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (-1 * coefs[7] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (-1 * tempArray[0] * tempArray[6]);
            tempArray[10] = (-1 * tempArray[2] * tempArray[11]);
            tempArray[11] = (-1 * tempArray[5] * tempArray[3]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            tempArray[11] = (coefs[7] * tempArray[10]);
            tempArray[10] = (tempArray[10] + tempArray[11]);
            ...
            tempArray[6] = (tempArray[0] * tempArray[6]);
            tempArray[10] = (tempArray[11] + tempArray[6]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            tempArray[6] = (tempArray[6] + tempArray[9]);
            tempArray[9] = (tempArray[5] * tempArray[4]);
            tempArray[3] = (-1 * tempArray[10] * tempArray[3]);
            tempArray[3] = (tempArray[9] + tempArray[3]);
            tempArray[7] = (-1 * tempArray[7] * tempArray[6]);
            vectors[1].C4 = (tempArray[3] + tempArray[7]);
            tempArray[3] = (tempArray[8] * tempArray[10]);
            tempArray[7] = (tempArray[5] * tempArray[15]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[7] = (coefs[7] * tempArray[12]);
            tempArray[9] = (coefs[5] * tempArray[11]);
            tempArray[7] = (tempArray[7] + tempArray[9]);
            tempArray[9] = (coefs[4] * tempArray[3]);
            tempArray[7] = (tempArray[7] + tempArray[9]);
            tempArray[9] = (tempArray[7] * tempArray[7]);
            tempArray[3] = (tempArray[3] + tempArray[9]);
            tempArray[3] = (tempArray[0] * tempArray[3]);
            tempArray[9] = (tempArray[8] * tempArray[6]);
            tempArray[11] = (tempArray[5] * tempArray[12]);
            tempArray[9] = (tempArray[9] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[7] * tempArray[3]);
            tempArray[9] = (tempArray[9] + tempArray[11]);
            tempArray[11] = (-1 * tempArray[0] * tempArray[9]);
            vectors[1].C1 = (tempArray[3] + tempArray[11]);
            tempArray[9] = (tempArray[0] * tempArray[9]);
            vectors[1].C5 = (tempArray[3] + tempArray[9]);
            tempArray[3] = (tempArray[3] + tempArray[7]);
            tempArray[9] = (tempArray[6] + tempArray[9]);
            tempArray[11] = (tempArray[3] + tempArray[11]);
            tempArray[13] = (-1 * tempArray[0] * tempArray[11]);
            tempArray[14] = (tempArray[3] + tempArray[9]);
            tempArray[14] = (tempArray[0] * tempArray[14]);
            tempArray[13] = (tempArray[13] + tempArray[14]);
            tempArray[11] = (tempArray[0] * tempArray[11]);
            tempArray[11] = (tempArray[14] + tempArray[11]);
            tempArray[14] = (tempArray[4] * tempArray[3]);
            tempArray[16] = (tempArray[5] * tempArray[9]);
            ...
            vectors[2].C3 = (tempArray[2] + tempArray[1]);
            tempArray[1] = (tempArray[8] * tempArray[9]);
            tempArray[2] = (tempArray[4] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[10] * tempArray[11]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (-1 * tempArray[6] * tempArray[13]);
            vectors[2].C4 = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[10] * tempArray[3]);
            tempArray[2] = (tempArray[2] * tempArray[9]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[15] * tempArray[12]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[2] = (tempArray[7] * tempArray[13]);
            tempArray[1] = (tempArray[1] + tempArray[2]);
            tempArray[1] = (tempArray[0] * tempArray[1]);
            tempArray[2] = (tempArray[6] * tempArray[3]);
            tempArray[3] = (tempArray[1] * tempArray[9]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (tempArray[12] * tempArray[12]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            tempArray[3] = (-1 * tempArray[7] * tempArray[11]);
            tempArray[2] = (tempArray[2] + tempArray[3]);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:12.2241391+02:00
