namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ERCP_523(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:44.1851036+02:00
            ...
            c[4] = (coefs1[0] * coefs2[5]);
            c[5] = (-1 * coefs1[0] * coefs2[4]);
            c[6] = (coefs1[0] * coefs2[3]);
            c[7] = (coefs1[0] * coefs2[2]);
            c[8] = (-1 * coefs1[0] * coefs2[1]);
            c[9] = (coefs1[0] * coefs2[0]);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:44.1871037+02:00
