namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ERCP_202(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:44.0810976+02:00
            ...
            c[7] = (-1 * coefs1[7] * coefs2[0]);
            c[8] = (-1 * coefs1[8] * coefs2[0]);
            c[9] = (-1 * coefs1[9] * coefs2[0]);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:44.0830977+02:00
