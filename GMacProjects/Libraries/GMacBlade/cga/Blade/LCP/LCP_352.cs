...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] LCP_352(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:40.6319003+02:00
            ...
            //Computations: 1.35714285714286 average, 57 total.
            ...
            tempVar0004 = (-1 * coefs1[2] * tempVar0000);
            tempVar0002 = (tempVar0002 + tempVar0004);
            tempVar0002 = (-1 * coefs2[0] * tempVar0002);
            ...
            tempVar0006 = (-1 * coefs1[1] * tempVar0000);
            ...
            tempVar0006 = (-1 * coefs1[6] * tempVar0000);
            tempVar0005 = (tempVar0005 + tempVar0006);
            tempVar0005 = (-1 * coefs2[0] * tempVar0005);
            tempVar0007 = (-1 * tempVar0000 * tempVar0005);
            tempVar0008 = (-1 * coefs1[0] * tempVar0000);
            tempVar0006 = (tempVar0006 + tempVar0008);
            tempVar0006 = (coefs2[0] * tempVar0006);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:40.6389007+02:00
