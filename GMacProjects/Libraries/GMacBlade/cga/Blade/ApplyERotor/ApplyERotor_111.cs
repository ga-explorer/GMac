namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyERotor_111(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:02.6015887+02:00
            ...
            tempVar0003 = (-1 * coefs1[0] * coefs2[1]);
            ...
            tempVar0002 = (coefs1[2] * coefs2[1]);
            tempVar0006 = (-1 * coefs1[1] * coefs2[2]);
            tempVar0002 = (tempVar0002 + tempVar0006);
            tempVar0006 = (-1 * coefs1[2] * tempVar0002);
            ...
            tempVar0007 = (coefs1[4] * coefs2[1]);
            tempVar0008 = (-1 * coefs1[1] * coefs2[4]);
            tempVar0007 = (tempVar0007 + tempVar0008);
            tempVar0008 = (-1 * coefs1[4] * tempVar0007);
            c[1] = (tempVar0001 + tempVar0008);
            tempVar0001 = (-1 * coefs1[2] * tempVar0000);
            tempVar0003 = (coefs1[0] * tempVar0003);
            tempVar0001 = (tempVar0001 + tempVar0003);
            tempVar0002 = (coefs1[1] * tempVar0002);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[3] * coefs2[2]);
            tempVar0003 = (-1 * coefs1[2] * coefs2[3]);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (-1 * coefs1[3] * tempVar0002);
            tempVar0001 = (tempVar0001 + tempVar0003);
            tempVar0003 = (coefs1[4] * coefs2[2]);
            tempVar0008 = (-1 * coefs1[2] * coefs2[4]);
            tempVar0003 = (tempVar0003 + tempVar0008);
            tempVar0008 = (-1 * coefs1[4] * tempVar0003);
            c[2] = (tempVar0001 + tempVar0008);
            tempVar0001 = (-1 * coefs1[3] * tempVar0000);
            tempVar0004 = (coefs1[0] * tempVar0004);
            tempVar0001 = (tempVar0001 + tempVar0004);
            tempVar0004 = (coefs1[1] * tempVar0006);
            tempVar0001 = (tempVar0001 + tempVar0004);
            tempVar0002 = (coefs1[2] * tempVar0002);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[4] * coefs2[3]);
            tempVar0004 = (-1 * coefs1[3] * coefs2[4]);
            tempVar0002 = (tempVar0002 + tempVar0004);
            tempVar0004 = (-1 * coefs1[4] * tempVar0002);
            c[3] = (tempVar0001 + tempVar0004);
            tempVar0000 = (-1 * coefs1[4] * tempVar0000);
            tempVar0001 = (coefs1[0] * tempVar0005);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (coefs1[1] * tempVar0007);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (coefs1[2] * tempVar0003);
            tempVar0000 = (tempVar0000 + tempVar0001);
            tempVar0001 = (coefs1[3] * tempVar0002);
            c[4] = (tempVar0000 + tempVar0001);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:02.6105892+02:00
