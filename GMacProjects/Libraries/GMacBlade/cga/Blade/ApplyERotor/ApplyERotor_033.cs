namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] ApplyERotor_033(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:47:02.5615864+02:00
            ...
            //Computations: 2 average, 40 total.
            ...
            tempVar0000 = (-1 * coefs1[0] * coefs2[7]);
            c[7] = (-1 * coefs1[0] * tempVar0000);
            tempVar0000 = (-1 * coefs1[0] * coefs2[8]);
            c[8] = (-1 * coefs1[0] * tempVar0000);
            tempVar0000 = (-1 * coefs1[0] * coefs2[9]);
            c[9] = (-1 * coefs1[0] * tempVar0000);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:47:02.5665867+02:00
