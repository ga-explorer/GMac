...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] GP_224(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:49.2463930+02:00
            ...
            //Computations: 1.24175824175824 average, 113 total.
            ...
            tempVar0003 = (-1 * coefs1[0] * tempVar0000);
            ...
            tempVar0009 = (-1 * coefs1[6] * coefs2[2]);
            tempVar000A = (-1 * coefs1[2] * coefs2[6]);
            tempVar0009 = (tempVar0009 + tempVar000A);
            tempVar000A = (-1 * tempVar0005 * tempVar0004);
            tempVar0009 = (tempVar0009 + tempVar000A);
            tempVar000A = (tempVar0003 * tempVar0006);
            tempVar0009 = (tempVar0009 + tempVar000A);
            tempVar000A = (tempVar0007 * tempVar0002);
            tempVar0009 = (tempVar0009 + tempVar000A);
            ...
            tempVar000D = (-1 * coefs1[6] * coefs2[4]);
            tempVar000E = (-1 * coefs1[4] * coefs2[6]);
            tempVar000D = (tempVar000D + tempVar000E);
            tempVar0004 = (-1 * tempVar000B * tempVar0004);
            tempVar0004 = (tempVar000D + tempVar0004);
            tempVar0003 = (tempVar0003 * tempVar000C);
            tempVar0003 = (tempVar0004 + tempVar0003);
            tempVar0004 = (tempVar0007 * tempVar000A);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * tempVar0009 * tempVar0008);
            c[2] = (tempVar0003 + tempVar0004);
            tempVar0003 = (coefs1[6] * coefs2[5]);
            tempVar0004 = (coefs1[5] * coefs2[6]);
            tempVar0003 = (tempVar0003 + tempVar0004);
            ...
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (tempVar0009 * tempVar0006);
            c[3] = (tempVar0001 + tempVar0002);
            tempVar0001 = (coefs2[2] * tempVar0009);
            tempVar0002 = (-1 * coefs2[4] * tempVar0001);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs2[5] * tempVar0003);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[2] * tempVar000B);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (-1 * coefs1[4] * tempVar0005);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[5] * tempVar0007);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (tempVar0000 * tempVar0001);
            tempVar0003 = (coefs2[2] * tempVar000A);
            tempVar0004 = (-1 * coefs2[4] * tempVar0002);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (coefs2[5] * tempVar0004);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (coefs1[2] * tempVar000C);
            tempVar0003 = (tempVar0003 + tempVar0004);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:49.2543935+02:00
