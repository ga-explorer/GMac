...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] GP_134(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:47.0582679+02:00
            ...
            //Computations: 1.34426229508197 average, 82 total.
            ...
            tempVar0005 = (-1 * coefs1[2] * coefs2[4]);
            ...
            tempVar0004 = (tempVar0004 + tempVar0005);
            tempVar0005 = (coefs1[3] * coefs2[5]);
            tempVar0006 = (-1 * coefs1[2] * coefs2[7]);
            tempVar0005 = (tempVar0005 + tempVar0006);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:47.0652683+02:00
