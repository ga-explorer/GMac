...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] GP_334(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:52.2445645+02:00
            ...
            //Computations: 1.32967032967033 average, 121 total.
            ...
            tempVar0001 = (coefs1[2] * tempVar0000);
            ...
            tempVar0005 = (coefs2[2] * tempVar0000);
            ...
            tempVar0002 = (-1 * coefs1[3] * coefs2[4]);
            tempVar0001 = (tempVar0001 + tempVar0002);
            ...
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (tempVar000B * tempVar0004);
            c[3] = (tempVar0001 + tempVar0002);
            tempVar0001 = (coefs2[4] * tempVar0001);
            tempVar0002 = (-1 * coefs2[5] * tempVar0003);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs2[7] * tempVar0009);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[4] * tempVar0005);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (-1 * coefs1[5] * tempVar0007);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[7] * tempVar000B);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (tempVar0000 * tempVar0001);
            tempVar0003 = (-1 * coefs2[4] * tempVar0002);
            tempVar0004 = (coefs2[5] * tempVar0004);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * coefs2[7] * tempVar000A);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * coefs1[4] * tempVar0006);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (coefs1[5] * tempVar0008);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * coefs1[7] * tempVar000C);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0003 = (-1 * tempVar0000 * tempVar0003);
            c[0] = (tempVar0002 + tempVar0003);
            tempVar0000 = (-1 * tempVar0000 * tempVar0001);
            c[4] = (tempVar0003 + tempVar0000);
            
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:52.2535650+02:00
