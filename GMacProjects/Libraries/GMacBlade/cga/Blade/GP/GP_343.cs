...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] GP_343(double[] coefs1, double[] coefs2)
        {
            var c = new double[10];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:52.5585825+02:00
            ...
            //Computations: 1.31111111111111 average, 118 total.
            ...
            tempVar0000 = (coefs1[7] * coefs2[1]);
            tempVar0001 = (-1 * coefs1[5] * coefs2[2]);
            ...
            tempVar0002 = (-1 * coefs1[6] * tempVar0000);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0005 = (-1 * coefs1[0] * tempVar0000);
            tempVar0002 = (tempVar0002 + tempVar0005);
            tempVar0005 = (-1 * coefs1[3] * coefs2[1]);
            tempVar0001 = (-1 * tempVar0004 * tempVar0001);
            tempVar0001 = (tempVar0005 + tempVar0001);
            tempVar0002 = (tempVar0003 * tempVar0002);
            tempVar0001 = (tempVar0001 + tempVar0002);
            c[7] = (-1 * tempVar0001);
            tempVar0001 = (coefs2[2] * tempVar0001);
            tempVar0002 = (-1 * coefs2[3] * tempVar0001);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs1[7] * tempVar0003);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0001 = (-1 * tempVar0000 * tempVar0001);
            tempVar0002 = (-1 * coefs2[2] * tempVar0002);
            tempVar0003 = (coefs2[3] * tempVar0002);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (-1 * coefs1[7] * tempVar0004);
            tempVar0002 = (tempVar0002 + tempVar0003);
            ...
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * coefs1[5] * tempVar0003);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0003 = (-1 * tempVar0000 * tempVar0003);
            tempVar0004 = (coefs2[1] * tempVar0002);
            tempVar0005 = (-1 * coefs2[3] * tempVar0002);
            tempVar0004 = (tempVar0004 + tempVar0005);
            tempVar0005 = (coefs1[5] * tempVar0004);
            tempVar0004 = (tempVar0004 + tempVar0005);
            ...
            tempVar0006 = (-1 * coefs1[4] * tempVar0003);
            tempVar0005 = (tempVar0005 + tempVar0006);
            ...
            tempVar0007 = (coefs1[4] * tempVar0004);
            tempVar0006 = (tempVar0006 + tempVar0007);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:52.5675830+02:00
