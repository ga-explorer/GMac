...
namespace GMacBlade.cga0001
{
    ...
    {
        private static double[] GP_321(double[] coefs1, double[] coefs2)
        {
            var c = new double[5];
        
            //Bagin GMac Macro Code Generation, 2015-12-20T21:45:51.3315123+02:00
            ...
            tempVar0009 = (-1 * coefs2[3] * tempVar0000);
            ...
            tempVar000D = (coefs1[3] * coefs2[4]);
            tempVar000E = (coefs1[5] * coefs2[6]);
            ...
            tempVar0003 = (-1 * tempVar0003 * tempVar000C);
            ...
            tempVar0004 = (coefs1[7] * coefs2[6]);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * tempVar0009 * tempVar0008);
            tempVar0003 = (tempVar0003 + tempVar0004);
            tempVar0004 = (-1 * tempVar0007 * tempVar000A);
            tempVar0003 = (tempVar0003 + tempVar0004);
            ...
            tempVar0001 = (coefs2[5] * tempVar0009);
            tempVar0002 = (coefs2[4] * tempVar0001);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (coefs2[2] * tempVar0003);
            tempVar0001 = (tempVar0001 + tempVar0002);
            tempVar0002 = (-1 * coefs1[7] * tempVar0005);
            tempVar0001 = (tempVar0001 + tempVar0002);
            ...
            tempVar0002 = (coefs2[5] * tempVar000A);
            tempVar0003 = (coefs2[4] * tempVar0002);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (coefs2[2] * tempVar0004);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (coefs1[7] * tempVar0006);
            tempVar0002 = (tempVar0002 + tempVar0003);
            tempVar0003 = (coefs1[5] * tempVar0008);
            tempVar0002 = (tempVar0002 + tempVar0003);
            ...
            //Finish GMac Macro Code Generation, 2015-12-20T21:45:51.3395128+02:00
