...
{
    public sealed class GaSymEuclideanCp : GaSymBilinearProductEuclidean
    {
        internal GaSymEuclideanCp(int targetVSpaceDim) : base(targetVSpaceDim)
        {
        }
        ...
        public override IGaSymMultivectorTemp MapToTemp(int id1, int id2)
        {
            ...
            if (GaNumFrameUtils.IsNonZeroECp(id1, id2))
