...
{
    public static class ClarkeRotation6DSample
    {
        ...
        public static void Execute()
        {
            ...
            var u6 = "'1'<6>".GaPoTSymParseVector();
            var u123456 = GaPoTSymUtils.OuterProduct(u1, u2, u3, u4, u5, u6);
            ...
            Console.WriteLine($@"u6 = {u6.TermsToText()}");
            Console.WriteLine();
            
            Console.WriteLine($@"u123456 = {u123456.TermsToText()}");
            Console.WriteLine($@"inverse(u123456) = {u123456.Inverse().TermsToText()}");
            Console.WriteLine();
            ...
            var e4 = u5 - u1;
            var e5 = u6 - u1;
            var e12345 = GaPoTSymUtils.OuterProduct(e1, e2, e3, e4, e5);
            ...
            Console.WriteLine($@"e5 = {e5.TermsToText()}");
            Console.WriteLine($@"e12345 = {e12345.TermsToText()}");
            Console.WriteLine();
            
            //Ortho-normalize e1, e2, e3, e4, e5
            var orthoVectors = 
                GaPoTSymUtils.ApplyGramSchmidt(new[] {e1, e2, e3, e4, e5}, true).ToArray();
            ...
            var c5 = orthoVectors[4];
            var c6 = GaPoTSymUtils.OuterProduct(c1, c2, c3, c4, c5).Gp(u123456.Inverse()).GetVectorPart();
            
            var c123456 = GaPoTSymUtils.OuterProduct(c1, c2, c3, c4, c5, c6);
            ...
            Console.WriteLine($@"c6 = {c6.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            Console.WriteLine($@"c6 . c6 = {c6.DotProduct(c6)}");
            ...
            Console.WriteLine($@"c5 . c6 = {c5.DotProduct(c6)}");
            Console.WriteLine($@"c6 . c1 = {c6.DotProduct(c1)}");
            ...
            Console.WriteLine($@"c12345 = {c123456.TermsToText()}");
            Console.WriteLine($@"inverse(c12345) = {c123456.Inverse().TermsToText()}");
            Console.WriteLine();
            ...
            Console.WriteLine($@"rotation of u6 under rotor1 = {u6_1.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            var u6_2 = u6_1.ApplyRotor(rotor2);
            ...
            Console.WriteLine($@"rotation of u6_1 under rotor2 = {u6_2.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            var u6_3 = u6_2.ApplyRotor(rotor3);
            ...
            Console.WriteLine($@"rotation of u6_2 under rotor3 = {u6_3.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            var u6_4 = u6_3.ApplyRotor(rotor4);
            ...
            Console.WriteLine($@"rotation of u6_3 under rotor4 = {u6_4.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            //Make sure this is a rotor
            Console.WriteLine($@"rotor5 = {rotor5.TermsToLaTeX()}");
            Console.WriteLine($@"rotor5 = {rotor5.TermsToText()}");
            Console.WriteLine($@"reverse(rotor5) = {rotor5.Reverse().TermsToText()}");
            Console.WriteLine($@"rotor5 gp reverse(rotor5) = {rotor5.Gp(rotor5.Reverse()).TermsToText()}");
            Console.WriteLine();
            
            //Rotate all basis vectors using rotor2
            var u1_5 = u1_4.ApplyRotor(rotor5);
            var u2_5 = u2_4.ApplyRotor(rotor5);
            var u3_5 = u3_4.ApplyRotor(rotor5);
            var u4_5 = u4_4.ApplyRotor(rotor5);
            var u5_5 = u5_4.ApplyRotor(rotor5);
            var u6_5 = u6_4.ApplyRotor(rotor5);
            
            Console.WriteLine($@"rotation of u1_4 under rotor5 = {u1_5.TermsToLaTeX()}");
            Console.WriteLine($@"rotation of u2_4 under rotor5 = {u2_5.TermsToLaTeX()}");
            Console.WriteLine($@"rotation of u3_4 under rotor5 = {u3_5.TermsToLaTeX()}");
            Console.WriteLine($@"rotation of u4_4 under rotor5 = {u4_5.TermsToLaTeX()}");
            Console.WriteLine($@"rotation of u5_4 under rotor5 = {u5_5.TermsToLaTeX()}");
            Console.WriteLine($@"rotation of u6_4 under rotor5 = {u6_5.TermsToLaTeX()}");
            Console.WriteLine();
            ...
            Console.WriteLine($@"rotation of u6 under rotor = {cc6.TermsToText()}");
            Console.WriteLine();
            ...
            var halfTheta56 = Mfs.Divide[@"t56".ToSymbolExpr(), 2.ToExpr()];
            var parkRotor56 = Mfs.Cos[halfTheta56] + Mfs.Sin[halfTheta56] * c5.Op(c6);
            
            //Make sure this is a rotor
            Console.WriteLine($@"rotor = {parkRotor56.TermsToLaTeX()}");
            Console.WriteLine($@"reverse(rotor) = {parkRotor56.Reverse().TermsToText()}");
            Console.WriteLine($@"rotor gp reverse(rotor) = {parkRotor56.Gp(parkRotor56.Reverse()).TermsToText()}");
            Console.WriteLine();
