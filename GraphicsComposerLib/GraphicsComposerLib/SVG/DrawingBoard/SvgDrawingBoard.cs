...
namespace GraphicsComposerLib.SVG.DrawingBoard
{
    public sealed class SvgDrawingBoard : IReadOnlyList<SvgDrawingBoardLayer>
    {
        ...
        public SvgDrawingBoardLayer FrontLayer
            => _layersList[_layersList.Count - 1];
        ...
        {
            get { return ActiveLayer.CurrentStyle.PenPixelsWidth; }
        ...
        {
            get { return ActiveLayer.CurrentStyle.PenColor; }
        ...
        {
            get { return ActiveLayer.CurrentStyle.PenOpacity; }
        ...
        {
            get { return ActiveLayer.CurrentStyle.FillColor; }
        ...
        {
            get { return ActiveLayer.CurrentStyle.FillOpacity; }
        ...
        public SvgElementSvg GetSvgElement()
        {
            ...
            backgroundRect
                .Style
                .Fill.SetToRgb(BackgroundColor)
                .StrokeWidth.SetTo(3 * LengthByPixelsRatio)
        ...
        public Bitmap RenderToBitmap()
        {
            ...
            var svgDocument = SvgDocument.FromSvg<SvgDocument>(svgCode);

            return svgDocument.Draw(PixelsWidth, PixelsHeight);
        }
