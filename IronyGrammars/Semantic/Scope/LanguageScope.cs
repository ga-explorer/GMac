...
namespace IronyGrammars.Semantic.Scope
{
    /// <summary>
    ...
    public abstract class LanguageScope : IronyAstObjectNamed
    {
        ...
        public bool SymbolExists(string symbolName, string roleName)
        {
            ...
            return _symbols.TryGetValue(symbolName, out symbol) && (symbol.SymbolRoleName == roleName);
        }
        ...
        public bool SymbolExists(string symbolName, IEnumerable<string> roleNames)
        {
            ...
            return _symbols.TryGetValue(symbolName, out symbol) && roleNames.Contains(symbol.SymbolRoleName);
        }
        ...
        public bool LookupSymbol<T>(string symbolName, out T outSymbol) where T : LanguageSymbol
        {
            ...
            if (_symbols.TryGetValue(symbolName, out symbol) && (symbol is T))
            {
                outSymbol = (T)symbol;
                return true;
            }
        ...
        public bool LookupSymbol<T>(string symbolName, string roleName, out T outSymbol) where T : LanguageSymbol
        {
            ...
            if (_symbols.TryGetValue(symbolName, out symbol) && (symbol.SymbolRoleName == roleName) && (symbol is T))
            {
                outSymbol = (T)symbol;
                return true;
            }
