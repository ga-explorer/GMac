...
{
    public sealed class EGpEval : GMacBasicBinaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.BinaryEGp;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1, GMacValueMultivector value2)
        {
            return GMacValueMultivector.Create(
                ...
                value1.SymbolicFrame.Gp[value1.SymbolicMultivector, value2.SymbolicMultivector]
                );
        }
