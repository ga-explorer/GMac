...
using GMac.Engine.API.CodeGen.BuiltIn.CSharp;
using GMac.Engine.API.CodeGen.BuiltIn.GMac.GMacFrame;
using GMac.Engine.AST;
using GMac.Engine.Compiler;
using GMac.Engine.Compiler.Semantic.AST;
using GMac.IDE.AstExplorer;
using GMac.IDE.CodeGen;
using GMac.IDE.Scripting;
using GMac.IDE.Tools;
using TextComposerLib.WinForms;
...
namespace GMac.IDE.Editor
{
    public partial class FormGMacDslEditor : Form
    {
        ...
        private void menuItemTools_CodeGenerator_Click(object sender, EventArgs e)
        {
            ...
            {
                new GMacDirectCSharpComposer(astRoot),
