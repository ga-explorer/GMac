...
namespace GMac.GMacAST
{
    ...
    public sealed class AstRoot : AstObject
    {
        ...
        /// </summary>
        internal GMacAst AssociatedAst { get; }
        ...
        public AstSymbol Symbol(string accessName)
        {
            ...
            if (AssociatedAst.SymbolsCache.MainSymbols.TryGetValue(accessName, out symbol))
        ...
        public AstNamespace Namespace(string accessName)
        {
            ...
            if (AssociatedAst.SymbolsCache.Namespaces.TryGetValue(accessName, out symbol))
        ...
        public AstFrame Frame(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Frames.TryGetValue(accessName, out symbol);
        ...
        public AstFrameBasisVector BasisVector(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.FrameBasisVectors.TryGetValue(accessName, out symbol);
        ...
        public AstFrameMultivector FrameMultivector(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.FrameMultivectors.TryGetValue(accessName, out symbol);
        ...
        public AstFrameSubspace Subspace(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.FrameSubspaces.TryGetValue(accessName, out symbol);
        ...
        public AstConstant Constant(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Constants.TryGetValue(accessName, out symbol);
        ...
        public AstTransform Transform(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Transforms.TryGetValue(accessName, out symbol);
        ...
        public AstStructure Structure(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Structures.TryGetValue(accessName, out symbol);
        ...
        public AstMacro Macro(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Macros.TryGetValue(accessName, out symbol);
        ...
        public AstType Type(string accessName)
        {
            ...
            AssociatedAst.SymbolsCache.Types.TryGetValue(accessName, out symbol);
