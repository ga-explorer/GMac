...
namespace GeometricAlgebraSymbolicsLib.Multivectors
{
    ...
    {
        internal GaBinaryTreeInternalNode<GaSymMultivectorBinaryTree1D> RootNode { get; }
        ...
        public MathematicaScalar this[int id1, int id2, int id3]
        {
            get
            {
                if (RootNode.TryGetLeafValue((ulong)id1, out var mvTree1D))
        ...
        {
            RootNode = new GaBinaryTreeInternalNode<GaSymMultivectorBinaryTree1D>(
                0,
