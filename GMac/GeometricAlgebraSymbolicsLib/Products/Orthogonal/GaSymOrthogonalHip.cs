...
{
    public sealed class GaSymOrthogonalHip : GaSymBilinearProductOrthogonal
    {
        internal GaSymOrthogonalHip(GaSymMetricOrthogonal basisBladesSignatures)
        ...
        public override IGaSymMultivectorTemp MapToTemp(int id1, int id2)
        {
            ...
            if (GaNumFrameUtils.IsNonZeroEHip(id1, id2))
        ...
        public override IGaSymMultivectorTemp MapToTemp(GaSymMultivector mv1, GaSymMultivector mv2)
        {
            ...
            return
                GaSymMultivector
                    ...
                    .AddFactors(mv1.GetBiTermsForHip(mv2, OrthogonalMetric));
        }
