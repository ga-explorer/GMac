...
{
    public sealed class GaSymOrthonormalFdp : GaSymBilinearProductOrthonormal
    {
        internal GaSymOrthonormalFdp(GaSymMetricOrthonormal basisBladesSignatures)
