...
namespace GeometricAlgebraSymbolicsLib
{
    public static class GaSymbolicsUtils
    {
        ...
        public static GaBinaryTreeInternalNode<int> ComputeBasisBladesSignatures(this IReadOnlyList<int> basisVectorsSignaturesList)
        {
            var vSpaceDim = basisVectorsSignaturesList.Count;
            var bbsList = new GaBinaryTreeInternalNode<int>(0, vSpaceDim);
        ...
        public static GaBinaryTreeInternalNode<double> ComputeBasisBladesSignatures(this IReadOnlyList<double> basisVectorsSignaturesList)
        {
            var vSpaceDim = basisVectorsSignaturesList.Count;
            var bbsList = new GaBinaryTreeInternalNode<double>(0, vSpaceDim);
        ...
        public static GaBinaryTreeInternalNode<MathematicaScalar> ToSymbolicTree(this GaBinaryTreeInternalNode<int> rootTreeNode)
        {
        ...
        public static GaBinaryTreeInternalNode<MathematicaScalar> ToSymbolicTree(this GaBinaryTreeInternalNode<double> rootTreeNode)
        {
            return rootTreeNode?.MapTree(
                i => MathematicaScalar.Create(Cas, i)
            );
