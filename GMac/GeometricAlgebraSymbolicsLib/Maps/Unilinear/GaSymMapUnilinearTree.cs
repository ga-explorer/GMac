...
namespace GeometricAlgebraSymbolicsLib.Maps.Unilinear
{
    public sealed class GaSymMapUnilinearTree : GaSymMapUnilinear
    {
        ...
        private readonly GaBinaryTreeInternalNode<IGaSymMultivector> _basisBladeMaps;
        ...
        public override IGaSymMultivector this[int id1]
        {
            get
            {
                _basisBladeMaps.TryGetLeafValue((ulong)id1, out var mv);
        ...
        private GaSymMapUnilinearTree(int targetVSpaceDim)
        {
            ...
            _basisBladeMaps = new GaBinaryTreeInternalNode<IGaSymMultivector>(
                0, 
                targetVSpaceDim
            );
        }
