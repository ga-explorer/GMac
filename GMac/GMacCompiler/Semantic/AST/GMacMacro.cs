...
using GMac.GMacCompiler.Semantic.ASTInterpreter.HighLevel;
...
namespace GMac.GMacCompiler.Semantic.AST
{
    ...
    public sealed class GMacMacro : SymbolProcedure
    {
        ...
        {
            SymbolLocalVariable localVar;

            return 
                SymbolBody.ChildCommandBlockScope.LookupSymbol(name, RoleNames.LocalVariable, out localVar) 
                ? localVar.SymbolType 
                : null;
        }
    }
