...
{
    public sealed class RcpEval : GMacBasicBinaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.BinaryRcp;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1, GMacValueMultivector value2)
        {
            return GMacValueMultivector.Create(
                ...
                value1.SymbolicFrame.Rcp[value1.SymbolicMultivector, value2.SymbolicMultivector]
                );
        }
