...
{
    public sealed class FdpEval : GMacBasicBinaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.BinaryFdp;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1, GMacValueMultivector value2)
        {
            return GMacValueMultivector.Create(
                ...
                value1.SymbolicFrame.Fdp[value1.SymbolicMultivector, value2.SymbolicMultivector]
                );
        }
