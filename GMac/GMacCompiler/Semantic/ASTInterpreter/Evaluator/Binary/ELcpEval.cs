...
{
    public sealed class ELcpEval : GMacBasicBinaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.BinaryELcp;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1, GMacValueMultivector value2)
        {
            return GMacValueMultivector.Create(
                ...
                value1.MultivectorCoefficients.EuclideanLcp(value2.MultivectorCoefficients)
                );
        }
