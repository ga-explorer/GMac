...
{
    public sealed class GradeInversionEval : GMacBasicUnaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.UnaryGradeInvolution;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1)
        {
            return GMacValueMultivector.Create(
                ...
                value1.MultivectorCoefficients.GradeInv()
                );
        }
    }
}
