...
{
    public sealed class ReverseEval : GMacBasicUnaryEvaluator
    {
        public override GMacOpInfo OperatorInfo => GMacOpInfo.UnaryReverse;
        ...
        public ILanguageValue Evaluate(GMacValueMultivector value1)
        {
            return GMacValueMultivector.Create(
                ...
                value1.MultivectorCoefficients.Reverse()
                );
        }
    }
}
