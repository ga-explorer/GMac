...
namespace GMac.GMacMath.Symbolic.Maps.Bilinear
{
    ...
    public sealed class GaSymMapBilinearCoefSums : GaSymMapBilinear
    {
        ...
        public static GaSymMapBilinearCoefSums CreateFromOuterProduct(IGMacFrame frame)
        {
            return new GaSymOp(frame.VSpaceDimension).ToCoefSumsMap();
        }


        private readonly SparseTable1D<int, GaSymMapBilinearCoefSumsTerm> _coefSumsTable
            = new SparseTable1D<int, GaSymMapBilinearCoefSumsTerm>();
        ...
        {
            GaSymMapBilinearCoefSumsTerm sum;
