...
namespace GMac.GMacMath.Symbolic.Maps.Bilinear
{
    public sealed class GaSymMapBilinearTree : GaSymMapBilinear
    {
        ...
        private readonly GMacQuadTree<IGaSymMultivector> _basisBladesMaps;
        ...
        {
            _basisBladesMaps = new GMacQuadTree<IGaSymMultivector>(targetVSpaceDim);
            TargetVSpaceDimension = targetVSpaceDim;
        }

        private GaSymMapBilinearTree(int domainVSpaceDim, int targetVSpaceDim)
        {
            _basisBladesMaps = new GMacQuadTree<IGaSymMultivector>(domainVSpaceDim);
            TargetVSpaceDimension = targetVSpaceDim;
        }
