...
{
    public sealed class GaSymOrthogonalLcp : GaSymBilinearProductOrthogonal
    {
        internal GaSymOrthogonalLcp(GaSymMetricOrthogonal basisBladesSignatures)
        ...
        public override IGaSymMultivectorTemp MapToTemp(int id1, int id2)
        {
            ...
            if (GMacMathUtils.IsNonZeroELcp(id1, id2))
