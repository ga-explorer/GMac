...
namespace GMac.GMacMath.Symbolic.Multivectors
{
    public sealed class GaSymMultivector : IGaSymMultivector, ISymbolicVector
    {
        ...
        internal GMacBinaryTree<Expr> TermsTree { get; }
        ...
        public IEnumerable<MathematicaScalar> BasisBladeScalars 
            => TermsTree
                .LeafValuePairs
                .Select(pair => pair.Value?.ToMathematicaScalar() ?? SymbolicUtils.Constants.Zero);
            ...
            => TermsTree
                ...
                .Select(
                    pair => new KeyValuePair<int, MathematicaScalar>(
                        (int)pair.Key, 
                        pair.Value?.ToMathematicaScalar() ?? SymbolicUtils.Constants.Zero
                        )
                    );
