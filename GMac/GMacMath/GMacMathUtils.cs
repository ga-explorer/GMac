...
namespace GMac.GMacMath
{
    public static class GMacMathUtils
    {
        ...
        /// <param name="indexSeq"></param>
        /// <returns></returns>
        public static IEnumerable<int> BasisBladeIDsOfGradeIndex(this IGMacFrame frame, int grade, params int[] indexSeq)
        {
            return indexSeq.Select(index => BasisBladeId(grade, index));
        }
        ...
        public static double ToNumber(this Expr value)
        {
            ...
            var textValue =
                SymbolicUtils.Cas.Connection.EvaluateToOutputForm(Mfs.CForm[Mfs.N[value]]);
