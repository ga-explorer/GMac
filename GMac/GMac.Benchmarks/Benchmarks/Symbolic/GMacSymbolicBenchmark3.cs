...
{
    //public class GMacSymbolicBenchmark3
    //{
    ...
    //        _sparseMv1 = GaSymMultivectorHash.CreateSymbolic(GaSpaceDimension, "A");
    //        _sparseMv2 = GaSymMultivectorHash.CreateSymbolic(GaSpaceDimension, "B");
