...
{
    /// <summary>
    /// Benchmark computed implementation method of standard products on non-orthogonal frames for BTR sparse multivectors
    /// </summary>
    public class Benchmark9
    {
        ...
        public void Setup()
        {
            ...
            {
                _inputMultivectors1[i] = _randGen.GetNumMultivectorTerms(_frame.VSpaceDimension).CreateSarMultivector(_frame.VSpaceDimension);
                _inputMultivectors2[i] = _randGen.GetNumMultivectorTerms(_frame.VSpaceDimension).CreateSarMultivector(_frame.VSpaceDimension);
