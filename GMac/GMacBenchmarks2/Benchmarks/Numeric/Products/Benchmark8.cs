...
{
    /// <summary>
    /// Benchmark computed implementation method of standard products on non-orthogonal frames for JAR k-vectors
    /// </summary>
    public class Benchmark8
    {
        ...
        public void Setup()
        {
            ...
            {
                _inputMultivectors1[i] = _randGen.GetNumFullKVectorTerms(_frame.VSpaceDimension, i).CreateDgrMultivector(_frame.VSpaceDimension);
                _inputMultivectors2[i] = _randGen.GetNumFullKVectorTerms(_frame.VSpaceDimension, i).CreateDgrMultivector(_frame.VSpaceDimension);
