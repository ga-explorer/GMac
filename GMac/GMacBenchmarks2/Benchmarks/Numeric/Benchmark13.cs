namespace GMacBenchmarks2.Benchmarks.Numeric
{
    ...
    //    private GaNumBtrMultivector[] _dynamicMultivectorsArray;
    ...
    //        _dynamicMultivectorsArray = new GaNumBtrMultivector[_size];
    ...
    //    [Benchmark]
    //    public GaNumBtrMultivector[,] DynamicOp()
    //    {
    //        var result = new GaNumBtrMultivector[_size, _size];
    ...
    //                GaNumBtrMultivector.CreateFromTerms(
    //                    GaSpaceDimension,
    //                    _sourceTermsArray[i]
    //                );
    //    }
