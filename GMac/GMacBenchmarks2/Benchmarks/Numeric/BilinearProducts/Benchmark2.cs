...
namespace GMacBenchmarks2.Benchmarks.Numeric.BilinearProducts
{
    ...
    public class Benchmark2
    {
        ...
        public void Setup()
        {
            ...
            {
                var termsList1 = _randGen.GetNumFullKVectorTerms(VSpaceDimension, grade).ToArray();
                var termsList2 = _randGen.GetNumFullKVectorTerms(VSpaceDimension, grade).ToArray();
