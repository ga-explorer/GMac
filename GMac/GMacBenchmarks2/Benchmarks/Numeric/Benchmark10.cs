...
{
    /// <summary>
    /// Benchmark implementation method of outermorphisms 
    /// </summary>
    public class Benchmark10
    {
        ...
        [Benchmark]
        public GaNumMultivector OmMatrix_Terms()
        {
            GaNumMultivector mv = null;
        ...
        [Benchmark]
        public GaNumMultivector OmMatrix_KVectors()
        {
            GaNumMultivector mv = null;
        ...
        [Benchmark]
        public GaNumMultivector OmMatrix_FullMultivectors()
        {
