...
namespace GMac.Engine.Compiler.Semantic.ASTDebug
{
    public sealed class GMacAstDescription : IronyAstDescription
    {
        ...
        public void Generate_Macro_UsingRawBody(GMacMacro macro)
        {
            Generate_Macro_UsingBody(macro, macro.SymbolBody);
        }

        public void Generate_Macro_UsingRawCompiledBody(GMacMacro macro)
        {
            Generate_Macro_UsingBody(macro, macro.CompiledBody);
        }

        public void Generate_Macro_UsingOptimizedCompiledBody(GMacMacro macro)
        {
