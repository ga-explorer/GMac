...
namespace GMac.Engine.Compiler.Semantic.ASTInterpreter.LowLevel.Optimizer.Evaluator
{
    internal sealed class TlCodeBlockEvaluationHistory
    {
        ...
        internal TlCodeBlockEvaluationHistory(GMacCodeBlock codeBlock, Dictionary<string, GMacMacroParameterBinding> inputsWithTestValues)
        {
            ...
            {
                if (!CodeBlock.TryGetInputParameterVariable(pair.Value.ValueAccess, out var inputParamVar))
                    continue;
