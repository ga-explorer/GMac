...
namespace GMac.Engine.Compiler.Semantic.AST
{
    ...
    public sealed class GMacFrame : SymbolWithScope, IGaFrame
    {
        ...
        /// </summary>
        public IEnumerable<GMacFrameBasisVector> FrameBasisVectors { get; }

        /// <summary>
        /// The multivector type associated with this frame
        /// </summary>
        public GMacFrameMultivector MultivectorType { get; private set; }
        ...
        /// </summary>
        public IEnumerable<GMacFrameSubspace> FrameSubspaces { get; }

        /// <summary>
        ///All child structures
        /// </summary>
        public IEnumerable<GMacStructure> Structures { get; private set; }

        /// <summary>
        ///All child transforms
        /// </summary>
        public IEnumerable<GMacMultivectorTransform> Transforms { get; private set; }
        ...
        internal GMacFrameSubspace DefineSubspace(string symbolName, BooleanPattern signature)
        {
            ...
            LookupSubspaceSignaturePattern(signature, out var newSignature);
