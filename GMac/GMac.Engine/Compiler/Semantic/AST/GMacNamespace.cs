...
namespace GMac.Engine.Compiler.Semantic.AST
{
    ...
    {
        public GMacAst GMacRootAst => (GMacAst)RootAst;

        /// <summary>
        ///All child namespaces
        /// </summary>
        public IEnumerable<GMacNamespace> ChildNamespaces { get; private set; }

        /// <summary>
        ///All child frames
        /// </summary>
        public IEnumerable<GMacFrame> ChildFrames { get; private set; }

        /// <summary>
        ///All child constants
        /// </summary>
        public IEnumerable<GMacConstant> ChildConstants { get; private set; }

        /// <summary>
        ///All child macros
        /// </summary>
        public IEnumerable<GMacMacro> ChildMacros { get; private set; }

        /// <summary>
        ///All child macro templates
        /// </summary>
        public IEnumerable<GMacMacroTemplate> ChildMacroTemplates { get; private set; }

        /// <summary>
        ///All child transforms
        /// </summary>
        public IEnumerable<GMacMultivectorTransform> ChildTransforms { get; private set; }

        /// <summary>
        ///All child structures
        /// </summary>
        public IEnumerable<GMacStructure> ChildStructures { get; private set; }

        /// <summary>
        /// The symbols cache used to speed access to sub-symbols
        /// </summary>
        public GMacAstSymbolsCache SymbolsCache { get; private set; }
