namespace GMac.Engine.API.Target.Java
{
    //public sealed class JavaExpressionConverter : GMacTargetExpressionConverter
    //{
    //    internal JavaExpressionConverter(JavaLanguage targetLanguage)
    //        : base(targetLanguage)
    //    {
    //    }
