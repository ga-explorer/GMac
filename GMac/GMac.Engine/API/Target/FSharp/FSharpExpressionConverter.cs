namespace GMac.Engine.API.Target.FSharp
{
    //public sealed class FSharpExpressionConverter : GMacTargetExpressionConverter
    //{
    //    internal FSharpExpressionConverter(FSharpLanguage targetLanguage)
    //        : base(targetLanguage)
    //    {
    //    }
