namespace GMac.Engine.API.Target.Scala
{
    //public sealed class ScalaExpressionConverter : GMacTargetExpressionConverter
    //{
    //    internal ScalaExpressionConverter(ScalaLanguage targetLanguage)
    //        : base(targetLanguage)
    //    {
    //    }
