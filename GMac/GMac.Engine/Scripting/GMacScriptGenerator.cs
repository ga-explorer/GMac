...
public sealed class InteractiveScript : IGMacScript
{
    ...
    public void Process()
    {
        ...
        private readonly ParametricTextComposer _scriptCodeTemplate =
            new ParametricTextComposer("#", "#", ScriptCodeTemplateText);
        ...
        private string TranslateShortcuts(string scriptText)
        {
            ...
            mappingComposer
                ...
                .TransformUsing(
                    ...
                    {
                        return
                            Shortcuts.TryGetMethodName(s.InitialText.ToLower(), out var value)
                            ? value
                            : s.OriginalText;
                    }
                    );
