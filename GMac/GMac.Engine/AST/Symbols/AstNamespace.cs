...
namespace GMac.Engine.AST.Symbols
{
    ...
    public sealed class AstNamespace : AstSymbol
    {
        ...
        public override LanguageSymbol AssociatedSymbol => AssociatedNamespace;
        ...
        {
            AssociatedNamespace.SymbolsCache.MainSymbols.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Namespaces.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Frames.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.FrameBasisVectors.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.FrameMultivectors.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.FrameSubspaces.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Constants.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Structures.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Transforms.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Macros.TryGetValue(accessName, out var symbol);
        ...
        {
            AssociatedNamespace.SymbolsCache.Types.TryGetValue(accessName, out var symbol);
