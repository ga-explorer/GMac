...
namespace GMac.Engine.AST.Symbols
{
    public sealed class AstMacro : AstSymbol
    {
        ...
        public GMacMacro AssociatedMacro { get; }

        public override LanguageSymbol AssociatedSymbol => AssociatedMacro;
        ...
        public AstMacro(GMacMacro macro)
        {
        ...
        public IEnumerable<KeyValuePair<AstType, List<AstMacroParameter>>> GroupParametersByType()
        {
            ...
            foreach (var parameter in AssociatedMacro.Parameters)
            {
                ...
                if (dict.TryGetValue(typeSignature, out var list) == false)
                {
