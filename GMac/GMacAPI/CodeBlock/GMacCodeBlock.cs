...
namespace GMac.GMacAPI.CodeBlock
{
    ...
    public sealed class GMacCodeBlock
    {
        ...
        /// </summary>
        private readonly List<GMacCbInputVariable> _inputVariables = new List<GMacCbInputVariable>();

        /// <summary>
        /// The computed variables (temp and output) defined in this block
        /// </summary>
        internal List<GMacCbComputedVariable> ComputedVariables = new List<GMacCbComputedVariable>();
        ...
        /// </summary>
        public IEnumerable<GMacCbVariable> Variables => _inputVariables.Concat(ComputedVariables.Cast<GMacCbVariable>());

        /// <summary>
        /// The input variables of this code block
        /// </summary>
        public IEnumerable<GMacCbInputVariable> InputVariables => _inputVariables;

        /// <summary>
        /// The number of input variables of this code block
        /// </summary>
        public int InputVariablesCount => _inputVariables.Count;
        ...
        public IEnumerable<GMacCbInputVariable> UsedInputVariables
        {
            get
            {
                return _inputVariables.Where(inputVar => inputVar.IsUsed);
            }
        }
        ...
        {
            get { return OutputVariables.Where(outputVar => outputVar.IsConstant); }
        }
        ...
        {
            get { return OutputVariables.Where(outputVar => outputVar.IsNonZeroConstant); }
        }
        ...
        {
            get { return OutputVariables.Where(outputVar => outputVar.IsConstant == false); }
        }
        ...
        {
            get { return OutputVariables.Where(outputVar => outputVar.IsNonZero); }
        }
        ...
        {
            get { return OutputVariables.Where(outputVar => outputVar.IsZero); }
        }

        /// <summary>
        /// Returns a list of input and output varfiables in this code block
        /// </summary>
        public IEnumerable<IGMacCbParameterVariable> ParameterVariables => _parametersDictionary.Count == 0 
        ...
        {
            get { return TempVariables.Where(item => item.IsFactoredSubExpression); }
        }
