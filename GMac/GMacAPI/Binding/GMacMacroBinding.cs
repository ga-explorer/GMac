...
namespace GMac.GMacAPI.Binding
{
    ...
    public sealed class GMacMacroBinding : IProgressReportSource
    {
        ...
        /// <summary>
        /// Gets the scalar pattern associated with the given primitive parameter value access component
        /// </summary>
        /// <param name="valueAccess"></param>
        /// <returns></returns>
        public GMacScalarBinding this[AstDatastoreValueAccess valueAccess] => _patternDictionary[valueAccess.ValueAccessName].ToScalarBinding;
        ...
        public IEnumerable<GMacMacroParameterBinding> GetBindings(AstDatastoreValueAccess paramValueAccess)
        {
            ...
            if (paramValueAccess.IsPartialMultivector)
            {
                ...
                {
                    GMacMacroParameterBinding paramVar;

                    if (_patternDictionary.TryGetValue(primitiveValueAccess.ValueAccessName, out paramVar))
                        result.Add(paramVar);
                }
