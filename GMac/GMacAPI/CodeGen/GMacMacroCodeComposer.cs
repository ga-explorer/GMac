...
namespace GMac.GMacAPI.CodeGen
{
    ...
    public class GMacMacroCodeComposer : GMacCodeStringComposer
    {
        ...
        /// </summary>
        public AstMacro BaseMacro => MacroBinding?.BaseMacro;
        ...
        /// </summary>
        public bool IsMacroBindingReady => (MacroBinding != null && MacroBinding.IsMacroBindingReady);

        /// <summary>
        /// True if the code block is generated and ready
        /// </summary>
        public bool IsCodeBlockReady => CodeBlock != null;
