...
{
    public sealed class DirectLibrary : GMacCodeLibraryComposer
    {
        private AstNamespace _currentNamespace;

        private ParametricComposer MultivectorTemplate => Templates["multivector"];
