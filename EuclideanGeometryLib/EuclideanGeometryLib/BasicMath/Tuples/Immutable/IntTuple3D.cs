...
namespace EuclideanGeometryLib.BasicMath.Tuples.Immutable
{
    ...
    public struct IntTuple3D : IEnumerable<int>
    {
        ...
        public int VectorLengthSquared =>
            ItemX * ItemX + ItemY * ItemY + ItemZ * ItemZ;
        ...
        public int MinComponent
            => (ItemX < ItemY) ? (ItemX < ItemZ ? ItemX : ItemZ) : (ItemY < ItemZ ? ItemY : ItemZ);
        ...
        public int MinComponentIndex
            => (ItemX < ItemY) ? (ItemX < ItemZ ? 0 : 2) : (ItemY < ItemZ ? 1 : 2);
        ...
        public bool Equals(IntTuple3D tuple)
        {
            return ItemX == tuple.ItemX && ItemY == tuple.ItemY && ItemZ == tuple.ItemZ;
        }

        public override bool Equals(object obj)
        {
            if (ReferenceEquals(null, obj)) return false;
            return obj is IntTuple3D && Equals((IntTuple3D)obj);
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                var hashCode = ItemX;
                hashCode = (hashCode * 397) ^ ItemY;
                hashCode = (hashCode * 397) ^ ItemZ;
                return hashCode;
            }
        }
