...
namespace EuclideanGeometryLib.Borders.Space3D.Immutable
{
    public sealed class BoundingBox3D : IBoundingBox3D
    {
        ...
        internal BoundingBox3D(double minX, double minY, double minZ, double maxX, double maxY, double maxZ)
        {
            MinX = minX;
            MinY = minY;
            MinZ = minZ;
