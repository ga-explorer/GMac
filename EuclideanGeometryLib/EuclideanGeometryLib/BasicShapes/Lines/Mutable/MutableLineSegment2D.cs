...
namespace EuclideanGeometryLib.BasicShapes.Lines.Mutable
{
    public sealed class MutableLineSegment2D : ILineSegment2D
    {
        ...
        public static MutableLineSegment2D Create(ITuple2D point1, ITuple2D point2)
        {
            return new MutableLineSegment2D(
                point1.X,
                point1.Y,
        ...
        public MutableLineSegment2D SetPoint1(ITuple2D point)
        {
            Point1X = point.X;
            Point1Y = point.Y;
        ...
        public MutableLineSegment2D SetPoint2(ITuple2D point)
        {
            Point2X = point.X;
            Point2Y = point.Y;
        ...
        public MutableLineSegment2D SetLineSegment(ITuple2D point1, ITuple2D point2)
        {
            Point1X = point1.X;
            Point1Y = point1.Y;
