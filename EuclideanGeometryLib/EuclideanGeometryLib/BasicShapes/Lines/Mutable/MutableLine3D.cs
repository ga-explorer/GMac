...
namespace EuclideanGeometryLib.BasicShapes.Lines.Mutable
{
    public sealed class MutableLine3D : ILine3D
    {
        ...
        public static MutableLine3D Create(ITuple3D origin, ITuple3D direction)
        {
            return new MutableLine3D(
                origin.X,
                origin.Y,
        ...
        public MutableLine3D SetOrigin(ITuple3D origin)
        {
            OriginX = origin.X;
            OriginY = origin.Y;
            OriginZ = origin.Z;
        ...
        public MutableLine3D SetDirection(ITuple3D direction)
        {
        ...
        public MutableLine3D SetLine(ITuple3D origin, ITuple3D direction)
        {
            OriginX = origin.X;
            OriginY = origin.Y;
            OriginZ = origin.Z;
